...
const marker = '/* MOBILE_MORE_MENU_DELEGATED_FIX_v1 */';
const patch = `
${marker}
(function(){
...
for (const file of ['src/js/core/page-shell.js', 'src/js/core/page-shell.pretty.js']) {
  const source = fs.readFileSync(file, 'utf8');
  if (!source.includes(marker)) fs.writeFileSync(file, source + patch);
}
