-- Dalil Manzala - Turso/SQLite-compatible Schema & Indexes
-- Turso schema reference. The production database is `dalilmanzala`.
...
-- Lightweight moderation queue for community-submitted corrections.
...
CREATE INDEX IF NOT EXISTS idx_places_verified_rating
...
-- ── 7. Offers & Products (Turso authoritative) ─────────────────
...
-- ── 8. Job Seekers & Available Jobs (باحث عن عمل & وظائف متاحة) ────
