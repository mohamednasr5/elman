...
export async function openManzalaVoiceAssistantModal() {
  ...
  {number:'180', names:['المطافئ المصرية','المطافي','مطافي','المطافئ','الاطفاء','إطفاء']},
  {number:'121', names:['طوارئ الكهرباء','الكهرباء','كهربا','طوارئ كهربا']},
  {number:'129', names:['طوارئ الغاز','الغاز','غاز','طوارئ غاز']},
  {number:'125', names:['طوارئ المياه','المياه','مياه','طوارئ مياه']},
  {number:'01221110000', names:['حوادث المرور','طوارئ المرور','الحوادث']},
  {number:'16474', names:['الرعاية الحرجة والعاجلة','الرعاية الحرجة']},
  {number:'138', names:['وزارة الداخلية','الداخلية']},
  {number:'107', names:['دار الإفتاء المصرية','دار الافتاء','الافتاء']},
  {number:'106', names:['الهيئة العامة للتأمين الصحي','التأمين الصحي']},
  {number:'19151', names:['التربية والتعليم','وزارة التربية والتعليم']},
  {number:'19556', names:['الهيئة العامة لتعليم الكبار','تعليم الكبار']},
  {number:'19654', names:['وزارة السياحة','السياحة']},
  {number:'19136', names:['وزارة الدفاع','الدفاع']},
  {number:'19808', names:['وزارة البيئة','البيئة']},
  ...
  {number:'19526', names:['مبيعات كبار العملاء','كبار العملاء']},
  {number:'19053', names:['الهيئة المصرية للرقابة على التأمين','الرقابة على التأمين']},
  {number:'19654', names:['مجلس التدريب الصناعي','التدريب الصناعي']},
  {number:'19680', names:['تكنولوجيا تشغيل المنشآت المالية','المنشآت المالية']},
  {number:'152', names:['الهيئة العامة لنظافة وتجميل القاهرة','النظافة']},
  {number:'175', names:['الهيئة العامة للصرف الصحي','الصرف الصحي']},
  {number:'155', names:['مرفق الاتصالات','الاتصالات']},
  {number:'16000', names:['المجلس القومي للأمومة والطفولة','الأمومة والطفولة']},
  {number:'16021', names:['المجلس القومي لحقوق الإنسان','حقوق الإنسان']},
  {number:'19932', names:['مركز اتصال المصرية والاتصالات','المصرية والاتصالات']},
  {number:'111', names:['مركز معلومات شبكات المرافق','شبكات المرافق']},
  {number:'19895', names:['مشروع حساب لكل بيت','حساب لكل بيت']},
  ...
  {number:'02233320555 / 01501692277', names:['طيران الإمارات','الامارات']},
  {number:'01009998271', names:['فلاي ناس']},
  {number:'0223960454 / 0223960465', names:['الخطوط الجوية التركية','الخطوط التركية']},
  {number:'025741200 / 025747575 / 025931049', names:['الخطوط الجوية السعودية','الخطوط السعودية']},
  {number:'025750875 / 025750905', names:['الخطوط الملكية الأردنية','الملكية الأردنية']},
  {number:'0225780740', names:['الخطوط الجوية البريطانية']},
  {number:'02226966620', names:['الخطوط الجوية الإثيوبية','الخطوط الاثيوبية']},
  {number:'4631010 / 4595671 / 4591487 / 4591486', names:['مطار الإسكندرية الدولي','مطار برج العرب','برج العرب']},
  {number:'35316900 / 35391580', names:['مطار سفنكس الدولي','مطار سفنكس','سفنكس']},
  {number:'199970', names:['شركة مطار القاهرة','مطار القاهرة']},
  ...
  {number:'4243479', names:['سرقات المتاجر','سرقات']},
  {number:'4268822', names:['سرقات السيارات','جرائم النشل','النشل']},
  {number:'4269966', names:['قسم مكافحة المخدرات','المخدرات']},
  {number:'4203208', names:['جرائم الأموال العامة','الأموال العامة']},
  {number:'4269955', names:['جرائم الآداب','جرائم الاداب','الاداب']},
  {number:'4268305', names:['جرائم المصنفات الفنية','المصنفات الفنية']},
  {number:'4949547', names:['مباحث المرور']},
  {number:'4244322', names:['شرطة المرافق']},
  {number:'484222', names:['مباحث التليفونات','التليفونات']},
  {number:'4863754', names:['مباحث التهرب الضريبي','التهرب الضريبي','الضرائب']},
  {number:'3925810', names:['الإسعاف']},
  {number:'01200003633', names:['عمليات المرور']},
  {number:'0227921487', names:['مباحث الإنترنت','مباحث الانترنت']},
