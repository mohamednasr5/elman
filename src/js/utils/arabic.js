...
export function expandArabicSearchIntent(rawQuery) {
  ...
  const SYNONYM_CLUSTERS = [
    ...
    // 14. Electricians & Lighting (كهرباء وإنارة وتأسيس)
    ['كهربائي', 'كهرباء', 'كهربا', 'فني كهربا', 'بتاع كهربا', 'صنايعي كهربا', 'كهربائي منازل', 'فني كهربائي', 'تصليح كهربا', 'تأسيس كهرباء', 'اضاءة', 'ليدات', 'لمبات', 'مفاتيح كهرباء', 'electrician'],

    // 15. Plumbers & Sanitary (سباكة وأدوات صحية)
    ['سباك', 'سباكة', 'سباكه', 'فني سباكة', 'بتاع سباكة', 'صنايعي سباكة', 'سباك منازل', 'مواسير', 'حنفية', 'خلاط', 'سخان', 'فلتر', 'ادوات صحية', 'plumber'],

    // 16. Carpenters & Woodwork (نجارة وأثاث وموبيليا)
    ['نجار', 'نجارة', 'نجاره', 'فني نجارة', 'بتاع نجارة', 'صنايعي نجارة', 'موبيليا', 'ابواب', 'شبابيك', 'غرف نوم', 'carpenter'],

    // 17. Painters & Finishes (نقاشة ودهانات)
    ['نقاش', 'نقاشة', 'فني نقاشة', 'صنايعي نقاشة', 'دهانات', 'بويات', 'معجون', 'الوان', 'painter'],

    // 18. Tilers & Ceramic (سيراميك وبلاط)
    ['مبلط', 'سيراميك', 'بلاط', 'بورسلين', 'رخام', 'tiler'],

    // 15. Auto Mechanics & Transportation (سيارات ونقل وصيانة)
    ['ميكانيكي', 'عفشة', 'كاوتش', 'غيار زيت', 'صيانة سيارات', 'تصليح عربيات', 'بطاريات', 'قطع غيار', 'سيارة', 'عربية', 'تاكسي', 'مشوار', 'مشاوير', 'توكتوك', 'موتوسيكل', 'توصيل', 'اتوبيس', 'باص', 'ربع نقل', 'نص نقل', 'نقل كبير', 'تريلا', 'عربية بحمار', 'كارو', 'عربية بحصان', 'حنطور', 'لودر', 'جرار', 'مقطورة', 'mechanic', 'car', 'delivery', 'bus', 'truck', 'loader', 'tractor'],
