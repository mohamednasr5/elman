      ...
      <div style="background:rgba(255,255,255,0.08);border:1px solid rgba(255,255,255,0.15);border-radius:14px;padding:12px 14px;display:flex;flex-direction:column;justify-content:space-between;gap:8px">
        <div>
          ...
          <h3 style="margin:0 0 4px 0;font-size:14px;font-weight:800;color:#fff">
            <a href="/place/${encodeURIComponent(p.slug || p.id)}/" style="color:inherit;text-decoration:none">
              ${p.name}
            </a>
          </h3>
        ...
        <div style="display:flex;align-items:center;gap:6px;border-top:1px solid rgba(255,255,255,0.1);padding-top:8px">
          <a href="/place/${encodeURIComponent(p.slug || p.id)}/" class="btn btn-xs" style="flex:1;background:rgba(255,255,255,0.15);color:#fff;border-radius:6px;font-weight:700;text-align:center;text-decoration:none;padding:5px">
            التفاصيل ↗
          </a>
