import{getCategories as H,getPublishedPlaces as q,getActiveOffers as V,getAds as U}from"../../core/db.js";import{WORKER_URL as A}from"../../core/firebase.js";import"../../core/state.js";import{renderPlaceCard as D,renderPlaceCardSkeleton as Z}from"../components/PlaceCard.js";import{isAtmPlace as O}from"../../utils/atm.js";import{mountSponsoredShowcase as N,isPlaceSponsored as W}from"../components/SponsoredShowcase.js";import{formatPrice as T,calcDiscount as Q,arabicMatch as I}from"../../utils/arabic.js";import{daysUntil as G}from"../../utils/date.js";import{getCurrentUser as J}from"../../core/auth.js";import{openManzalaVoiceAssistantModal as K}from"../../services/voice.service.js";import{mountLivePulseSection as Y}from"../components/LivePulseSection.js?v=c1cf1c7c";import{mountAroundMeRadar as X}from"../components/AroundMeRadar.js";import{executeFastSearch as ee}from"../../services/search-engine.service.js";import{getCategorySvg as ae}from"../../utils/professions-data.js";import{getCategoryVisualMeta as te,renderCategoryCardIcon as ie}from"../../utils/category-visual.js";const qe={pharmacy:{emoji:"\u{1F48A}",color:"rgba(231,76,60,0.1)",border:"#E74C3C"},supermarket:{emoji:"\u{1F6D2}",color:"rgba(39,174,96,0.1)",border:"#27AE60"},paint:{emoji:"\u{1F3A8}",color:"rgba(155,89,182,0.1)",border:"#9B59B6"},herbs:{emoji:"\u{1F33F}",color:"rgba(39,174,96,0.1)",border:"#27AE60"},doctor:{emoji:"\u{1F468}\u200D\u2695\uFE0F",color:"rgba(41,128,185,0.1)",border:"#2980B9"},plumbing:{emoji:"\u{1F527}",color:"rgba(52,73,94,0.1)",border:"#52596E"},plumber:{emoji:"\u{1FAA0}",color:"rgba(41,128,185,0.1)",border:"#2980B9"},carpenter:{emoji:"\u{1FA9A}",color:"rgba(230,126,34,0.1)",border:"#E67E22"},tiler:{emoji:"\u{1F9F1}",color:"rgba(155,89,182,0.1)",border:"#9B59B6"},painter:{emoji:"\u{1F58C}\uFE0F",color:"rgba(241,196,15,0.1)",border:"#F1C40F"},electrician:{emoji:"\u26A1",color:"rgba(243,156,18,0.1)",border:"#F39C12"},"ac-technician":{emoji:"\u2744\uFE0F",color:"rgba(52,152,219,0.1)",border:"#3498DB"},blacksmith:{emoji:"\u{1F6E0}\uFE0F",color:"rgba(52,73,94,0.1)",border:"#52596E"},alumital:{emoji:"\u{1FA9F}",color:"rgba(149,165,166,0.1)",border:"#95A5A6"},mechanic:{emoji:"\u{1F529}",color:"rgba(231,76,60,0.1)",border:"#E74C3C"},upholsterer:{emoji:"\u{1F6CB}\uFE0F",color:"rgba(155,89,182,0.1)",border:"#9B59B6"},feed:{emoji:"\u{1F33E}",color:"rgba(243,156,18,0.1)",border:"#F39C12"},poultry:{emoji:"\u{1F357}",color:"rgba(243,156,18,0.1)",border:"#F39C12"},bakery:{emoji:"\u{1F35E}",color:"rgba(230,126,34,0.1)",border:"#E67E22"},vegetables:{emoji:"\u{1F96C}",color:"rgba(39,174,96,0.1)",border:"#27AE60"},antiques:{emoji:"\u{1F3FA}",color:"rgba(149,165,166,0.1)",border:"#95A5A6"},electronics:{emoji:"\u{1F4FA}",color:"rgba(41,128,185,0.1)",border:"#2980B9"},carpet:{emoji:"\u{1F9F6}",color:"rgba(155,89,182,0.1)",border:"#9B59B6"},mattress:{emoji:"\u{1F6CF}\uFE0F",color:"rgba(52,152,219,0.1)",border:"#3498DB"},china:{emoji:"\u{1F37D}\uFE0F",color:"rgba(231,76,60,0.1)",border:"#E74C3C"},electrical:{emoji:"\u{1F4A1}",color:"rgba(241,196,15,0.1)",border:"#F1C40F"},roastery:{emoji:"\u{1F95C}",color:"rgba(101,67,33,0.1)",border:"#654321"},phones:{emoji:"\u{1F4F1}",color:"rgba(41,128,185,0.1)",border:"#2980B9"},grocery:{emoji:"\u{1F3EA}",color:"rgba(39,174,96,0.1)",border:"#27AE60"},hypermarket:{emoji:"\u{1F3EC}",color:"rgba(27,79,114,0.1)",border:"#1B4F72"},delivery:{emoji:"\u{1F680}",color:"rgba(231,76,60,0.1)",border:"#E74C3C"}},Ve={emoji:"\u{1F3EA}",color:"rgba(27,79,114,0.1)",border:"#1B4F72"};export async function renderHomePage(n,{user:t}={}){n.innerHTML=be(),P();try{const[e,a,r,s]=await Promise.all([H(),q({limit:100}),V(8),U("homepage")]),o=J()||t,d=a||[];if(typeof window<"u"&&Array.isArray(d)){window._placesRegistry=window._placesRegistry||new Map;for(const i of d){if(!i)continue;const g=String(i.slug||i.id||i._key||"").toLowerCase().trim();g&&(window._placesRegistry.set(g,i),i.id&&window._placesRegistry.set(String(i.id).toLowerCase().trim(),i),i.slug&&window._placesRegistry.set(String(i.slug).toLowerCase().trim(),i))}}Y("home-live-pulse-container"),X("home-around-me-container"),N("home-sponsored-container",d,{title:"\u0623\u0645\u0627\u0643\u0646 \u0648\u0625\u0639\u0644\u0627\u0646\u0627\u062A \u0645\u0645\u064A\u0632\u0629 \u0641\u064A \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629",subtitle:"\u0623\u0646\u0634\u0637\u0629 \u062A\u062C\u0627\u0631\u064A\u0629 \u0648\u062E\u062F\u0645\u0627\u062A \u0645\u0648\u0635\u0649 \u0628\u0647\u0627 \u0648\u0645\u0639\u062A\u0645\u062F\u0629 \u0641\u064A \u0627\u0644\u0645\u062F\u064A\u0646\u0629",maxVisible:4}),se(e||[]),P(d);const l=re(d,o?.uid);ce(l.slice(0,8)),le(r||[]),de(d.filter(i=>i.categoryId?.includes("delivery")||i.deliveryType)),pe(s||[]);try{import("../components/WideAdsBanner.js").then(({mountWideAdsBanner:i})=>i("wide-ads-banner")).catch(()=>{})}catch{}he(e||[]),fe(),ue(),ge(d.length||0,e?.length||31),ye()}catch{}}function re(n,t=null,e=!1){const a=new Set,r=[],s=[];return[...n].sort((l,i)=>{const g=Number(l.createdAt)||Number(l.updatedAt)||0;return(Number(i.createdAt)||Number(i.updatedAt)||0)-g}).forEach(l=>{const i=l._key||l.id;a.has(i)||(a.add(i),W(l)?r.push(l):s.push(l))}),[...e?oe(r):r,...s]}function se(n){const t=document.getElementById("categories-grid");!t||!n||(t.innerHTML=n.map(e=>{const a=e.slug||e._key||e.id||"",r=te(e),s=ie(e,{size:40});return`
    ...
    `}).join("")}const o=_.length,d=[];for(let l=0;l<Math.min(4,o);l++)d.push(_[(k+l)%o]);if(s(d),C&&(clearInterval(C),C=null),o>=2){let l=1;C=setInterval(()=>{t.querySelectorAll(".fair-place-card").forEach(g=>g.classList.add("anim-swap")),setTimeout(()=>{k=(k+1)%_.length,l++;const g=[],p=_.length;for(let v=0;v<Math.min(4,p);v++)g.push(_[(k+v)%p]);s(g),e&&(e.innerHTML=`\u{1F7E2} <b>\u062A\u0645 \u062A\u062F\u0648\u064A\u0631 \u0627\u0644\u0635\u062F\u0627\u0631\u0629 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B (${l}):</b> \u062A\u062A\u063A\u064A\u0631 \u0627\u0644\u0645\u0631\u0627\u0643\u0632 \u062F\u0648\u0631\u064A\u0627\u064B \u0644\u0636\u0645\u0627\u0646 \u062A\u0643\u0627\u0641\u0624 \u0646\u0633\u0628 \u0627\u0644\u0645\u0634\u0627\u0647\u062F\u0629 \u0644\u0643\u0627\u0641\u0629 \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0627\u0644\u0645\u0648\u062B\u0642\u0629!`)},300)},4500)}}function oe(n){const t=[...n];for(let e=t.length-1;e>0;e--){const a=Math.floor(Math.random()*(e+1));[t[e],t[a]]=[t[a],t[e]]}return t}function ce(n){const t=document.getElementById("latest-places-grid");if(t){if(!n||!n.length){t.innerHTML=`
    ...
    `;return}t.innerHTML=n.map(e=>D(e)).join("")}}function le(n){const t=document.getElementById("offers-scroll"),e=document.getElementById("offers-section");if(t){if(!n||!n.length){e?.remove();return}t.innerHTML=n.map(a=>{const r=a.discountPercent||Q(a.oldPrice,a.newPrice),s=G(a.endDate);return`
    ...
    `}).join("")}}function de(n){const t=document.getElementById("delivery-grid"),e=document.getElementById("delivery-section");if(!t)return;if(!n||!n.length){e?.remove();return}const a={motorcycle:"\u{1F3CD}\uFE0F",tuktuk:"\u{1F6FA}",car:"\u{1F697}"};t.innerHTML=n.slice(0,6).map(r=>{const s=r.slug||r._key||r.id||"";return`
  ...
  `}).join("")}function pe(n){const t=document.getElementById("ads-container");if(!t||!n||!n.length)return;const e=n.filter(a=>a&&(a.imageUrl||a.image_url));if(!e.length){t.innerHTML="";return}t.innerHTML=e.map(a=>{let r=(a.link||"#").trim();r.startsWith("place.html")&&(r="/"+r);const s=a.id||a._id||"",o=a.title||"\u0625\u0639\u0644\u0627\u0646 \u0645\u0645\u064A\u0632",d=a.imageUrl||a.image_url||"";return`
      <a href="${m(r)}" class="ad-banner" target="_blank" rel="noopener noreferrer sponsored" aria-label="${m(o)}" data-ad-id="${m(s)}">
  ...
  `,ve(e)}function ve(n){let t=!1,e=!1;function a(){if(e)return;e=!0;const r=n.querySelectorAll(".stats-bar__value[data-target]");if(!r.length){e=!1;return}const s=1800,o=performance.now();r.forEach(i=>{i.classList.remove("stats-done"),i.classList.add("stats-counting")});let d=-1;function l(i){const g=i-o,p=Math.min(1,g/s),v=1-Math.pow(1-p,3);r.forEach(h=>{const c=parseInt(h.getAttribute("data-target"),10)||0,b=h.getAttribute("data-prefix")||"",f=h.getAttribute("data-suffix")||"",x=Math.floor(v*c);if(h.textContent=`${b}${x.toLocaleString("en-US")}${f}`,x!==d){d=x;const u=420+x/Math.max(1,c)*430;w.playTick(u)}}),p<1?requestAnimationFrame(l):(r.forEach(h=>{const c=parseInt(h.getAttribute("data-target"),10)||0,b=h.getAttribute("data-prefix")||"",f=h.getAttribute("data-suffix")||"";h.textContent=`${b}${c.toLocaleString("en-US")}${f}`,h.classList.remove("stats-counting"),h.classList.add("stats-done")}),w.playDoneChime(),e=!1)}requestAnimationFrame(l)}if("IntersectionObserver"in window){const r=new IntersectionObserver(s=>{s.forEach(o=>{o.isIntersecting&&!t&&(t=!0,a(),r.disconnect())})},{threshold:.15});r.observe(n)}else a();n.querySelectorAll(".stats-interactive-item").forEach(r=>{r.addEventListener("click",()=>{w.init(),w.ctx&&w.ctx.state==="suspended"&&w.ctx.resume().catch(()=>{}),a()})})}function he(n){const t=document.getElementById("hero-search-glow-wrap"),e=document.getElementById("hero-search-input"),a=document.getElementById("hero-search-btn"),r=document.getElementById("hero-search-clear"),s=document.getElementById("hero-live-dropdown"),o=document.getElementById("hero-live-list"),d=document.getElementById("hero-live-count"),l=document.getElementById("hero-live-all-btn");if(!e)return;const i=document.getElementById("hero-quick-cats");i&&n&&(i.innerHTML=n.slice(0,10).map(c=>{const b=c.slug||c._key||c.id||"",f=ae(b||c.name,18);return`
        <a href="category.html?slug=${encodeURIComponent(b)}" class="hero__quick-cat">
          ${f||c.icon||"\u{1F3EA}"} ${y(c.name)}
        </a>
      `}).join(""));function g(){const c=e.value.trim();c&&(window.location.href=`search.html?q=${encodeURIComponent(c)}`)}a?.addEventListener("click",c=>{c.stopPropagation(),g()}),e.addEventListener("keydown",c=>{c.key==="Enter"?g():c.key==="Escape"&&s?.classList.remove("visible")}),r?.addEventListener("click",c=>{c.stopPropagation(),e.value="",r.classList.remove("visible"),s?.classList.remove("visible"),o&&(o.innerHTML=""),e.focus()}),e.addEventListener("focus",()=>{e.value.trim().length>=1&&o?.children.length>0&&s?.classList.add("visible")});let p=null,v=0;e.addEventListener("input",()=>{const c=e.value.trim();if(r?.classList.toggle("visible",c.length>0),l&&(l.href=`search.html?q=${encodeURIComponent(c)}`),!c){s?.classList.remove("visible"),o&&(o.innerHTML="");return}clearTimeout(p),p=setTimeout(async()=>{const b=++v;try{const f=await ee(c,{limit:6});if(b!==v||!s||!o)return;if(!f||f.length===0){d&&(d.textContent="0"),o.innerHTML=`
          ...
          `,s.classList.add("visible");return}d&&(d.textContent=String(f.length)),o.innerHTML=f.map(x=>{const u=x.raw||x,L=u.name||"\u0645\u0643\u0627\u0646 \u0628\u0627\u0644\u062F\u0644\u064A\u0644",S=u.categoryName||x.category||"",z=u.area||u.address||"\u0645\u062F\u064A\u0646\u0629 \u0627\u0644\u0645\u0646\u0632\u0644\u0629",F=u.slug||u.id||"",$=u.photoURL||u.logo||u.coverURL||"",R=u.isVerified||!1,B=u.isOpen!==void 0?u.isOpen:!0,E=(L.trim()[0]||"\u0645").toUpperCase();return`
  ...
  `}function y(n){return n?String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):""}function m(n){return n?String(n).replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function ye(){try{let r=function(){try{localStorage.setItem("__has_seen_welcome_video_v1","true")}catch{}e&&e.pause(),t.style.opacity="0";const s=t.querySelector(".first-visit-video-card");s&&(s.style.transform="scale(0.92)"),setTimeout(()=>{t&&t.parentNode&&t.parentNode.removeChild(t)},350)};return}catch(n){console.warn("[Welcome Video] error:",n)}}
