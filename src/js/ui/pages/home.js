import{getCategories as H,getPublishedPlaces as q,getActiveOffers as V,getAds as U}from"../../core/db.js";import{WORKER_URL as A}from"../../core/firebase.js";import"../../core/state.js";import{renderPlaceCard as D,renderPlaceCardSkeleton as Z}from"../components/PlaceCard.js";import{isAtmPlace as O}from"../../utils/atm.js";import{mountSponsoredShowcase as N,isPlaceSponsored as W}from"../components/SponsoredShowcase.js";import{formatPrice as T,calcDiscount as Q,arabicMatch as I}from"../../utils/arabic.js";import{daysUntil as G}from"../../utils/date.js";import{getCurrentUser as J}from"../../core/auth.js";import{openManzalaVoiceAssistantModal as K}from"../../services/voice.service.js";import{mountLivePulseSection as Y}from"../components/LivePulseSection.js?v=c1cf1c7c";import{mountAroundMeRadar as X}from"../components/AroundMeRadar.js";import{executeFastSearch as ee}from"../../services/search-engine.service.js";import{getCategorySvg as ae}from"../../utils/professions-data.js";import{getCategoryVisualMeta as te,renderCategoryCardIcon as ie}from"../../utils/category-visual.js";const qe={pharmacy:{emoji:"\u{1F48A}",color:"rgba(231,76,60,0.1)",border:"#E74C3C"},supermarket:{emoji:"\u{1F6D2}",color:"rgba(39,174,96,0.1)",border:"#27AE60"},paint:{emoji:"\u{1F3A8}",color:"rgba(155,89,182,0.1)",border:"#9B59B6"},herbs:{emoji:"\u{1F33F}",color:"rgba(39,174,96,0.1)",border:"#27AE60"},doctor:{emoji:"\u{1F468}\u200D\u2695\uFE0F",color:"rgba(41,128,185,0.1)",border:"#2980B9"},plumbing:{emoji:"\u{1F527}",color:"rgba(52,73,94,0.1)",border:"#52596E"},plumber:{emoji:"\u{1FAA0}",color:"rgba(41,128,185,0.1)",border:"#2980B9"},carpenter:{emoji:"\u{1FA9A}",color:"rgba(230,126,34,0.1)",border:"#E67E22"},tiler:{emoji:"\u{1F9F1}",color:"rgba(155,89,182,0.1)",border:"#9B59B6"},painter:{emoji:"\u{1F58C}\uFE0F",color:"rgba(241,196,15,0.1)",border:"#F1C40F"},electrician:{emoji:"\u26A1",color:"rgba(243,156,18,0.1)",border:"#F39C12"},"ac-technician":{emoji:"\u2744\uFE0F",color:"rgba(52,152,219,0.1)",border:"#3498DB"},blacksmith:{emoji:"\u{1F6E0}\uFE0F",color:"rgba(52,73,94,0.1)",border:"#52596E"},alumital:{emoji:"\u{1FA9F}",color:"rgba(149,165,166,0.1)",border:"#95A5A6"},mechanic:{emoji:"\u{1F529}",color:"rgba(231,76,60,0.1)",border:"#E74C3C"},upholsterer:{emoji:"\u{1F6CB}\uFE0F",color:"rgba(155,89,182,0.1)",border:"#9B59B6"},feed:{emoji:"\u{1F33E}",color:"rgba(243,156,18,0.1)",border:"#F39C12"},poultry:{emoji:"\u{1F357}",color:"rgba(243,156,18,0.1)",border:"#F39C12"},bakery:{emoji:"\u{1F35E}",color:"rgba(230,126,34,0.1)",border:"#E67E22"},vegetables:{emoji:"\u{1F96C}",color:"rgba(39,174,96,0.1)",border:"#27AE60"},antiques:{emoji:"\u{1F3FA}",color:"rgba(149,165,166,0.1)",border:"#95A5A6"},electronics:{emoji:"\u{1F4FA}",color:"rgba(41,128,185,0.1)",border:"#2980B9"},carpet:{emoji:"\u{1F9F6}",color:"rgba(155,89,182,0.1)",border:"#9B59B6"},mattress:{emoji:"\u{1F6CF}\uFE0F",color:"rgba(52,152,219,0.1)",border:"#3498DB"},china:{emoji:"\u{1F37D}\uFE0F",color:"rgba(231,76,60,0.1)",border:"#E74C3C"},electrical:{emoji:"\u{1F4A1}",color:"rgba(241,196,15,0.1)",border:"#F1C40F"},roastery:{emoji:"\u{1F95C}",color:"rgba(101,67,33,0.1)",border:"#654321"},phones:{emoji:"\u{1F4F1}",color:"rgba(41,128,185,0.1)",border:"#2980B9"},grocery:{emoji:"\u{1F3EA}",color:"rgba(39,174,96,0.1)",border:"#27AE60"},hypermarket:{emoji:"\u{1F3EC}",color:"rgba(27,79,114,0.1)",border:"#1B4F72"},delivery:{emoji:"\u{1F680}",color:"rgba(231,76,60,0.1)",border:"#E74C3C"}},Ve={emoji:"\u{1F3EA}",color:"rgba(27,79,114,0.1)",border:"#1B4F72"};export async function renderHomePage(o,{user:t}={}){o.innerHTML=be(),P();try{const[e,a,r,s]=await Promise.all([H(),q({limit:100}),V(8),U("homepage")]),n=J()||t,d=a||[];if(typeof window<"u"&&Array.isArray(d)){window._placesRegistry=window._placesRegistry||new Map;for(const i of d){if(!i)continue;const g=String(i.slug||i.id||i._key||"").toLowerCase().trim();g&&(window._placesRegistry.set(g,i),i.id&&window._placesRegistry.set(String(i.id).toLowerCase().trim(),i),i.slug&&window._placesRegistry.set(String(i.slug).toLowerCase().trim(),i))}}Y("home-live-pulse-container"),X("home-around-me-container"),N("home-sponsored-container",d,{title:"\u0623\u0645\u0627\u0643\u0646 \u0648\u0625\u0639\u0644\u0627\u0646\u0627\u062A \u0645\u0645\u064A\u0632\u0629 \u0641\u064A \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629",subtitle:"\u0623\u0646\u0634\u0637\u0629 \u062A\u062C\u0627\u0631\u064A\u0629 \u0648\u062E\u062F\u0645\u0627\u062A \u0645\u0648\u0635\u0649 \u0628\u0647\u0627 \u0648\u0645\u0639\u062A\u0645\u062F\u0629 \u0641\u064A \u0627\u0644\u0645\u062F\u064A\u0646\u0629",maxVisible:4}),se(e||[]),P(d);const l=re(d,n?.uid);ce(l.slice(0,8)),le(r||[]),de(d.filter(i=>i.categoryId?.includes("delivery")||i.deliveryType)),pe(s||[]);try{import("../components/WideAdsBanner.js").then(({mountWideAdsBanner:i})=>i("wide-ads-banner")).catch(()=>{})}catch{}he(e||[]),fe(),ue(),ge(d.length||0,e?.length||31),ye()}catch{}}function re(o,t=null,e=!1){const a=new Set,r=[],s=[];return[...o].sort((l,i)=>{const g=Number(l.createdAt)||Number(l.updatedAt)||0;return(Number(i.createdAt)||Number(i.updatedAt)||0)-g}).forEach(l=>{const i=l._key||l.id;a.has(i)||(a.add(i),W(l)?r.push(l):s.push(l))}),[...e?ne(r):r,...s]}function se(o){const t=document.getElementById("categories-grid");!t||!o||(t.innerHTML=o.map(e=>{const a=e.slug||e._key||e.id||"",r=te(e),s=ie(e,{size:40});return`
    ...
    `}).join(""))}const j="manzala_verified_showcase_v1";let C=null,_=[],k=0;const oe=[{id:"p_1788703900620_oae8ka",slug:"mtam-basl-wbaha-llmakwlat-albhrya",name:"\u0645\u0637\u0639\u0645 \u0628\u0627\u0633\u0644 \u0648\u0628\u0627\u0647\u0649 \u0644\u0644\u0645\u0623\u0643\u0648\u0644\u0627\u062A \u0627\u0644\u0628\u062D\u0631\u064A\u0629",area:"\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u062F\u0642\u0647\u0644\u064A\u0629",category:"\u0645\u0637\u0627\u0639\u0645 \u0648\u0623\u0633\u0645\u0627\u0643",cover:"https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&w=300&h=180&q=75",isSponsored:!0},{id:"-P03LX9MledW_z7QfyHO",slug:"-P03LX9MledW_z7QfyHO",name:"\u0627\u0644\u062D\u0633\u0646 \u0644\u0635\u064A\u0627\u0646\u0629 \u0627\u0644\u0647\u0648\u0627\u062A\u0641 \u0627\u0644\u0645\u062D\u0645\u0648\u0644\u0629",area:"\u0627\u0644\u0645\u0646\u0632\u0644\u0629 - \u0634\u0627\u0631\u0639 \u0627\u0644\u0628\u062D\u0631",category:"\u0635\u064A\u0627\u0646\u0629 \u0648\u0645\u0648\u0628\u0627\u064A\u0644",cover:"https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=300&h=180&q=75",isSponsored:!0},{id:"p_1788801925745_vuxmjs",slug:"mtbkh-eyma-llaakl-albyty",name:"\u0645\u0637\u0628\u062E \u0625\u064A\u0645\u0649 \u0644\u0644\u0623\u0643\u0644 \u0627\u0644\u0628\u064A\u062A\u064A",area:"\u0627\u0644\u0645\u0646\u0632\u0644\u0629 - \u0637\u0631\u064A\u0642 \u0627\u0644\u0645\u0646\u0635\u0648\u0631\u0629",category:"\u0623\u0643\u0644 \u0628\u064A\u062A\u064A \u0648\u062D\u0644\u0648\u064A\u0627\u062A",cover:"https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=300&h=180&q=75",isSponsored:!1},{id:"-P0hEa0K6ZfAM65O27G9",slug:"kwafyr-mnh-asad",name:"\u0643\u0648\u0627\u0641\u064A\u0631 \u0645\u0646\u0647 \u0623\u0633\u0639\u062F",area:"\u0627\u0644\u0645\u0646\u0632\u0644\u0629 - \u062D\u064A \u0627\u0644\u0633\u0644\u0627\u0645",category:"\u0628\u064A\u0648\u062A\u064A \u0648\u0643\u0648\u0627\u0641\u064A\u0631",cover:"https://images.unsplash.com/photo-1560066984-138dadb4c035?auto=format&fit=crop&w=300&h=180&q=75",isSponsored:!1}];function P(o=null){const t=document.getElementById("home-verified-cards-grid"),e=document.getElementById("home-verified-status-text");if(!t)return;let a=null;try{const l=localStorage.getItem(j);if(l){const i=JSON.parse(l);Array.isArray(i)&&i.length>0&&(a=i)}}catch{}if(Array.isArray(o)&&o.length>0){const l=o.filter(i=>i&&i.isVerified&&!O(i)).map(i=>({id:i.id||i._key,slug:i.slug||i.id,name:i.name,area:i.area||"\u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629",category:i.categoryName||i.customCategory||i.categoryId||"\u0646\u0634\u0627\u0637 \u062A\u062C\u0627\u0631\u064A",cover:i.coverImageUrl||i.logoUrl||i.gallery&&i.gallery[0]||"/assets/images/og-whatsapp.jpg",isSponsored:!!(i.isSponsored&&(!i.sponsoredUntil||i.sponsoredUntil>Date.now()))}));if(l.length>0){_=l;try{localStorage.setItem(j,JSON.stringify(l))}catch{}}}else _.length||(a&&a.length>0?_=a:_=[...oe]);const r=["\u{1F947} \u0627\u0644\u0635\u062F\u0627\u0631\u0629 #1","\u{1F948} \u0627\u0644\u0635\u062F\u0627\u0631\u0629 #2","\u{1F949} \u0627\u0644\u0635\u062F\u0627\u0631\u0629 #3","\u{1F396}\uFE0F \u0627\u0644\u0635\u062F\u0627\u0631\u0629 #4"];function s(l){t.innerHTML=l.map((i,g)=>{const p=i.slug||i.id||"";return`
      <article class="fair-place-card" data-card-index="${g}"
        ...
        <span class="fair-place-card__rank">${r[g]||`\u{1F396}\uFE0F \u0627\u0644\u0635\u062F\u0627\u0631\u0629 #${g+1}`}</span>
        <div class="fair-place-card__cover">
          <img src="${m(i.cover)}" alt="${m(i.name)}" loading="lazy" onerror="this.src='/assets/images/og-whatsapp.jpg'">
        ...
        <div class="fair-place-card__body">
          <h3 class="fair-place-card__title" title="${m(i.name)}">${y(i.name)}</h3>
    ...
    `;return}t.innerHTML=o.map(e=>D(e)).join("")}}function le(o){const t=document.getElementById("offers-scroll"),e=document.getElementById("offers-section");if(t){if(!o||!o.length){e?.remove();return}t.innerHTML=o.map(a=>{const r=a.discountPercent||Q(a.oldPrice,a.newPrice),s=G(a.endDate);return`
    ...
    <a href="/place.html?slug=${encodeURIComponent(s)}" class="delivery-card"
      ...
      <div class="delivery-card__icon">${a[r.deliveryType]||"\u{1F680}"}</div>
  ...
  `}).join("")}function pe(o){const t=document.getElementById("ads-container");if(!t||!o||!o.length)return;const e=o.filter(a=>a&&(a.imageUrl||a.image_url));if(!e.length){t.innerHTML="";return}t.innerHTML=e.map(a=>{let r=(a.link||"#").trim();r.startsWith("place.html")&&(r="/"+r);const s=a.id||a._id||"",n=a.title||"\u0625\u0639\u0644\u0627\u0646 \u0645\u0645\u064A\u0632",d=a.imageUrl||a.image_url||"";return`
      <a href="${m(r)}" class="ad-banner" target="_blank" rel="noopener noreferrer sponsored" aria-label="${m(n)}" data-ad-id="${m(s)}">
    ...
    `}).join(""),t.querySelectorAll(".ad-banner").forEach(a=>{a.addEventListener("click",()=>{const r=a.getAttribute("data-ad-id");if(r&&A)try{fetch(`${A}/api/ads/track-click`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:r}),keepalive:!0}).catch(()=>{})}catch{}})})}class me{constructor(){this.ctx=null,this.lastTickTime=0}init(){if(!this.ctx&&typeof window<"u"){const t=window.AudioContext||window.webkitAudioContext;t&&(this.ctx=new t)}}playTick(t=550){try{if(!this.ctx||this.ctx.state!=="running")return;const e=this.ctx.currentTime;if(e-this.lastTickTime<.038)return;this.lastTickTime=e;const a=this.ctx.createOscillator(),r=this.ctx.createGain();a.type="sine",a.frequency.setValueAtTime(t,e),a.frequency.exponentialRampToValueAtTime(t*1.35,e+.018),r.gain.setValueAtTime(.04,e),r.gain.exponentialRampToValueAtTime(1e-4,e+.022),a.connect(r),r.connect(this.ctx.destination),a.start(e),a.stop(e+.028)}catch{}}playDoneChime(){try{if(!this.ctx||this.ctx.state!=="running")return;const t=this.ctx.currentTime;[1046.5,1318.51,1567.98,2093].forEach((a,r)=>{const s=this.ctx.createOscillator(),n=this.ctx.createGain();s.type="triangle",s.frequency.setValueAtTime(a,t+r*.055),n.gain.setValueAtTime(.06,t+r*.055),n.gain.exponentialRampToValueAtTime(1e-4,t+r*.055+.32),s.connect(n),n.connect(this.ctx.destination),s.start(t+r*.055),s.stop(t+r*.055+.35)})}catch{}}}const w=new me;function ge(o,t){const e=document.getElementById("stats-bar");if(!e)return;const a=Math.max(15e3,Number(o)||0),r=Math.max(94,Number(t)||0),s=55,n=5e4,d=12e3;e.innerHTML=`
  ...
  `,ve(e)}function ve(o){let t=!1,e=!1;function a(){if(e)return;e=!0;const r=o.querySelectorAll(".stats-bar__value[data-target]");if(!r.length){e=!1;return}const s=1800,n=performance.now();r.forEach(i=>{i.classList.remove("stats-done"),i.classList.add("stats-counting")});let d=-1;function l(i){const g=i-n,p=Math.min(1,g/s),v=1-Math.pow(1-p,3);r.forEach(h=>{const c=parseInt(h.getAttribute("data-target"),10)||0,b=h.getAttribute("data-prefix")||"",f=h.getAttribute("data-suffix")||"",x=Math.floor(v*c);if(h.textContent=`${b}${x.toLocaleString("en-US")}${f}`,x!==d){d=x;const u=420+x/Math.max(1,c)*430;w.playTick(u)}}),p<1?requestAnimationFrame(l):(r.forEach(h=>{const c=parseInt(h.getAttribute("data-target"),10)||0,b=h.getAttribute("data-prefix")||"",f=h.getAttribute("data-suffix")||"";h.textContent=`${b}${c.toLocaleString("en-US")}${f}`,h.classList.remove("stats-counting"),h.classList.add("stats-done")}),w.playDoneChime(),e=!1)}requestAnimationFrame(l)}if("IntersectionObserver"in window){const r=new IntersectionObserver(s=>{s.forEach(n=>{n.isIntersecting&&!t&&(t=!0,a(),r.disconnect())})},{threshold:.15});r.observe(o)}else a();o.querySelectorAll(".stats-interactive-item").forEach(r=>{r.addEventListener("click",()=>{w.init(),w.ctx&&w.ctx.state==="suspended"&&w.ctx.resume().catch(()=>{}),a()})})}function he(o){const t=document.getElementById("hero-search-glow-wrap"),e=document.getElementById("hero-search-input"),a=document.getElementById("hero-search-btn"),r=document.getElementById("hero-search-clear"),s=document.getElementById("hero-live-dropdown"),n=document.getElementById("hero-live-list"),d=document.getElementById("hero-live-count"),l=document.getElementById("hero-live-all-btn");if(!e)return;const i=document.getElementById("hero-quick-cats");i&&o&&(i.innerHTML=o.slice(0,10).map(c=>{const b=c.slug||c._key||c.id||"",f=ae(b||c.name,18);return`
        <a href="category.html?slug=${encodeURIComponent(b)}" class="hero__quick-cat">
          ${f||c.icon||"\u{1F3EA}"} ${y(c.name)}
        </a>
      `}).join(""));function g(){const c=e.value.trim();c&&(window.location.href=`search.html?q=${encodeURIComponent(c)}`)}a?.addEventListener("click",c=>{c.stopPropagation(),g()}),e.addEventListener("keydown",c=>{c.key==="Enter"?g():c.key==="Escape"&&s?.classList.remove("visible")}),r?.addEventListener("click",c=>{c.stopPropagation(),e.value="",r.classList.remove("visible"),s?.classList.remove("visible"),n&&(n.innerHTML=""),e.focus()}),e.addEventListener("focus",()=>{e.value.trim().length>=1&&n?.children.length>0&&s?.classList.add("visible")});let p=null,v=0;e.addEventListener("input",()=>{const c=e.value.trim();if(r?.classList.toggle("visible",c.length>0),l&&(l.href=`search.html?q=${encodeURIComponent(c)}`),!c){s?.classList.remove("visible"),n&&(n.innerHTML="");return}clearTimeout(p),p=setTimeout(async()=>{const b=++v;try{const f=await ee(c,{limit:6});if(b!==v||!s||!n)return;if(!f||f.length===0){d&&(d.textContent="0"),n.innerHTML=`
  ...
  `}function y(o){return o?String(o).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):""}function m(o){return o?String(o).replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function ye(){try{let r=function(){try{localStorage.setItem("__has_seen_welcome_video_v1","true")}catch{}e&&e.pause(),t.style.opacity="0";const s=t.querySelector(".first-visit-video-card");s&&(s.style.transform="scale(0.92)"),setTimeout(()=>{t&&t.parentNode&&t.parentNode.removeChild(t)},350)};return}catch(o){console.warn("[Welcome Video] error:",o)}}
