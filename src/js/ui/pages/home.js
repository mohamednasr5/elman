import{getCategories as V,getPublishedPlaces as D,getActiveOffers as Z,getAds as N}from"../../core/db.js";import{WORKER_URL as T}from"../../core/firebase.js";import"../../core/state.js";import{renderPlaceCard as O,renderPlaceCardSkeleton as W}from"../components/PlaceCard.js";import{isAtmPlace as Q}from"../../utils/atm.js";import{mountSponsoredShowcase as G,isPlaceSponsored as J}from"../components/SponsoredShowcase.js";import{formatPrice as P,calcDiscount as K,arabicMatch as j}from"../../utils/arabic.js";import{daysUntil as Y}from"../../utils/date.js";import{getCurrentUser as X}from"../../core/auth.js";import{openManzalaVoiceAssistantModal as ee}from"../../services/voice.service.js";import{executeFastSearch as ae}from"../../services/search-engine.service.js";import{getCategorySvg as te}from"../../utils/professions-data.js";import{getCategoryVisualMeta as ie,renderCategoryCardIcon as re}from"../../utils/category-visual.js";const Re={pharmacy:{emoji:"\u{1F48A}",color:"rgba(231,76,60,0.1)",border:"#E74C3C"},supermarket:{emoji:"\u{1F6D2}",color:"rgba(39,174,96,0.1)",border:"#27AE60"},paint:{emoji:"\u{1F3A8}",color:"rgba(155,89,182,0.1)",border:"#9B59B6"},herbs:{emoji:"\u{1F33F}",color:"rgba(39,174,96,0.1)",border:"#27AE60"},doctor:{emoji:"\u{1F468}\u200D\u2695\uFE0F",color:"rgba(41,128,185,0.1)",border:"#2980B9"},plumbing:{emoji:"\u{1F527}",color:"rgba(52,73,94,0.1)",border:"#52596E"},plumber:{emoji:"\u{1FAA0}",color:"rgba(41,128,185,0.1)",border:"#2980B9"},carpenter:{emoji:"\u{1FA9A}",color:"rgba(230,126,34,0.1)",border:"#E67E22"},tiler:{emoji:"\u{1F9F1}",color:"rgba(155,89,182,0.1)",border:"#9B59B6"},painter:{emoji:"\u{1F58C}\uFE0F",color:"rgba(241,196,15,0.1)",border:"#F1C40F"},electrician:{emoji:"\u26A1",color:"rgba(243,156,18,0.1)",border:"#F39C12"},"ac-technician":{emoji:"\u2744\uFE0F",color:"rgba(52,152,219,0.1)",border:"#3498DB"},blacksmith:{emoji:"\u{1F6E0}\uFE0F",color:"rgba(52,73,94,0.1)",border:"#52596E"},alumital:{emoji:"\u{1FA9F}",color:"rgba(149,165,166,0.1)",border:"#95A5A6"},mechanic:{emoji:"\u{1F529}",color:"rgba(231,76,60,0.1)",border:"#E74C3C"},upholsterer:{emoji:"\u{1F6CB}\uFE0F",color:"rgba(155,89,182,0.1)",border:"#9B59B6"},feed:{emoji:"\u{1F33E}",color:"rgba(243,156,18,0.1)",border:"#F39C12"},poultry:{emoji:"\u{1F357}",color:"rgba(243,156,18,0.1)",border:"#F39C12"},bakery:{emoji:"\u{1F35E}",color:"rgba(230,126,34,0.1)",border:"#E67E22"},vegetables:{emoji:"\u{1F96C}",color:"rgba(39,174,96,0.1)",border:"#27AE60"},antiques:{emoji:"\u{1F3FA}",color:"rgba(149,165,166,0.1)",border:"#95A5A6"},electronics:{emoji:"\u{1F4FA}",color:"rgba(41,128,185,0.1)",border:"#2980B9"},carpet:{emoji:"\u{1F9F6}",color:"rgba(155,89,182,0.1)",border:"#9B59B6"},mattress:{emoji:"\u{1F6CF}\uFE0F",color:"rgba(52,152,219,0.1)",border:"#3498DB"},china:{emoji:"\u{1F37D}\uFE0F",color:"rgba(231,76,60,0.1)",border:"#E74C3C"},electrical:{emoji:"\u{1F4A1}",color:"rgba(241,196,15,0.1)",border:"#F1C40F"},roastery:{emoji:"\u{1F95C}",color:"rgba(101,67,33,0.1)",border:"#654321"},phones:{emoji:"\u{1F4F1}",color:"rgba(41,128,185,0.1)",border:"#2980B9"},grocery:{emoji:"\u{1F3EA}",color:"rgba(39,174,96,0.1)",border:"#27AE60"},hypermarket:{emoji:"\u{1F3EC}",color:"rgba(27,79,114,0.1)",border:"#1B4F72"},delivery:{emoji:"\u{1F680}",color:"rgba(231,76,60,0.1)",border:"#E74C3C"}},ze={emoji:"\u{1F3EA}",color:"rgba(27,79,114,0.1)",border:"#1B4F72"};export async function renderHomePage(n,{user:r}={}){const a=document.getElementById("hero-section-static");if(!!!a)n.innerHTML=H(),U();else{a.removeAttribute("id");const i=[];let o=a.nextSibling;for(;o;)i.push(o),o=o.nextSibling;i.forEach(l=>l.parentNode&&l.parentNode.removeChild(l));const d=document.createElement("div");d.innerHTML=H();const h=d.querySelector(".hero");for(h&&h.remove();d.firstChild;)n.appendChild(d.firstChild);U()}z();try{const[i,o,d,h]=await Promise.all([V(),D({limit:100}),Z(8),N("homepage")]),l=X()||r,t=o||[];if(typeof window<"u"&&Array.isArray(t)){window._placesRegistry=window._placesRegistry||new Map;for(const c of t){if(!c)continue;const g=String(c.slug||c.id||c._key||"").toLowerCase().trim();g&&(window._placesRegistry.set(g,c),c.id&&window._placesRegistry.set(String(c.id).toLowerCase().trim(),c),c.slug&&window._placesRegistry.set(String(c.slug).toLowerCase().trim(),c))}}se(i||[]),z(t);const v=oe(t,l?.uid);le(v.slice(0,8)),de(d||[]),pe(t.filter(c=>c.categoryId?.includes("delivery")||c.deliveryType)),me(h||[]),he(t.length||0,i?.length||31),fe(i||[]),ue(),Promise.resolve().then(()=>{import("../components/WhoIsAvailableNow.js").then(({renderWhoIsAvailableNow:c})=>{const g=document.getElementById("home-oncall-craftsmen-container");g&&c(g)}).catch(()=>{}),import("../components/ServiceRequestsSection.js").then(({renderServiceRequestsSection:c})=>{const g=document.getElementById("home-service-requests-container");g&&c(g,{limit:4,showHero:!0,isCompact:!0})}).catch(()=>{}),import("../components/AroundMeRadar.js").then(({mountAroundMeRadar:c})=>{c("home-around-me-container")}).catch(()=>{}),G("home-sponsored-container",t,{title:"\u0623\u0645\u0627\u0643\u0646 \u0648\u0625\u0639\u0644\u0627\u0646\u0627\u062A \u0645\u0645\u064A\u0632\u0629 \u0641\u064A \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629",subtitle:"\u0623\u0646\u0634\u0637\u0629 \u062A\u062C\u0627\u0631\u064A\u0629 \u0648\u062E\u062F\u0645\u0627\u062A \u0645\u0648\u0635\u0649 \u0628\u0647\u0627 \u0648\u0645\u0639\u062A\u0645\u062F\u0629 \u0641\u064A \u0627\u0644\u0645\u062F\u064A\u0646\u0629",maxVisible:4});try{import("../components/WideAdsBanner.js").then(({mountWideAdsBanner:c})=>c("wide-ads-banner")).catch(()=>{})}catch{}be()})}catch{}}function oe(n,r=null,a=!1){const e=new Set,i=[],o=[];return[...n].sort((l,t)=>{const v=Number(l.createdAt)||Number(l.updatedAt)||0;return(Number(t.createdAt)||Number(t.updatedAt)||0)-v}).forEach(l=>{const t=l._key||l.id;e.has(t)||(e.add(t),J(l)?i.push(l):o.push(l))}),[...a?ce(i):i,...o]}function se(n){const r=document.getElementById("categories-grid");!r||!n||(r.innerHTML=n.map(a=>{const e=a.slug||a._key||a.id||"",i=ie(a),o=re(a,{size:40});return`
    ...
    `}).join(""))}const R="manzala_verified_showcase_v1";let $=null,y=[],S=0;const ne=[{id:"p_1788703900620_oae8ka",slug:"mtam-basl-wbaha-llmakwlat-albhrya",name:"\u0645\u0637\u0639\u0645 \u0628\u0627\u0633\u0644 \u0648\u0628\u0627\u0647\u0649 \u0644\u0644\u0645\u0623\u0643\u0648\u0644\u0627\u062A \u0627\u0644\u0628\u062D\u0631\u064A\u0629",area:"\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u062F\u0642\u0647\u0644\u064A\u0629",address:"\u0627\u0644\u0645\u0637\u0631\u064A\u0629 - \u0634 \u0627\u0644\u062B\u0648\u0631\u0629",phone:"01062944644",whatsapp:"01062944644",category:"\u0645\u0637\u0627\u0639\u0645 \u0648\u0623\u0633\u0645\u0627\u0643",cover:"https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&w=300&h=180&q=75",coverImageUrl:"https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&w=300&h=180&q=75",isSponsored:!0},{id:"-P03LX9MledW_z7QfyHO",slug:"-P03LX9MledW_z7QfyHO",name:"\u0627\u0644\u062D\u0633\u0646 \u0644\u0635\u064A\u0627\u0646\u0629 \u0627\u0644\u0647\u0648\u0627\u062A\u0641 \u0627\u0644\u0645\u062D\u0645\u0648\u0644\u0629",area:"\u0627\u0644\u0645\u0646\u0632\u0644\u0629 - \u0634\u0627\u0631\u0639 \u0627\u0644\u0628\u062D\u0631",address:"\u0627\u0644\u0645\u0646\u0632\u0644\u0629 - \u0634\u0627\u0631\u0639 \u0627\u0644\u0628\u062D\u0631 \u0623\u0645\u0627\u0645 \u0627\u0644\u0628\u0646\u0643",phone:"01026046049",whatsapp:"01026046049",category:"\u0635\u064A\u0627\u0646\u0629 \u0648\u0645\u0648\u0628\u0627\u064A\u0644",cover:"https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=300&h=180&q=75",coverImageUrl:"https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=300&h=180&q=75",isSponsored:!0},{id:"p_1788801925745_vuxmjs",slug:"mtbkh-eyma-llaakl-albyty",name:"\u0645\u0637\u0628\u062E \u0625\u064A\u0645\u0649 \u0644\u0644\u0623\u0643\u0644 \u0627\u0644\u0628\u064A\u062A\u064A",area:"\u0627\u0644\u0645\u0646\u0632\u0644\u0629 - \u0637\u0631\u064A\u0642 \u0627\u0644\u0645\u0646\u0635\u0648\u0631\u0629",address:"\u0627\u0644\u0645\u0646\u0632\u0644\u0629 - \u0637\u0631\u064A\u0642 \u0627\u0644\u0645\u0646\u0635\u0648\u0631\u0629 \u0627\u0644\u0631\u0626\u064A\u0633\u064A",phone:"01090123456",whatsapp:"01090123456",category:"\u0623\u0643\u0644 \u0628\u064A\u062A\u064A \u0648\u062D\u0644\u0648\u064A\u0627\u062A",cover:"https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=300&h=180&q=75",coverImageUrl:"https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=300&h=180&q=75",isSponsored:!1},{id:"-P0hEa0K6ZfAM65O27G9",slug:"kwafyr-mnh-asad",name:"\u0643\u0648\u0627\u0641\u064A\u0631 \u0645\u0646\u0647 \u0623\u0633\u0639\u062F",area:"\u0627\u0644\u0645\u0646\u0632\u0644\u0629 - \u062D\u064A \u0627\u0644\u0633\u0644\u0627\u0645",address:"\u0627\u0644\u0645\u0646\u0632\u0644\u0629 - \u062D\u064A \u0627\u0644\u0633\u0644\u0627\u0645",phone:"01099887766",whatsapp:"01099887766",category:"\u0628\u064A\u0648\u062A\u064A \u0648\u0643\u0648\u0627\u0641\u064A\u0631",cover:"https://images.unsplash.com/photo-1560066984-138dadb4c035?auto=format&fit=crop&w=300&h=180&q=75",coverImageUrl:"https://images.unsplash.com/photo-1560066984-138dadb4c035?auto=format&fit=crop&w=300&h=180&q=75",isSponsored:!1}];function z(n=null){const r=document.getElementById("home-verified-cards-grid"),a=document.getElementById("home-verified-status-text");if(!r)return;let e=null;try{const l=localStorage.getItem(R);if(l){const t=JSON.parse(l);Array.isArray(t)&&t.length>0&&(e=t)}}catch{}if(Array.isArray(n)&&n.length>0){const l=n.filter(t=>t&&t.isVerified&&!Q(t)).map(t=>({...t,id:t.id||t._key,slug:t.slug||t.id,name:t.name,area:t.area||"\u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629",address:t.address||"",phone:t.phone||"",whatsapp:t.whatsapp||"",logoUrl:t.logoUrl||"",coverImageUrl:t.coverImageUrl||t.gallery&&t.gallery[0]||"",category:t.categoryName||t.customCategory||t.categoryId||"\u0646\u0634\u0627\u0637 \u062A\u062C\u0627\u0631\u064A",cover:t.coverImageUrl||t.logoUrl||t.gallery&&t.gallery[0]||"/assets/images/og-whatsapp.jpg",isSponsored:!!(t.isSponsored&&(!t.sponsoredUntil||t.sponsoredUntil>Date.now()))}));if(l.length>0){y=l;try{localStorage.setItem(R,JSON.stringify(l))}catch{}}}else y.length||(e&&e.length>0?y=e:y=[...ne]);if(typeof window<"u"&&Array.isArray(y)){window._placesRegistry=window._placesRegistry||new Map;for(const l of y){if(!l)continue;const t=String(l.slug||l.id||"").toLowerCase().trim();t&&(window._placesRegistry.set(t,l),l.slug&&window._placesRegistry.set(String(l.slug).toLowerCase().trim(),l),l.id&&window._placesRegistry.set(String(l.id).toLowerCase().trim(),l))}}const i=["\u{1F947} \u0627\u0644\u0635\u062F\u0627\u0631\u0629 #1","\u{1F948} \u0627\u0644\u0635\u062F\u0627\u0631\u0629 #2","\u{1F949} \u0627\u0644\u0635\u062F\u0627\u0631\u0629 #3","\u{1F396}\uFE0F \u0627\u0644\u0635\u062F\u0627\u0631\u0629 #4"];function o(l){r.innerHTML=l.map((t,v)=>{const c=t.slug||t.id||"";return`
      <article class="fair-place-card" data-card-index="${v}"
               ...
               onclick="window.__openPlaceCard ? window.__openPlaceCard(this, '${s(c)}', event) : (window.location.href='/place.html?slug=${encodeURIComponent(c)}')"
               ontouchstart="window.__prefetchPlaceCard && window.__prefetchPlaceCard('${s(c)}', this)"
               onpointerdown="window.__prefetchPlaceCard && window.__prefetchPlaceCard('${s(c)}', this)"
               onmouseenter="window.__prefetchPlaceCard && window.__prefetchPlaceCard('${s(c)}', this)"
        ...
        <div class="fair-place-card__body">
          ...
          <a href="/place.html?slug=${encodeURIComponent(c)}" class="fair-place-card__link" onclick="event.preventDefault(); window.__openPlaceCard ? window.__openPlaceCard(this, '${s(c)}', event) : (window.location.href='/place.html?slug=${encodeURIComponent(c)}')">\u0639\u0631\u0636 \u0628\u0637\u0627\u0642\u0629 \u0627\u0644\u0645\u0643\u0627\u0646 \u2197</a>
        </div>
      </article>
    `}).join("")}const d=y.length,h=[];for(let l=0;l<Math.min(4,d);l++)h.push(y[(S+l)%d]);if(o(h),$&&(clearInterval($),$=null),d>=2){let l=1;$=setInterval(()=>{r.querySelectorAll(".fair-place-card").forEach(v=>v.classList.add("anim-swap")),setTimeout(()=>{S=(S+1)%y.length,l++;const v=[],c=y.length;for(let g=0;g<Math.min(4,c);g++)v.push(y[(S+g)%c]);o(v),a&&(a.innerHTML=`\u{1F7E2} <b>\u062A\u0645 \u062A\u062F\u0648\u064A\u0631 \u0627\u0644\u0635\u062F\u0627\u0631\u0629 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B (${l}):</b> \u062A\u062A\u063A\u064A\u0631 \u0627\u0644\u0645\u0631\u0627\u0643\u0632 \u062F\u0648\u0631\u064A\u0627\u064B \u0644\u0636\u0645\u0627\u0646 \u062A\u0643\u0627\u0641\u0624 \u0646\u0633\u0628 \u0627\u0644\u0645\u0634\u0627\u0647\u062F\u0629 \u0644\u0643\u0627\u0641\u0629 \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0627\u0644\u0645\u0648\u062B\u0642\u0629!`)},300)},4500)}}function ce(n){const r=[...n];for(let a=r.length-1;a>0;a--){const e=Math.floor(Math.random()*(a+1));[r[a],r[e]]=[r[e],r[a]]}return r}function le(n){const r=document.getElementById("latest-places-grid");if(r){if(!n||!n.length){r.innerHTML=`
    ...
    `;return}r.innerHTML=n.map(a=>O(a)).join("")}}function de(n){const r=document.getElementById("offers-scroll"),a=document.getElementById("offers-section");if(r){if(!n||!n.length){a?.remove();return}r.innerHTML=n.map(e=>{const i=e.discountPercent||K(e.oldPrice,e.newPrice),o=Y(e.endDate);return`
      <article class="offer-card"
        ...
        <div class="offer-card__body">
          ...
          <div class="offer-card__price">
            <span class="offer-card__price-new">${P(e.newPrice)}</span>
            ${e.oldPrice?`<span class="offer-card__price-old">${P(e.oldPrice)}</span>`:""}
          </div>
          `:""}
    ...
    <a href="/place.html?slug=${encodeURIComponent(o)}" class="delivery-card"
      ...
      <div class="delivery-card__icon">${e[i.deliveryType]||"\u{1F680}"}</div>
  ...
  `}).join("")}function me(n){const r=document.getElementById("ads-container");if(!r||!n||!n.length)return;const a=n.filter(e=>e&&(e.imageUrl||e.image_url));if(!a.length){r.innerHTML="";return}r.innerHTML=a.map(e=>{let i=(e.link||"#").trim();i.startsWith("place.html")&&(i="/"+i);const o=e.id||e._id||"",d=e.title||"\u0625\u0639\u0644\u0627\u0646 \u0645\u0645\u064A\u0632",h=e.imageUrl||e.image_url||"";return`
    ...
    `}).join(""),r.querySelectorAll(".ad-banner").forEach(e=>{e.addEventListener("click",()=>{const i=e.getAttribute("data-ad-id");if(i&&T)try{fetch(`${T}/api/ads/track-click`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({id:i}),keepalive:!0}).catch(()=>{})}catch{}})})}class ge{constructor(){this.ctx=null,this.lastTickTime=0}init(){if(!this.ctx&&typeof window<"u"){const r=window.AudioContext||window.webkitAudioContext;r&&(this.ctx=new r)}}playTick(r=550){try{if(!this.ctx||this.ctx.state!=="running")return;const a=this.ctx.currentTime;if(a-this.lastTickTime<.038)return;this.lastTickTime=a;const e=this.ctx.createOscillator(),i=this.ctx.createGain();e.type="sine",e.frequency.setValueAtTime(r,a),e.frequency.exponentialRampToValueAtTime(r*1.35,a+.018),i.gain.setValueAtTime(.04,a),i.gain.exponentialRampToValueAtTime(1e-4,a+.022),e.connect(i),i.connect(this.ctx.destination),e.start(a),e.stop(a+.028)}catch{}}playDoneChime(){try{if(!this.ctx||this.ctx.state!=="running")return;const r=this.ctx.currentTime;[1046.5,1318.51,1567.98,2093].forEach((e,i)=>{const o=this.ctx.createOscillator(),d=this.ctx.createGain();o.type="triangle",o.frequency.setValueAtTime(e,r+i*.055),d.gain.setValueAtTime(.06,r+i*.055),d.gain.exponentialRampToValueAtTime(1e-4,r+i*.055+.32),o.connect(d),d.connect(this.ctx.destination),o.start(r+i*.055),o.stop(r+i*.055+.35)})}catch{}}}const C=new ge;function he(n,r){const a=document.getElementById("stats-bar");if(!a)return;const e=Math.max(191,Number(n)||0),i=Math.max(94,Number(r)||0),o=55;a.innerHTML=`
    <div class="stats-bar__inner container">
      <div class="stats-bar__item stats-interactive-item" title="\u0639\u062F\u062F \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0648\u0627\u0644\u0645\u062D\u0644\u0627\u062A \u0648\u0627\u0644\u0645\u0647\u0646 \u0627\u0644\u0645\u0633\u062C\u0644\u0629">
        <div class="stats-bar__value" data-target="${e}" data-prefix="+" data-suffix="">+${e}</div>
  ...
  `,ve(a)}function ve(n){let r=!1,a=!1;function e(){if(a)return;a=!0;const i=n.querySelectorAll(".stats-bar__value[data-target]");if(!i.length){a=!1;return}const o=1800,d=performance.now();i.forEach(t=>{t.classList.remove("stats-done"),t.classList.add("stats-counting")});let h=-1;function l(t){const v=t-d,c=Math.min(1,v/o),g=1-Math.pow(1-c,3);i.forEach(f=>{const p=parseInt(f.getAttribute("data-target"),10)||0,b=f.getAttribute("data-prefix")||"",u=f.getAttribute("data-suffix")||"",w=Math.floor(g*p);if(f.textContent=`${b}${w.toLocaleString("en-US")}${u}`,w!==h){h=w;const m=420+w/Math.max(1,p)*430;C.playTick(m)}}),c<1?requestAnimationFrame(l):(i.forEach(f=>{const p=parseInt(f.getAttribute("data-target"),10)||0,b=f.getAttribute("data-prefix")||"",u=f.getAttribute("data-suffix")||"";f.textContent=`${b}${p.toLocaleString("en-US")}${u}`,f.classList.remove("stats-counting"),f.classList.add("stats-done")}),C.playDoneChime(),a=!1)}requestAnimationFrame(l)}if("IntersectionObserver"in window){const i=new IntersectionObserver(o=>{o.forEach(d=>{d.isIntersecting&&!r&&(r=!0,e(),i.disconnect())})},{threshold:.15});i.observe(n)}else e();n.querySelectorAll(".stats-interactive-item").forEach(i=>{i.addEventListener("click",()=>{C.init(),C.ctx&&C.ctx.state==="suspended"&&C.ctx.resume().catch(()=>{}),e()})})}function fe(n){const r=document.getElementById("hero-search-glow-wrap"),a=document.getElementById("hero-search-input"),e=document.getElementById("hero-search-btn"),i=document.getElementById("hero-search-clear"),o=document.getElementById("hero-live-dropdown"),d=document.getElementById("hero-live-list"),h=document.getElementById("hero-live-count"),l=document.getElementById("hero-live-all-btn");if(!a)return;const t=document.getElementById("hero-quick-cats");t&&n&&(t.innerHTML=n.slice(0,10).map(p=>{const b=p.slug||p._key||p.id||"",u=te(b||p.name,18);return`
        <a href="category.html?slug=${encodeURIComponent(b)}" class="hero__quick-cat">
          ${u||p.icon||"\u{1F3EA}"} ${_(p.name)}
        </a>
      `}).join(""));function v(){const p=a.value.trim();p&&(window.location.href=`search.html?q=${encodeURIComponent(p)}`)}e?.addEventListener("click",p=>{p.stopPropagation(),v()}),a.addEventListener("keydown",p=>{p.key==="Enter"?v():p.key==="Escape"&&o?.classList.remove("visible")}),i?.addEventListener("click",p=>{p.stopPropagation(),a.value="",i.classList.remove("visible"),o?.classList.remove("visible"),d&&(d.innerHTML=""),a.focus()}),a.addEventListener("focus",()=>{a.value.trim().length>=1&&d?.children.length>0&&o?.classList.add("visible")});let c=null,g=0;a.addEventListener("input",()=>{const p=a.value.trim();if(i?.classList.toggle("visible",p.length>0),l&&(l.href=`search.html?q=${encodeURIComponent(p)}`),!p){o?.classList.remove("visible"),d&&(d.innerHTML="");return}clearTimeout(c),c=setTimeout(async()=>{const b=++g;try{const u=await ae(p,{limit:6});if(b!==g||!o||!d)return;if(!u||u.length===0){h&&(h.textContent="0"),d.innerHTML=`
  ...
  `}function _(n){return n?String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):""}function s(n){return n?String(n).replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function be(){try{let i=function(){try{localStorage.setItem("__has_seen_welcome_video_v1","true")}catch{}a&&a.pause(),r.style.opacity="0";const o=r.querySelector(".first-visit-video-card");o&&(o.style.transform="scale(0.92)"),setTimeout(()=>{r&&r.parentNode&&r.parentNode.removeChild(r)},350)};return}catch(n){console.warn("[Welcome Video] error:",n)}}
