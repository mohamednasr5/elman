import{getCategories as H,getPublishedPlaces as q,getActiveOffers as V,getAds as U}from"../../core/db.js";import{WORKER_URL as A}from"../../core/firebase.js";import"../../core/state.js";import{renderPlaceCard as D,renderPlaceCardSkeleton as Z}from"../components/PlaceCard.js";import{isAtmPlace as O}from"../../utils/atm.js";import{mountSponsoredShowcase as N,isPlaceSponsored as W}from"../components/SponsoredShowcase.js";import{formatPrice as T,calcDiscount as Q,arabicMatch as I}from"../../utils/arabic.js";import{daysUntil as G}from"../../utils/date.js";import{getCurrentUser as J}from"../../core/auth.js";import{openManzalaVoiceAssistantModal as K}from"../../services/voice.service.js";import{mountLivePulseSection as Y}from"../components/LivePulseSection.js?v=c1cf1c7c";import{mountAroundMeRadar as X}from"../components/AroundMeRadar.js";import{executeFastSearch as ee}from"../../services/search-engine.service.js";import{getCategorySvg as ae}from"../../utils/professions-data.js";import{getCategoryVisualMeta as te,renderCategoryCardIcon as ie}from"../../utils/category-visual.js";const qe={pharmacy:{emoji:"\u{1F48A}",color:"rgba(231,76,60,0.1)",border:"#E74C3C"},supermarket:{emoji:"\u{1F6D2}",color:"rgba(39,174,96,0.1)",border:"#27AE60"},paint:{emoji:"\u{1F3A8}",color:"rgba(155,89,182,0.1)",border:"#9B59B6"},herbs:{emoji:"\u{1F33F}",color:"rgba(39,174,96,0.1)",border:"#27AE60"},doctor:{emoji:"\u{1F468}\u200D\u2695\uFE0F",color:"rgba(41,128,185,0.1)",border:"#2980B9"},plumbing:{emoji:"\u{1F527}",color:"rgba(52,73,94,0.1)",border:"#52596E"},plumber:{emoji:"\u{1FAA0}",color:"rgba(41,128,185,0.1)",border:"#2980B9"},carpenter:{emoji:"\u{1FA9A}",color:"rgba(230,126,34,0.1)",border:"#E67E22"},tiler:{emoji:"\u{1F9F1}",color:"rgba(155,89,182,0.1)",border:"#9B59B6"},painter:{emoji:"\u{1F58C}\uFE0F",color:"rgba(241,196,15,0.1)",border:"#F1C40F"},electrician:{emoji:"\u26A1",color:"rgba(243,156,18,0.1)",border:"#F39C12"},"ac-technician":{emoji:"\u2744\uFE0F",color:"rgba(52,152,219,0.1)",border:"#3498DB"},blacksmith:{emoji:"\u{1F6E0}\uFE0F",color:"rgba(52,73,94,0.1)",border:"#52596E"},alumital:{emoji:"\u{1FA9F}",color:"rgba(149,165,166,0.1)",border:"#95A5A6"},mechanic:{emoji:"\u{1F529}",color:"rgba(231,76,60,0.1)",border:"#E74C3C"},upholsterer:{emoji:"\u{1F6CB}\uFE0F",color:"rgba(155,89,182,0.1)",border:"#9B59B6"},feed:{emoji:"\u{1F33E}",color:"rgba(243,156,18,0.1)",border:"#F39C12"},poultry:{emoji:"\u{1F357}",color:"rgba(243,156,18,0.1)",border:"#F39C12"},bakery:{emoji:"\u{1F35E}",color:"rgba(230,126,34,0.1)",border:"#E67E22"},vegetables:{emoji:"\u{1F96C}",color:"rgba(39,174,96,0.1)",border:"#27AE60"},antiques:{emoji:"\u{1F3FA}",color:"rgba(149,165,166,0.1)",border:"#95A5A6"},electronics:{emoji:"\u{1F4FA}",color:"rgba(41,128,185,0.1)",border:"#2980B9"},carpet:{emoji:"\u{1F9F6}",color:"rgba(155,89,182,0.1)",border:"#9B59B6"},mattress:{emoji:"\u{1F6CF}\uFE0F",color:"rgba(52,152,219,0.1)",border:"#3498DB"},china:{emoji:"\u{1F37D}\uFE0F",color:"rgba(231,76,60,0.1)",border:"#E74C3C"},electrical:{emoji:"\u{1F4A1}",color:"rgba(241,196,15,0.1)",border:"#F1C40F"},roastery:{emoji:"\u{1F95C}",color:"rgba(101,67,33,0.1)",border:"#654321"},phones:{emoji:"\u{1F4F1}",color:"rgba(41,128,185,0.1)",border:"#2980B9"},grocery:{emoji:"\u{1F3EA}",color:"rgba(39,174,96,0.1)",border:"#27AE60"},hypermarket:{emoji:"\u{1F3EC}",color:"rgba(27,79,114,0.1)",border:"#1B4F72"},delivery:{emoji:"\u{1F680}",color:"rgba(231,76,60,0.1)",border:"#E74C3C"}},Ve={emoji:"\u{1F3EA}",color:"rgba(27,79,114,0.1)",border:"#1B4F72"};export async function renderHomePage(o,{user:t}={}){o.innerHTML=be(),P();try{const[e,a,i,s]=await Promise.all([H(),q({limit:100}),V(8),U("homepage")]),n=J()||t,d=a||[];if(typeof window<"u"&&Array.isArray(d)){window._placesRegistry=window._placesRegistry||new Map;for(const r of d){if(!r)continue;const g=String(r.slug||r.id||r._key||"").toLowerCase().trim();g&&(window._placesRegistry.set(g,r),r.id&&window._placesRegistry.set(String(r.id).toLowerCase().trim(),r),r.slug&&window._placesRegistry.set(String(r.slug).toLowerCase().trim(),r))}}Y("home-live-pulse-container"),X("home-around-me-container"),N("home-sponsored-container",d,{title:"\u0623\u0645\u0627\u0643\u0646 \u0648\u0625\u0639\u0644\u0627\u0646\u0627\u062A \u0645\u0645\u064A\u0632\u0629 \u0641\u064A \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629",subtitle:"\u0623\u0646\u0634\u0637\u0629 \u062A\u062C\u0627\u0631\u064A\u0629 \u0648\u062E\u062F\u0645\u0627\u062A \u0645\u0648\u0635\u0649 \u0628\u0647\u0627 \u0648\u0645\u0639\u062A\u0645\u062F\u0629 \u0641\u064A \u0627\u0644\u0645\u062F\u064A\u0646\u0629",maxVisible:4}),se(e||[]),P(d);const l=re(d,n?.uid);ce(l.slice(0,8)),le(i||[]),de(d.filter(r=>r.categoryId?.includes("delivery")||r.deliveryType)),pe(s||[]),he(e||[]),fe(),ue(),ge(d.length||0,e?.length||31),ye()}catch{}}function re(o,t=null,e=!1){const a=new Set,i=[],s=[];return[...o].sort((l,r)=>{const g=Number(l.createdAt)||Number(l.updatedAt)||0;return(Number(r.createdAt)||Number(r.updatedAt)||0)-g}).forEach(l=>{const r=l._key||l.id;a.has(r)||(a.add(r),W(l)?i.push(l):s.push(l))}),[...e?ne(i):i,...s]}function se(o){const t=document.getElementById("categories-grid");!t||!o||(t.innerHTML=o.map(e=>{const a=e.slug||e._key||e.id||"",i=te(e),s=ie(e,{size:40});return`
    ...
    `}).join(""))}const j="manzala_verified_showcase_v1";let C=null,_=[],k=0;const oe=[{id:"p_1788703900620_oae8ka",slug:"mtam-basl-wbaha-llmakwlat-albhrya",name:"\u0645\u0637\u0639\u0645 \u0628\u0627\u0633\u0644 \u0648\u0628\u0627\u0647\u0649 \u0644\u0644\u0645\u0623\u0643\u0648\u0644\u0627\u062A \u0627\u0644\u0628\u062D\u0631\u064A\u0629",area:"\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u062F\u0642\u0647\u0644\u064A\u0629",category:"\u0645\u0637\u0627\u0639\u0645 \u0648\u0623\u0633\u0645\u0627\u0643",cover:"https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&w=300&h=180&q=75",isSponsored:!0},{id:"-P03LX9MledW_z7QfyHO",slug:"-P03LX9MledW_z7QfyHO",name:"\u0627\u0644\u062D\u0633\u0646 \u0644\u0635\u064A\u0627\u0646\u0629 \u0627\u0644\u0647\u0648\u0627\u062A\u0641 \u0627\u0644\u0645\u062D\u0645\u0648\u0644\u0629",area:"\u0627\u0644\u0645\u0646\u0632\u0644\u0629 - \u0634\u0627\u0631\u0639 \u0627\u0644\u0628\u062D\u0631",category:"\u0635\u064A\u0627\u0646\u0629 \u0648\u0645\u0648\u0628\u0627\u064A\u0644",cover:"https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?auto=format&fit=crop&w=300&h=180&q=75",isSponsored:!0},{id:"p_1788801925745_vuxmjs",slug:"mtbkh-eyma-llaakl-albyty",name:"\u0645\u0637\u0628\u062E \u0625\u064A\u0645\u0649 \u0644\u0644\u0623\u0643\u0644 \u0627\u0644\u0628\u064A\u062A\u064A",area:"\u0627\u0644\u0645\u0646\u0632\u0644\u0629 - \u0637\u0631\u064A\u0642 \u0627\u0644\u0645\u0646\u0635\u0648\u0631\u0629",category:"\u0623\u0643\u0644 \u0628\u064A\u062A\u064A \u0648\u062D\u0644\u0648\u064A\u0627\u062A",cover:"https://images.unsplash.com/photo-1504674900247-0877df9cc836?auto=format&fit=crop&w=300&h=180&q=75",isSponsored:!1},{id:"-P0hEa0K6ZfAM65O27G9",slug:"kwafyr-mnh-asad",name:"\u0643\u0648\u0627\u0641\u064A\u0631 \u0645\u0646\u0647 \u0623\u0633\u0639\u062F",area:"\u0627\u0644\u0645\u0646\u0632\u0644\u0629 - \u062D\u064A \u0627\u0644\u0633\u0644\u0627\u0645",category:"\u0628\u064A\u0648\u062A\u064A \u0648\u0643\u0648\u0627\u0641\u064A\u0631",cover:"https://images.unsplash.com/photo-1560066984-138dadb4c035?auto=format&fit=crop&w=300&h=180&q=75",isSponsored:!1}];function P(o=null){const t=document.getElementById("home-verified-cards-grid"),e=document.getElementById("home-verified-status-text");if(!t)return;let a=null;try{const l=localStorage.getItem(j);if(l){const r=JSON.parse(l);Array.isArray(r)&&r.length>0&&(a=r)}}catch{}if(Array.isArray(o)&&o.length>0){const l=o.filter(r=>r&&r.isVerified&&!O(r)).map(r=>({id:r.id||r._key,slug:r.slug||r.id,name:r.name,area:r.area||"\u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629",category:r.categoryName||r.customCategory||r.categoryId||"\u0646\u0634\u0627\u0637 \u062A\u062C\u0627\u0631\u064A",cover:r.coverImageUrl||r.logoUrl||r.gallery&&r.gallery[0]||"/assets/images/og-whatsapp.jpg",isSponsored:!!(r.isSponsored&&(!r.sponsoredUntil||r.sponsoredUntil>Date.now()))}));if(l.length>0){_=l;try{localStorage.setItem(j,JSON.stringify(l))}catch{}}}else _.length||(a&&a.length>0?_=a:_=[...oe]);const i=["\u{1F947} \u0627\u0644\u0635\u062F\u0627\u0631\u0629 #1","\u{1F948} \u0627\u0644\u0635\u062F\u0627\u0631\u0629 #2","\u{1F949} \u0627\u0644\u0635\u062F\u0627\u0631\u0629 #3","\u{1F396}\uFE0F \u0627\u0644\u0635\u062F\u0627\u0631\u0629 #4"];function s(l){t.innerHTML=l.map((r,g)=>{const p=r.slug||r.id||"";return`
      <article class="fair-place-card" data-card-index="${g}"
        ...
        <span class="fair-place-card__rank">${i[g]||`\u{1F396}\uFE0F \u0627\u0644\u0635\u062F\u0627\u0631\u0629 #${g+1}`}</span>
        <div class="fair-place-card__cover">
          <img src="${m(r.cover)}" alt="${m(r.name)}" loading="lazy" onerror="this.src='/assets/images/og-whatsapp.jpg'">
          <div class="fair-place-card__badges">
            ${r.isSponsored?'<span class="fair-badge-sponsored">\u2B50 \u0625\u0639\u0644\u0627\u0646 \u0645\u0645\u064A\u0632</span>':""}
            <span class="fair-badge-verified">\u2713 \u0645\u0648\u062B\u0642 \u0631\u0633\u0645\u064A\u0627\u064B</span>
          </div>
        </div>
        <div class="fair-place-card__body">
          <h3 class="fair-place-card__title" title="${m(r.name)}">${y(r.name)}</h3>
          <div class="fair-place-card__meta">
            <span>\u{1F4CD} ${y(r.area)}</span>
            <span>\u{1F3F7}\uFE0F ${y(r.category)}</span>
          </div>
    ...
    `}).join("")}const n=_.length,d=[];for(let l=0;l<Math.min(4,n);l++)d.push(_[(k+l)%n]);if(s(d),C&&(clearInterval(C),C=null),n>=2){let l=1;C=setInterval(()=>{t.querySelectorAll(".fair-place-card").forEach(g=>g.classList.add("anim-swap")),setTimeout(()=>{k=(k+1)%_.length,l++;const g=[],p=_.length;for(let v=0;v<Math.min(4,p);v++)g.push(_[(k+v)%p]);s(g),e&&(e.innerHTML=`\u{1F7E2} <b>\u062A\u0645 \u062A\u062F\u0648\u064A\u0631 \u0627\u0644\u0635\u062F\u0627\u0631\u0629 \u062A\u0644\u0642\u0627\u0626\u064A\u0627\u064B (${l}):</b> \u062A\u062A\u063A\u064A\u0631 \u0627\u0644\u0645\u0631\u0627\u0643\u0632 \u062F\u0648\u0631\u064A\u0627\u064B \u0644\u0636\u0645\u0627\u0646 \u062A\u0643\u0627\u0641\u0624 \u0646\u0633\u0628 \u0627\u0644\u0645\u0634\u0627\u0647\u062F\u0629 \u0644\u0643\u0627\u0641\u0629 \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0627\u0644\u0645\u0648\u062B\u0642\u0629!`)},300)},4500)}}function ne(o){const t=[...o];for(let e=t.length-1;e>0;e--){const a=Math.floor(Math.random()*(e+1));[t[e],t[a]]=[t[a],t[e]]}return t}function ce(o){const t=document.getElementById("latest-places-grid");if(t){if(!o||!o.length){t.innerHTML=`
    ...
    `;return}t.innerHTML=o.map(e=>D(e)).join("")}}function le(o){const t=document.getElementById("offers-scroll"),e=document.getElementById("offers-section");if(t){if(!o||!o.length){e?.remove();return}t.innerHTML=o.map(a=>{const i=a.discountPercent||Q(a.oldPrice,a.newPrice),s=G(a.endDate);return`
      <article class="offer-card"
               onclick="window.__openPlaceCard ? window.__openPlaceCard(this, '${m(a.placeSlug||"")}', event) : (window.location.href='/place.html?slug=${encodeURIComponent(a.placeSlug||"")}')"
               onpointerdown="window.__prefetchPlaceCard && window.__prefetchPlaceCard('${m(a.placeSlug||"")}')"
               onmouseenter="window.__prefetchPlaceCard && window.__prefetchPlaceCard('${m(a.placeSlug||"")}')"
               style="cursor:pointer">
        <div class="offer-card__image">
          ${a.imageUrl?`<img src="${m(a.imageUrl)}" alt="${m(a.title)}" loading="lazy" />`:'<div style="width:100%;height:100%;background:var(--primary-alpha);display:flex;align-items:center;justify-content:center;font-size:2rem">\u{1F3F7}\uFE0F</div>'}
    ...
    `}).join("")}}function de(o){const t=document.getElementById("delivery-grid"),e=document.getElementById("delivery-section");if(!t)return;if(!o||!o.length){e?.remove();return}const a={motorcycle:"\u{1F3CD}\uFE0F",tuktuk:"\u{1F6FA}",car:"\u{1F697}"};t.innerHTML=o.slice(0,6).map(i=>{const s=i.slug||i._key||i.id||"";return`
    <a href="/place.html?slug=${encodeURIComponent(s)}" class="delivery-card"
       onclick="event.preventDefault(); window.__openPlaceCard ? window.__openPlaceCard(this, '${m(s)}', event) : (window.location.href='/place.html?slug=${encodeURIComponent(s)}')"
       onpointerdown="window.__prefetchPlaceCard && window.__prefetchPlaceCard('${m(s)}')"
       onmouseenter="window.__prefetchPlaceCard && window.__prefetchPlaceCard('${m(s)}')">
  ...
  `}).join("")}function pe(o){const t=document.getElementById("ads-container");if(!t||!o||!o.length)return;const e=o.filter(a=>a&&(a.imageUrl||a.image_url));if(!e.length){t.innerHTML="";return}t.innerHTML=e.map(a=>{let i=(a.link||"#").trim();i.startsWith("place.html")&&(i="/"+i);const s=a.id||a._id||"",n=a.title||"\u0625\u0639\u0644\u0627\u0646 \u0645\u0645\u064A\u0632",d=a.imageUrl||a.image_url||"";return`
      <a href="${m(i)}" class="ad-banner" target="_blank" rel="noopener noreferrer sponsored" aria-label="${m(n)}" data-ad-id="${m(s)}">
    ...
    <div class="stats-bar__inner container">
      ...
      <div class="stats-bar__item stats-interactive-item" title="\u0639\u062F\u062F \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0648\u0627\u0644\u0645\u062D\u0644\u0627\u062A \u0648\u0627\u0644\u0645\u0647\u0646 \u0627\u0644\u0645\u0633\u062C\u0644\u0629">
        <div class="stats-bar__value" data-target="${a}" data-prefix="+" data-suffix="">+0</div>
      ...
      <div class="stats-bar__item stats-interactive-item" title="\u0627\u0644\u0645\u062F\u0646 \u0648\u0627\u0644\u0642\u0631\u0649 \u0627\u0644\u0645\u063A\u0637\u0627\u0629 \u0628\u0627\u0644\u0643\u0627\u0645\u0644">
        <div class="stats-bar__value" data-target="${s}" data-prefix="+" data-suffix="">+0</div>
  ...
  `,ve(e)}function ve(o){let t=!1,e=!1;function a(){if(e)return;e=!0;const i=o.querySelectorAll(".stats-bar__value[data-target]");if(!i.length){e=!1;return}const s=1800,n=performance.now();i.forEach(r=>{r.classList.remove("stats-done"),r.classList.add("stats-counting")});let d=-1;function l(r){const g=r-n,p=Math.min(1,g/s),v=1-Math.pow(1-p,3);i.forEach(h=>{const c=parseInt(h.getAttribute("data-target"),10)||0,b=h.getAttribute("data-prefix")||"",f=h.getAttribute("data-suffix")||"",x=Math.floor(v*c);if(h.textContent=`${b}${x.toLocaleString("en-US")}${f}`,x!==d){d=x;const u=420+x/Math.max(1,c)*430;w.playTick(u)}}),p<1?requestAnimationFrame(l):(i.forEach(h=>{const c=parseInt(h.getAttribute("data-target"),10)||0,b=h.getAttribute("data-prefix")||"",f=h.getAttribute("data-suffix")||"";h.textContent=`${b}${c.toLocaleString("en-US")}${f}`,h.classList.remove("stats-counting"),h.classList.add("stats-done")}),w.playDoneChime(),e=!1)}requestAnimationFrame(l)}if("IntersectionObserver"in window){const i=new IntersectionObserver(s=>{s.forEach(n=>{n.isIntersecting&&!t&&(t=!0,a(),i.disconnect())})},{threshold:.15});i.observe(o)}else a();o.querySelectorAll(".stats-interactive-item").forEach(i=>{i.addEventListener("click",()=>{w.init(),w.ctx&&w.ctx.state==="suspended"&&w.ctx.resume().catch(()=>{}),a()})})}function he(o){const t=document.getElementById("hero-search-glow-wrap"),e=document.getElementById("hero-search-input"),a=document.getElementById("hero-search-btn"),i=document.getElementById("hero-search-clear"),s=document.getElementById("hero-live-dropdown"),n=document.getElementById("hero-live-list"),d=document.getElementById("hero-live-count"),l=document.getElementById("hero-live-all-btn");if(!e)return;const r=document.getElementById("hero-quick-cats");r&&o&&(r.innerHTML=o.slice(0,10).map(c=>{const b=c.slug||c._key||c.id||"",f=ae(b||c.name,18);return`
        <a href="category.html?slug=${encodeURIComponent(b)}" class="hero__quick-cat">
          ${f||c.icon||"\u{1F3EA}"} ${y(c.name)}
        </a>
      `}).join(""));function g(){const c=e.value.trim();c&&(window.location.href=`search.html?q=${encodeURIComponent(c)}`)}a?.addEventListener("click",c=>{c.stopPropagation(),g()}),e.addEventListener("keydown",c=>{c.key==="Enter"?g():c.key==="Escape"&&s?.classList.remove("visible")}),i?.addEventListener("click",c=>{c.stopPropagation(),e.value="",i.classList.remove("visible"),s?.classList.remove("visible"),n&&(n.innerHTML=""),e.focus()}),e.addEventListener("focus",()=>{e.value.trim().length>=1&&n?.children.length>0&&s?.classList.add("visible")});let p=null,v=0;e.addEventListener("input",()=>{const c=e.value.trim();if(i?.classList.toggle("visible",c.length>0),l&&(l.href=`search.html?q=${encodeURIComponent(c)}`),!c){s?.classList.remove("visible"),n&&(n.innerHTML="");return}clearTimeout(p),p=setTimeout(async()=>{const b=++v;try{const f=await ee(c,{limit:6});if(b!==v||!s||!n)return;if(!f||f.length===0){d&&(d.textContent="0"),n.innerHTML=`
          ...
          `,s.classList.add("visible");return}d&&(d.textContent=String(f.length)),n.innerHTML=f.map(x=>{const u=x.raw||x,L=u.name||"\u0645\u0643\u0627\u0646 \u0628\u0627\u0644\u062F\u0644\u064A\u0644",S=u.categoryName||x.category||"",z=u.area||u.address||"\u0645\u062F\u064A\u0646\u0629 \u0627\u0644\u0645\u0646\u0632\u0644\u0629",F=u.slug||u.id||"",$=u.photoURL||u.logo||u.coverURL||"",R=u.isVerified||!1,B=u.isOpen!==void 0?u.isOpen:!0,E=(L.trim()[0]||"\u0645").toUpperCase();return`
            <a href="/place.html?slug=${encodeURIComponent(F)}" class="hero-live-dropdown__item" role="option">
              <div class="hero-live-avatar">
                ${$?`<img src="${m($)}" alt="${m(L)}" loading="lazy" onerror="this.onerror=null;this.parentElement.innerHTML='<div class=\\'hero-live-avatar-fallback\\'>${E}</div>'"/>`:`<div class="hero-live-avatar-fallback">${E}</div>`}
              </div>
              <div class="hero-live-content">
                <div class="hero-live-title-row">
                  <span class="hero-live-name">${y(L)}</span>
                  ${R?'<span class="hero-live-verified" title="\u0645\u0643\u0627\u0646 \u0645\u0648\u062B\u0642">\u2713</span>':""}
                </div>
    ...
    <section class="section" style="background:var(--surface);padding-block:var(--space-8);border-bottom:1px solid var(--border)">
      <div class="container">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill, minmax(130px, 1fr));gap:10px;margin-top:14px" id="villages-grid-container">
          ${o.map(t=>`
            <a href="places.html?area=${encodeURIComponent(t.name)}" class="category-card village-grid-item" data-name="${m(t.name)}" style="padding:12px 8px;text-align:center;text-decoration:none;border-radius:var(--radius-md);transition:all 0.2s ease;display:flex;flex-direction:column;align-items:center" title="\u062F\u0644\u064A\u0644 \u0623\u0645\u0627\u0643\u0646 \u0648\u062E\u062F\u0645\u0627\u062A ${t.name}">
  ...
  `}function y(o){return o?String(o).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):""}function m(o){return o?String(o).replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function ye(){try{let i=function(){try{localStorage.setItem("__has_seen_welcome_video_v1","true")}catch{}e&&e.pause(),t.style.opacity="0";const s=t.querySelector(".first-visit-video-card");s&&(s.style.transform="scale(0.92)"),setTimeout(()=>{t&&t.parentNode&&t.parentNode.removeChild(t)},350)};return}catch(o){console.warn("[Welcome Video] error:",o)}}
