...
async function render(container) {
  ...
  if (p === 'place') {
    ...
    return renderPlacePage(container, { slug: parts()[1] || q.get('slug') || '', user });
  }
  if (p === 'category') {
