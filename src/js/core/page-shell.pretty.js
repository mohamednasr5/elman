...
function _footerHTML() {
  ...
  const groups = isEn ? [
    ...
    {title:'Support & Contact',links:[['/en/about.html','About Us'],['/en/legal/','Legal Policy'],['/en/contact/','Contact Us'],['/en/terms/','Terms & Conditions'],['/en/privacy/','Privacy Policy'],['/en/manzala/','About El Manzala'],['/en/matariya/','About El Matariya']]}
  ] : [
