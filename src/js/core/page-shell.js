import{ensureFirebaseReady as q}from"./firebase.js";import{initAuth as F,onAuthStateChange as R,signOut as U,waitForAuth as N,isAdmin as g,getCurrentUser as W,getClientIp as j}from"./auth.js";import{getSettings as V,isIpBanned as K}from"./db.js";import{toast as r}from"../ui/components/Toast.js";import{bindGlobalVoiceAssistantFab as O,openManzalaVoiceAssistantModal as S}from"../services/voice.service.js";import{initRealtimePwaSyncBus as G}from"../services/realtime-sync.service.js";import{initLiveNotificationSubscriber as Y}from"../services/notification.service.js";import{initFcmMessaging as J}from"../services/fcm.service.js";import{initUniversalMobileTouchTooltips as Q}from"../utils/mobile-tooltip.js";import{executeFastSearch as X}from"../services/search-engine.service.js";import{mountWideAdsBanner as Z}from"../ui/components/WideAdsBanner.js";function ee(t){return`
<header class="header" id="site-header" role="banner">
  <div class="container header__inner">
    ...
    <nav class="header__nav" aria-label="\u0627\u0644\u062A\u0646\u0642\u0644 \u0627\u0644\u0631\u0626\u064A\u0633\u064A">
      ${[["index.html","\u0627\u0644\u0631\u0626\u064A\u0633\u064A\u0629"],["places.html","\u0627\u0644\u0623\u0645\u0627\u0643\u0646"],["categories.html","\u0627\u0644\u062A\u0635\u0646\u064A\u0641\u0627\u062A"],["offers.html","\u0627\u0644\u0639\u0631\u0648\u0636"],["now.html","\u064A\u062D\u062F\u062B \u0627\u0644\u0622\u0646 \u{1F525}"],["around-me.html","\u0628\u0627\u0644\u0642\u0631\u0628 \u0645\u0646\u064A \u{1F9ED}"],["favorites.html","\u2764\uFE0F \u0627\u0644\u0645\u0641\u0636\u0644\u0629"]].map(([i,n])=>`<a href="${i}" class="header__nav-link${i===t?" active":""}">${n}</a>`).join("")}
    </nav>
...
</header>`}function te(t){if(t==="admin/index.html")return`
...
<div class="pwa-banner" id="pwa-banner" hidden role="dialog" aria-label="\u062A\u062B\u0628\u064A\u062A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A">
  <div class="pwa-banner__rect">
    ...
    <div class="pwa-banner__rect-actions">
...
</div>`}export async function initPage(t=""){if(ie(),h("header-slot",ee(t)),!t.includes("admin/")&&t!=="dashboard.html"){let e=document.getElementById("wide-ads-banner");if(!e&&t!=="index.html"&&t!==""){const o=document.getElementById("page-container")||document.querySelector("main");o&&(e=document.createElement("div"),e.id="wide-ads-banner",e.className="container",o.insertAdjacentElement("afterend",e))}e&&setTimeout(()=>Z(e),100)}h("footer-slot",ae()),h("nav-slot",te(t)),h("pwa-slot",ne()),oe(),se();try{O()}catch(e){console.warn("[initPage] voice FAB init failed:",e)}const a=document.getElementById("site-header"),i=document.getElementById("scroll-to-top-btn");window.addEventListener("scroll",()=>{const e=window.scrollY||window.pageYOffset||0;a?.classList.toggle("scrolled",e>8),i?.classList.toggle("visible",e>300)},{passive:!0}),i?.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});try{ve()}catch(e){console.warn("[initPage] header search init failed:",e)}const n=e=>{"requestIdleCallback"in window?requestIdleCallback(e,{timeout:2500}):setTimeout(e,0)};n(async()=>{try{(await q(2500))?.auth&&F()}catch{}try{await be()}catch{}try{R(e=>{le(e),Y(e?.uid),J(e)})}catch{}try{const o=(await V())?.contact?.whatsappLink;o&&document.querySelectorAll("[data-wa]").forEach(s=>{s.href=o})}catch{}});try{pe()}catch(e){console.warn("[initPage] PWA setup failed:",e)}"serviceWorker"in navigator&&n(()=>navigator.serviceWorker.register("./sw.js").catch(()=>{}));try{["manzala_fast_places_cache","manzala_live_news_store_v2","manzala_global_broadcast_notifs_cache"].forEach(o=>localStorage.removeItem(o))}catch{}n(()=>{try{G()}catch{}try{Q()}catch{}try{re()}catch{}try{fe()}catch{}})}function oe(){try{(window.matchMedia&&window.matchMedia("(display-mode: standalone)").matches||window.matchMedia&&window.matchMedia("(display-mode: fullscreen)").matches||window.matchMedia&&window.matchMedia("(display-mode: minimal-ui)").matches||window.navigator.standalone===!0||document.referrer&&document.referrer.includes("android-app://")||navigator.userAgent&&(navigator.userAgent.includes("wv")||navigator.userAgent.includes("Android")&&navigator.userAgent.includes("Version/"))||new URLSearchParams(window.location.search).get("source")==="apk"||new URLSearchParams(window.location.search).get("source")==="pwa")&&document.querySelectorAll("#footer-apk-container, .footer__apk-download, .apk-pro-download-btn").forEach(a=>{a.style.display="none"})}catch{}}function ie(){const t=localStorage.getItem("elmanzala-theme")||(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light");$(t)}function se(){document.querySelectorAll("#theme-toggle-btn, .theme-toggle-btn").forEach(t=>{t.addEventListener("click",()=>{const i=(document.documentElement.getAttribute("data-theme")||"light")==="dark"?"light":"dark";$(i),localStorage.setItem("elmanzala-theme",i),r.info(i==="dark"?"\u062A\u0645 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0648\u0636\u0639 \u0627\u0644\u0644\u064A\u0644\u064A \u{1F319}":"\u062A\u0645 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0648\u0636\u0639 \u0627\u0644\u0646\u0647\u0627\u0631\u064A \u2600\uFE0F")})})}function $(t){document.documentElement.setAttribute("data-theme",t),document.body&&(document.body.classList.toggle("dark-theme",t==="dark"),document.body.classList.toggle("light-theme",t==="light"));const a=document.querySelector('meta[name="theme-color"]');a&&a.setAttribute("content",t==="dark"?"#0F172A":"#1B4F72")}function re(){const t=new Set,a=e=>{if(e)try{const o=new URL(e,location.href);if(o.origin===location.origin&&!t.has(o.href)){t.add(o.href);const s=document.createElement("link");s.rel="prefetch",s.href=o.href,document.head.appendChild(s)}}catch{}};document.addEventListener("mouseover",e=>{const o=e.target.closest("a[href]");o&&a(o.href)},{passive:!0}),document.addEventListener("touchstart",e=>{const o=e.target.closest("a[href]");o&&a(o.href)},{passive:!0});const i=["index.html","places.html","categories.html","offers.html","search.html"],n=()=>{i.forEach(e=>a(e))};"requestIdleCallback"in window?window.requestIdleCallback(n,{timeout:1500}):setTimeout(n,800)}export{N as waitForAuth,g as isAdmin};function h(t,a){const i=document.getElementById(t);if(!i)return;const n=document.createElement("div");n.innerHTML=a.trim(),i.replaceWith(n.firstElementChild)}function le(t){const a=document.getElementById("header-user-section");if(a)if(t){a.innerHTML=`
        ...
        <div style="position:relative">
          <button class="header__user-btn" id="usr-btn" aria-haspopup="true" aria-expanded="false">
            <img src="${he(t.photoURL||"./icons/icon-72x72.png")}"
                 ...
                 alt="${T(t.name)}"/>
            <span class="header__user-name">${T((t.name||"").split(" ")[0])}</span>
      ...
      </div>`;const i=document.getElementById("usr-btn"),n=document.getElementById("usr-dd");i&&n&&(i.addEventListener("click",e=>{e.preventDefault(),e.stopPropagation();const o=n.classList.contains("open");n.classList.toggle("open",!o),i.setAttribute("aria-expanded",o?"false":"true")}),document.addEventListener("click",e=>{!e.target.closest("#usr-btn")&&!e.target.closest("#usr-dd")&&(n.classList.remove("open"),i.setAttribute("aria-expanded","false"))})),document.getElementById("logout-btn")?.addEventListener("click",async()=>{await U(),r.success("\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062E\u0631\u0648\u062C \u0628\u0646\u062C\u0627\u062D"),location.reload()})}else a.innerHTML='<a href="login.html" class="btn btn-primary btn-sm"><span>\u{1F511}</span> \u062F\u062E\u0648\u0644</a>'}let m=typeof window<"u"&&window.__deferredPwaPrompt?window.__deferredPwaPrompt:null;typeof window<"u"&&(window.addEventListener("beforeinstallprompt",t=>{t.preventDefault(),m=t,window.__deferredPwaPrompt=t}),window.addEventListener("appinstalled",()=>{try{localStorage.setItem("pwa-installed","true")}catch{}m=null,typeof window<"u"&&(window.__deferredPwaPrompt=null),u()}));function ce(){return typeof window>"u"?!1:!!(window.matchMedia("(display-mode: standalone)").matches||window.matchMedia("(display-mode: window-controls-overlay)").matches||window.navigator.standalone||document.referrer.includes("android-app://")||localStorage.getItem("pwa-installed")==="true")}function de(){try{const t=localStorage.getItem("pwa-dismissed");if(!t)return!1;const a=parseInt(t,10);return isNaN(a)?!0:Date.now()-a<336*60*60*1e3}catch{return!1}}function _(){if(ce()||de())return!1;try{if(sessionStorage.getItem("pwa_session_shown")==="true")return!1}catch{}return!0}function pe(){const t=!localStorage.getItem("manzala_voice_guide_seen");t&&setTimeout(()=>{w()},2e3);const a=t?12e3:5e3,i=()=>{(m||typeof window<"u"&&window.__deferredPwaPrompt)&&_()&&!document.getElementById("voice-guide-callout")&&me()};_()&&(m||typeof window<"u"&&window.__deferredPwaPrompt?setTimeout(i,a):typeof window<"u"&&window.addEventListener("beforeinstallprompt",()=>{setTimeout(i,a)},{once:!0})),document.addEventListener("click",n=>{if(n.target.closest("#pwa-banner-close")||n.target.closest("#pwa-banner-later")){n.preventDefault(),u();return}if(n.target.closest("#pwa-install-btn")){n.preventDefault(),ue();return}if(n.target.closest("#desktop-voice-fab")){n.preventDefault();try{S()}catch{}return}})}function me(){if(!_())return;const t=document.getElementById("pwa-banner");if(t){try{sessionStorage.setItem("pwa_session_shown","true")}catch{}t.hidden=!1,t.style.display="block",requestAnimationFrame(()=>{t.classList.add("visible")})}}function u(){const t=document.getElementById("pwa-banner");t&&(t.classList.remove("visible"),setTimeout(()=>{t.hidden=!0,t.style.display="none"},350));try{localStorage.setItem("pwa-dismissed",Date.now().toString()),sessionStorage.setItem("pwa_session_shown","true")}catch{}w()}async function ue(){const t=m||(typeof window<"u"?window.__deferredPwaPrompt:null);if(t)try{t.prompt();const{outcome:a}=await t.userChoice;if(a==="accepted"){try{localStorage.setItem("pwa-installed","true")}catch{}u(),r.success("\u062A\u0645 \u062A\u062B\u0628\u064A\u062A \u0627\u0644\u062A\u0637\u0628\u064A\u0642 \u0628\u0646\u062C\u0627\u062D! \u0633\u062A\u062C\u062F\u0647 \u0641\u064A \u0634\u0627\u0634\u0629 \u062A\u0637\u0628\u064A\u0642\u0627\u062A \u0647\u0627\u062A\u0641\u0643 \u{1F389}"),setTimeout(()=>w(),1200)}else u()}catch{u()}finally{m=null,typeof window<"u"&&(window.__deferredPwaPrompt=null)}else u()}function w(){if(!(typeof document>"u")){try{if(localStorage.getItem("manzala_voice_guide_seen")==="true")return;localStorage.setItem("manzala_voice_guide_seen","true")}catch{return}setTimeout(()=>{const t=window.innerWidth>=769;let a=null;if(t?a=document.getElementById("desktop-voice-fab")||document.getElementById("global-voice-assistant-fab"):a=document.getElementById("global-voice-assistant-fab")||document.querySelector(".bottom-nav__fab-btn")||document.querySelector(".bottom-nav__fab"),!a)return;document.getElementById("voice-guide-callout")?.remove();const i=document.getElementById("pwa-banner");i&&i.classList.contains("visible")&&(i.classList.remove("visible"),i.style.display="none",i.hidden=!0);const n=document.createElement("div");n.className="voice-guide-callout",n.id="voice-guide-callout",n.setAttribute("role","tooltip"),n.innerHTML=`
    ...
    `,document.body.appendChild(n),a.classList.add("voice-mic-highlighted");const e=()=>{n.classList.add("fade-out"),a?.classList.remove("voice-mic-highlighted"),setTimeout(()=>n.remove(),350)};n.querySelector("#voice-guide-callout-close")?.addEventListener("click",s=>{s.stopPropagation(),e()}),n.querySelector("#voice-guide-bubble")?.addEventListener("click",s=>{if(!s.target.closest("#voice-guide-callout-close")){e();try{S()}catch{}}}),a.addEventListener("click",e,{once:!0});const o=s=>{!n.contains(s.target)&&!a.contains(s.target)&&(e(),document.removeEventListener("click",o))};setTimeout(()=>{document.addEventListener("click",o)},400),setTimeout(()=>{document.body.contains(n)&&(e(),document.removeEventListener("click",o))},9e3)},500)}}function T(t){return t?String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):""}function he(t){return t?String(t).replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function fe(){if(typeof window>"u")return;const t=new Date().getFullYear(),a=()=>{try{console.log(`%c\xA9 \u062C\u0645\u064A\u0639 \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0627\u0644\u062D\u0642\u0648\u0642 \u0645\u062D\u0641\u0648\u0638\u0629 \u0644\u062F\u0644\u064A\u0644 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A (${t}).`,"background: linear-gradient(135deg, #0B2239, #153A5C); color: #F5A623; font-size: 16px; font-weight: 800; padding: 12px 20px; border-radius: 8px; border: 2px solid #F5A623; font-family: Cairo, Tahoma, sans-serif; text-shadow: 0 1px 2px rgba(0,0,0,0.5);"),console.log(`%c\u26A0\uFE0F \u062A\u062D\u0630\u064A\u0631 \u0642\u0627\u0646\u0648\u0646\u064A \u0631\u0633\u0645\u064A:
\u0643\u0627\u0641\u0629 \u0627\u0644\u0645\u062D\u062A\u0648\u064A\u0627\u062A \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0642\u0648\u0627\u0639\u062F \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0646\u0634\u0648\u0631\u0629 \u0645\u0633\u062C\u0644\u0629 \u0648\u0645\u062D\u0645\u064A\u0629 \u0631\u0642\u0645\u064A\u0627\u064B\u060C \u0648\u0644\u0627 \u064A\u0645\u0643\u0646 \u0646\u0642\u0644\u0647\u0627 \u0623\u0648 \u0646\u0633\u062E\u0647\u0627 \u062D\u062A\u0649 \u0644\u0627 \u064A\u062A\u0645 \u0645\u0633\u0627\u0621\u0644\u062A\u0643 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u0623\u0645\u0627\u0645 \u0627\u0644\u0645\u062D\u0627\u0643\u0645 \u0628\u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629.`,"color: #EF4444; font-size: 13px; font-weight: 700; line-height: 1.8; font-family: Cairo, Tahoma, sans-serif;"),console.log("%c\u0631\u0627\u0628\u0637 \u0627\u0644\u0628\u0648\u0627\u0628\u0629 \u0627\u0644\u0631\u0633\u0645\u064A\u0629: %chttps://dalilmanzala.com/","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #0284C7; font-size: 11px; font-weight: 700; text-decoration: underline;"),console.log("%c\u{1F4AC} \u0644\u0644\u0627\u0633\u062A\u0641\u0633\u0627\u0631\u0627\u062A \u0648\u0627\u0644\u0627\u0642\u062A\u0631\u0627\u062D\u0627\u062A: %chttps://wa.me/wasendernew","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #10B981; font-size: 11px; font-weight: 700; text-decoration: underline;")}catch{}};a();let i=window.outerWidth-window.innerWidth,n=window.outerHeight-window.innerHeight;window.addEventListener("resize",()=>{const e=window.outerWidth-window.innerWidth,o=window.outerHeight-window.innerHeight;(e!==i||o!==n)&&(i=e,n=o,a())},{passive:!0}),document.addEventListener("contextmenu",e=>{const o=e.target.tagName.toLowerCase();o==="input"||o==="textarea"||e.target.isContentEditable||(e.preventDefault(),typeof r<"u"&&r.info&&r.info("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0645\u064A\u0629 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u2014 \u063A\u064A\u0631 \u0645\u0635\u0631\u062D \u0628\u0646\u0633\u062E \u0623\u0648 \u0646\u0642\u0644 \u0645\u062D\u062A\u0648\u0649 \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("copy",e=>{const o=e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||e.target.isContentEditable||(e.preventDefault(),e.clipboardData&&e.clipboardData.setData("text/plain",`\xA9 \u062C\u0645\u064A\u0639 \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0627\u0644\u062D\u0642\u0648\u0642 \u0645\u062D\u0641\u0648\u0638\u0629 \u0644\u062F\u0644\u064A\u0644 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A (${t}). https://dalilmanzala.com/`),typeof r<"u"&&r.warning&&r.warning("\u26A0\uFE0F \u062A\u0645 \u062D\u0641\u0638 \u062D\u0642\u0648\u0642 \u0627\u0644\u0645\u0644\u0643\u064A\u0629: \u0644\u0627 \u064A\u062C\u0648\u0632 \u0646\u0633\u062E \u0623\u0648 \u0627\u0642\u062A\u0628\u0627\u0633 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("cut",e=>{const o=e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||e.target.isContentEditable||e.preventDefault()}),document.addEventListener("keydown",e=>{const o=e.target.tagName?e.target.tagName.toLowerCase():"",s=o==="input"||o==="textarea"||e.target.isContentEditable;(e.key==="F12"||e.ctrlKey&&e.shiftKey&&(e.key==="I"||e.key==="i"||e.key==="J"||e.key==="j"||e.key==="C"||e.key==="c"))&&a(),e.ctrlKey&&(e.key==="u"||e.key==="U"||e.key==="s"||e.key==="S"||e.key==="p"||e.key==="P")&&(e.preventDefault(),typeof r<"u"&&r.warning&&r.warning("\u{1F512} \u0645\u0635\u062F\u0631 \u0648\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644 \u0645\u062D\u0645\u064A\u0629 \u0628\u0645\u0648\u062C\u0628 \u0642\u0627\u0646\u0648\u0646 \u0627\u0644\u0645\u0644\u0643\u064A\u0629 \u0627\u0644\u0641\u0643\u0631\u064A\u0629.")),e.ctrlKey&&(e.key==="c"||e.key==="C")&&!s&&(window.getSelection?window.getSelection().toString():"").length>0&&(e.preventDefault(),typeof r<"u"&&r.warning&&r.warning("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0645\u062D\u0645\u064A: \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u0646\u0633\u062E \u0644\u0645\u0646\u0639 \u0627\u0644\u062A\u0639\u062F\u064A \u0627\u0644\u0642\u0627\u0646\u0648\u0646\u064A."))})}async function be(){try{const t=W();if(t&&g(t))return;if(t&&t.status==="suspended"){C("\u062A\u0645 \u0625\u064A\u0642\u0627\u0641 \u062D\u0633\u0627\u0628\u0643 \u0645\u0646 \u0642\u0628\u0644 \u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0645\u0646\u0635\u0629 \u0644\u0645\u062E\u0627\u0644\u0641\u0629 \u0627\u0644\u0634\u0631\u0648\u0637.");return}const a=await j();if(a){const i=await K(a);if(i){const n=i.reason||"\u0645\u062E\u0627\u0644\u0641\u0629 \u0645\u0639\u0627\u064A\u064A\u0631 \u0648\u0633\u064A\u0627\u0633\u0627\u062A \u0627\u0644\u0645\u0646\u0635\u0629",e=i.bannedUntil?new Date(i.bannedUntil).toLocaleDateString("ar-EG"):null,o=i.isPermanent?`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${a}) \u0646\u0647\u0627\u0626\u064A\u0627\u064B \u0645\u0646 \u062F\u062E\u0648\u0644 \u0627\u0644\u0645\u0646\u0635\u0629 \u0628\u0633\u0628\u0628: ${n}`:`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${a}) \u062D\u062A\u0649 ${e} \u0628\u0633\u0628\u0628: ${n}`;C(o)}}}catch(t){console.debug("[_enforceBanGuard] notice:",t)}}function C(t){document.body.innerHTML=`
  ...
  `}function ve(){const t=document.getElementById("header-search-container"),a=document.getElementById("header-search-pill"),i=document.getElementById("header-search-trigger"),n=document.getElementById("header-search-input"),e=document.getElementById("header-search-clear"),o=document.getElementById("header-live-dropdown"),s=document.getElementById("header-live-list"),d=document.getElementById("header-live-count"),y=document.getElementById("header-live-all-btn");if(!n)return;let k=null,x=0;const P=()=>{a?.classList.add("expanded"),n.focus(),n.value.trim().length>=1&&o?.classList.add("visible")},A=()=>{a?.classList.remove("expanded"),o?.classList.remove("visible")};i?.addEventListener("click",l=>{l.stopPropagation(),a?.classList.contains("expanded")&&n.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(n.value.trim())}`:P()}),n.addEventListener("focus",()=>{a?.classList.add("expanded"),n.value.trim().length>=1&&s?.children.length>0&&o?.classList.add("visible")}),e?.addEventListener("click",l=>{l.stopPropagation(),n.value="",e.classList.remove("visible"),o?.classList.remove("visible"),s&&(s.innerHTML=""),n.focus()}),n.addEventListener("keydown",l=>{l.key==="Enter"&&n.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(n.value.trim())}`:l.key==="Escape"&&A()}),n.addEventListener("input",()=>{const l=n.value.trim();if(e?.classList.toggle("visible",l.length>0),y&&(y.href=`search.html?q=${encodeURIComponent(l)}`),!l){o?.classList.remove("visible"),s&&(s.innerHTML="");return}clearTimeout(k),k=setTimeout(async()=>{const M=++x;try{const p=await X(l,{limit:6});if(M!==x||!o||!s)return;if(!p||p.length===0){d&&(d.textContent="0"),s.innerHTML=`
          ...
          `,o.classList.add("visible");return}d&&(d.textContent=String(p.length)),s.innerHTML=p.map(b=>{const c=b.raw||b,v=c.name||"\u0645\u0643\u0627\u0646 \u0628\u0627\u0644\u062F\u0644\u064A\u0644",L=c.categoryName||b.category||"",z=c.area||c.address||"\u0645\u062F\u064A\u0646\u0629 \u0627\u0644\u0645\u0646\u0632\u0644\u0629",D=c.slug||c.id||"",E=c.photoURL||c.logo||c.coverURL||"",H=c.isVerified||!1,B=c.isOpen!==void 0?c.isOpen:!0,I=(v.trim()[0]||"\u0645").toUpperCase();return`
            <a href="/place.html?slug=${encodeURIComponent(D)}" class="header-live-dropdown__item" role="option">
              <div class="header-live-avatar">
                ${E?`<img src="${E}" alt="${f(v)}" loading="lazy" onerror="this.onerror=null;this.parentElement.innerHTML='<div class=\\'header-live-avatar-fallback\\'>${I}</div>'"/>`:`<div class="header-live-avatar-fallback">${I}</div>`}
              </div>
              <div class="header-live-content">
                <div class="header-live-title-row">
                  <span class="header-live-name">${f(v)}</span>
                  ${H?'<span class="header-live-verified" title="\u0645\u0643\u0627\u0646 \u0645\u0648\u062B\u0642">\u2713</span>':""}
                </div>
                <div class="header-live-meta-row">
                  ${L?`<span class="header-live-cat">${f(L)}</span>`:""}
                  <span class="header-live-area">${f(z)}</span>
                  <span class="${B?"header-live-status-open":"header-live-status-closed"}">
                    ${B?"\u0645\u0641\u062A\u0648\u062D \u0627\u0644\u0622\u0646":"\u0645\u063A\u0644\u0642"}
                  </span>
                </div>
              </div>
            </a>
          `}).join(""),o.classList.add("visible")}catch(p){console.warn("[HeaderLiveSearch] search error:",p)}},120)}),document.addEventListener("click",l=>{t?.contains(l.target)||(o?.classList.remove("visible"),window.innerWidth<=767&&a?.classList.remove("expanded"))})}function f(t){return String(t||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}
