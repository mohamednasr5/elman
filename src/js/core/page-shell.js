import{initAuth as R,onAuthStateChange as W,signOut as M,waitForAuth as j,isAdmin as E,getCurrentUser as F,getClientIp as G,signInWithGoogle as K}from"./auth.js";import{toast as c}from"../ui/components/Toast.js";function V(a){return`
...
</header>`}function O(a){if(a==="admin/index.html")return`
...
<div class="pwa-banner" id="pwa-banner" hidden role="dialog" aria-label="\u062A\u062B\u0628\u064A\u062A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A">
      ...
      <div style="display:flex;align-items:center;gap:10px">
        ...
        <div style="position:relative">
          <button class="header__user-btn" id="usr-btn" aria-haspopup="true" aria-expanded="false">
            <img src="${D(a.photoURL||"./icons/icon-72x72.png")}"
                 class="header__avatar" width="32" height="32"
                 onerror="this.src='./icons/icon-72x72.png'"
                 alt="${B(a.name)}"/>
            <span class="header__user-name">${B((a.name||"").split(" ")[0])}</span>
          ...
          <div class="header__dropdown" id="usr-dd" role="menu">
            ...
            ${E(a)?'<a href="admin.html" class="header__dropdown-item" style="color:var(--secondary,#F5A623);font-weight:bold" role="menuitem">\u2699\uFE0F \u0644\u0648\u062D\u0629 \u0627\u0644\u0625\u062F\u0627\u0631\u0629</a>':""}
    ...
    <div class="more-menu-container" style="direction:rtl;text-align:right">
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;padding:12px 14px;background:var(--surface-2,#F8FAFC);border-radius:14px;margin-bottom:12px;border:1px solid var(--border,#E2E8F0)">
        <div style="display:flex;align-items:center;gap:12px">
          <img src="${D(s)}" style="width:46px;height:46px;border-radius:50%;object-fit:cover;border:2px solid var(--primary,#1B4F72)" alt="${B(e)}" onerror="this.src='./icons/icon-72x72.png'"/>
          <div>
            <div style="font-weight:800;font-size:0.98rem;color:var(--text-primary,#0F172A)">${B(e)}</div>
  ...
  `,{showModal:_}=await import("../ui/components/Modal.js"),h=_({title:i?"\u2630 \u0627\u0644\u0642\u0627\u0626\u0645\u0629 \u0648\u0644\u0648\u062D\u0629 \u0627\u0644\u062A\u062D\u0643\u0645":"\u2630 \u062F\u0644\u064A\u0644 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629",content:r,sheet:!0,closeable:!0,size:"sm"}),w=document.querySelector(".modal");return w&&(w.querySelectorAll("[data-dash-nav]").forEach(g=>{g.addEventListener("click",m=>{const d=g.getAttribute("data-dash-nav");o&&typeof window.switchDashboardSection=="function"?(m.preventDefault(),h.close(),window.switchDashboardSection(d,null,!0)):h.close()})}),document.getElementById("more-modal-logout-btn")?.addEventListener("click",async()=>{h.close(),await M(),c.success("\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062E\u0631\u0648\u062C \u0628\u0646\u062C\u0627\u062D"),window.location.reload()}),document.getElementById("more-modal-google-login-btn")?.addEventListener("click",async g=>{g.preventDefault();const m=g.currentTarget,d=m.innerHTML;try{m.disabled=!0,m.style.opacity="0.7",m.innerHTML="<span>\u062C\u0627\u0631\u064A \u0641\u062A\u062D \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062F\u062E\u0648\u0644...</span>";const u=await K();u?(h.close(),c.success(`\u0623\u0647\u0644\u0627\u064B \u0628\u0643 ${u.displayName||u.name||""} \u{1F44B}`),window.location.reload()):(m.disabled=!1,m.style.opacity="1",m.innerHTML=d)}catch(u){m.disabled=!1,m.style.opacity="1",m.innerHTML=d,console.error("[MoreModal GoogleSignIn] error:",u),u?.code!=="auth/popup-closed-by-user"&&c.error("\u062A\u0639\u0630\u0631 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062F\u062E\u0648\u0644: "+(u?.message||"\u064A\u0631\u062C\u0649 \u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649"))}})),h}typeof window<"u"&&(window.openDashboardMoreModal=openDashboardMoreModal);let v=typeof window<"u"&&window.__deferredPwaPrompt?window.__deferredPwaPrompt:null;typeof window<"u"&&(window.addEventListener("beforeinstallprompt",a=>{a.preventDefault(),v=a,window.__deferredPwaPrompt=a}),window.addEventListener("appinstalled",()=>{try{localStorage.setItem("pwa-installed","true")}catch{}v=null,typeof window<"u"&&(window.__deferredPwaPrompt=null),b()}));function ae(){return typeof window>"u"?!1:!!(window.matchMedia("(display-mode: standalone)").matches||window.matchMedia("(display-mode: window-controls-overlay)").matches||window.navigator.standalone||document.referrer.includes("android-app://")||localStorage.getItem("pwa-installed")==="true")}function ne(){try{const a=localStorage.getItem("pwa-dismissed");if(!a)return!1;const n=parseInt(a,10);return isNaN(n)?!1:Date.now()-n<7200*1e3}catch{return!1}}function $(){if(ae()||ne())return!1;try{if(sessionStorage.getItem("pwa_session_shown")==="true")return!1}catch{}return!0}function se(){const a=!localStorage.getItem("manzala_voice_guide_seen");a&&setTimeout(()=>{z()},2e3);const n=a?12e3:5e3,i=()=>{(v||typeof window<"u"&&window.__deferredPwaPrompt)&&$()&&!document.getElementById("voice-guide-callout")&&ie()};$()&&(v||typeof window<"u"&&window.__deferredPwaPrompt?setTimeout(i,n):typeof window<"u"&&window.addEventListener("beforeinstallprompt",()=>{setTimeout(i,n)},{once:!0})),document.addEventListener("click",t=>{if(t.target.closest("#pwa-banner-close")||t.target.closest("#pwa-banner-later")){t.preventDefault(),b();return}if(t.target.closest("#pwa-install-btn")){t.preventDefault(),oe();return}if(t.target.closest("#desktop-voice-fab")){t.preventDefault();try{import("../services/voice.service.js").then(({openManzalaVoiceAssistantModal:e})=>e()).catch(()=>{})}catch{}return}})}function ie(){if(!$())return;const a=document.getElementById("pwa-banner");if(a){try{sessionStorage.setItem("pwa_session_shown","true")}catch{}a.hidden=!1,a.style.display="block",requestAnimationFrame(()=>{a.classList.add("visible")})}}function b(){const a=document.getElementById("pwa-banner");a&&(a.classList.remove("visible"),setTimeout(()=>{a.hidden=!0,a.style.display="none"},350));try{localStorage.setItem("pwa-dismissed",Date.now().toString()),sessionStorage.setItem("pwa_session_shown","true")}catch{}z()}async function oe(){const a=v||(typeof window<"u"?window.__deferredPwaPrompt:null);if(a)try{a.prompt();const{outcome:n}=await a.userChoice;if(n==="accepted"){try{localStorage.setItem("pwa-installed","true")}catch{}b(),c.success("\u062A\u0645 \u062A\u062B\u0628\u064A\u062A \u0627\u0644\u062A\u0637\u0628\u064A\u0642 \u0628\u0646\u062C\u0627\u062D! \u0633\u062A\u062C\u062F\u0647 \u0641\u064A \u0634\u0627\u0634\u0629 \u062A\u0637\u0628\u064A\u0642\u0627\u062A \u0647\u0627\u062A\u0641\u0643 \u{1F389}"),setTimeout(()=>z(),1200)}else b()}catch{b()}finally{v=null,typeof window<"u"&&(window.__deferredPwaPrompt=null)}else b()}function z(){if(!(typeof document>"u")){try{if(localStorage.getItem("manzala_voice_guide_seen")==="true")return;localStorage.setItem("manzala_voice_guide_seen","true")}catch{return}setTimeout(()=>{const a=window.innerWidth>=769;let n=null;if(a?n=document.getElementById("desktop-voice-fab")||document.getElementById("global-voice-assistant-fab"):n=document.getElementById("global-voice-assistant-fab")||document.querySelector(".bottom-nav__fab-btn")||document.querySelector(".bottom-nav__fab"),!n)return;document.getElementById("voice-guide-callout")?.remove();const i=document.getElementById("pwa-banner");i&&i.classList.contains("visible")&&(i.classList.remove("visible"),i.style.display="none",i.hidden=!0);const t=document.createElement("div");t.className="voice-guide-callout",t.id="voice-guide-callout",t.setAttribute("role","tooltip"),t.innerHTML=`
    ...
    `,document.body.appendChild(t),n.classList.add("voice-mic-highlighted");const e=()=>{t.classList.add("fade-out"),n?.classList.remove("voice-mic-highlighted"),setTimeout(()=>t.remove(),350)};t.querySelector("#voice-guide-callout-close")?.addEventListener("click",o=>{o.stopPropagation(),e()}),t.querySelector("#voice-guide-bubble")?.addEventListener("click",o=>{if(!o.target.closest("#voice-guide-callout-close")){e();try{import("../services/voice.service.js").then(({openManzalaVoiceAssistantModal:r})=>r()).catch(()=>{})}catch{}}}),n.addEventListener("click",e,{once:!0});const s=o=>{!t.contains(o.target)&&!n.contains(o.target)&&(e(),document.removeEventListener("click",s))};setTimeout(()=>{document.addEventListener("click",s)},400),setTimeout(()=>{document.body.contains(t)&&(e(),document.removeEventListener("click",s))},9e3)},500)}}function B(a){return a?String(a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):""}function D(a){return a?String(a).replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function le(){if(typeof window>"u")return;const a=new Date().getFullYear(),n=()=>{try{console.log(`%c\xA9 \u062C\u0645\u064A\u0639 \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0627\u0644\u062D\u0642\u0648\u0642 \u0645\u062D\u0641\u0648\u0638\u0629 \u0644\u062F\u0644\u064A\u0644 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A (${a}).`,"background: linear-gradient(135deg, #0B2239, #153A5C); color: #F5A623; font-size: 16px; font-weight: 800; padding: 12px 20px; border-radius: 8px; border: 2px solid #F5A623; font-family: Cairo, Tahoma, sans-serif; text-shadow: 0 1px 2px rgba(0,0,0,0.5);"),console.log(`%c\u26A0\uFE0F \u062A\u062D\u0630\u064A\u0631 \u0642\u0627\u0646\u0648\u0646\u064A \u0631\u0633\u0645\u064A:
\u0643\u0627\u0641\u0629 \u0627\u0644\u0645\u062D\u062A\u0648\u064A\u0627\u062A \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0642\u0648\u0627\u0639\u062F \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0646\u0634\u0648\u0631\u0629 \u0645\u0633\u062C\u0644\u0629 \u0648\u0645\u062D\u0645\u064A\u0629 \u0631\u0642\u0645\u064A\u0627\u064B\u060C \u0648\u0644\u0627 \u064A\u0645\u0643\u0646 \u0646\u0642\u0644\u0647\u0627 \u0623\u0648 \u0646\u0633\u062E\u0647\u0627 \u062D\u062A\u0649 \u0644\u0627 \u064A\u062A\u0645 \u0645\u0633\u0627\u0621\u0644\u062A\u0643 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u0623\u0645\u0627\u0645 \u0627\u0644\u0645\u062D\u0627\u0643\u0645 \u0628\u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629.`,"color: #EF4444; font-size: 13px; font-weight: 700; line-height: 1.8; font-family: Cairo, Tahoma, sans-serif;"),console.log("%c\u0631\u0627\u0628\u0637 \u0627\u0644\u0628\u0648\u0627\u0628\u0629 \u0627\u0644\u0631\u0633\u0645\u064A\u0629: %chttps://dalilmanzala.com/","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #0284C7; font-size: 11px; font-weight: 700; text-decoration: underline;"),console.log("%c\u{1F4AC} \u0644\u0644\u0627\u0633\u062A\u0641\u0633\u0627\u0631\u0627\u062A \u0648\u0627\u0644\u0627\u0642\u062A\u0631\u0627\u062D\u0627\u062A: %chttps://wa.me/wasendernew","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #10B981; font-size: 11px; font-weight: 700; text-decoration: underline;")}catch{}};n();let i=window.outerWidth-window.innerWidth,t=window.outerHeight-window.innerHeight;window.addEventListener("resize",()=>{const e=window.outerWidth-window.innerWidth,s=window.outerHeight-window.innerHeight;(e!==i||s!==t)&&(i=e,t=s,n())},{passive:!0}),document.addEventListener("contextmenu",e=>{const s=e.target.tagName.toLowerCase();s==="input"||s==="textarea"||e.target.isContentEditable||(e.preventDefault(),typeof c<"u"&&c.info&&c.info("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0645\u064A\u0629 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u2014 \u063A\u064A\u0631 \u0645\u0635\u0631\u062D \u0628\u0646\u0633\u062E \u0623\u0648 \u0646\u0642\u0644 \u0645\u062D\u062A\u0648\u0649 \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("copy",e=>{const s=e.target.tagName?e.target.tagName.toLowerCase():"";s==="input"||s==="textarea"||e.target.isContentEditable||(e.preventDefault(),e.clipboardData&&e.clipboardData.setData("text/plain",`\xA9 \u062C\u0645\u064A\u0639 \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0627\u0644\u062D\u0642\u0648\u0642 \u0645\u062D\u0641\u0648\u0638\u0629 \u0644\u062F\u0644\u064A\u0644 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A (${a}). https://dalilmanzala.com/`),typeof c<"u"&&c.warning&&c.warning("\u26A0\uFE0F \u062A\u0645 \u062D\u0641\u0638 \u062D\u0642\u0648\u0642 \u0627\u0644\u0645\u0644\u0643\u064A\u0629: \u0644\u0627 \u064A\u062C\u0648\u0632 \u0646\u0633\u062E \u0623\u0648 \u0627\u0642\u062A\u0628\u0627\u0633 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("cut",e=>{const s=e.target.tagName?e.target.tagName.toLowerCase():"";s==="input"||s==="textarea"||e.target.isContentEditable||e.preventDefault()}),document.addEventListener("keydown",e=>{const s=e.target.tagName?e.target.tagName.toLowerCase():"",o=s==="input"||s==="textarea"||e.target.isContentEditable;(e.key==="F12"||e.ctrlKey&&e.shiftKey&&(e.key==="I"||e.key==="i"||e.key==="J"||e.key==="j"||e.key==="C"||e.key==="c"))&&n(),e.ctrlKey&&(e.key==="u"||e.key==="U"||e.key==="s"||e.key==="S"||e.key==="p"||e.key==="P")&&(e.preventDefault(),typeof c<"u"&&c.warning&&c.warning("\u{1F512} \u0645\u0635\u062F\u0631 \u0648\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644 \u0645\u062D\u0645\u064A\u0629 \u0628\u0645\u0648\u062C\u0628 \u0642\u0627\u0646\u0648\u0646 \u0627\u0644\u0645\u0644\u0643\u064A\u0629 \u0627\u0644\u0641\u0643\u0631\u064A\u0629.")),e.ctrlKey&&(e.key==="c"||e.key==="C")&&!o&&(window.getSelection?window.getSelection().toString():"").length>0&&(e.preventDefault(),typeof c<"u"&&c.warning&&c.warning("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0645\u062D\u0645\u064A: \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u0646\u0633\u062E \u0644\u0645\u0646\u0639 \u0627\u0644\u062A\u0639\u062F\u064A \u0627\u0644\u0642\u0627\u0646\u0648\u0646\u064A."))})}async function re(){try{const a=F();if(a&&E(a))return;if(a&&a.status==="suspended"){H("\u062A\u0645 \u0625\u064A\u0642\u0627\u0641 \u062D\u0633\u0627\u0628\u0643 \u0645\u0646 \u0642\u0628\u0644 \u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0645\u0646\u0635\u0629 \u0644\u0645\u062E\u0627\u0644\u0641\u0629 \u0627\u0644\u0634\u0631\u0648\u0637.");return}const n=await G();if(n){const{isIpBanned:i}=await import("./db.js"),t=await i(n);if(t){const e=t.reason||"\u0645\u062E\u0627\u0644\u0641\u0629 \u0645\u0639\u0627\u064A\u064A\u0631 \u0648\u0633\u064A\u0627\u0633\u0627\u062A \u0627\u0644\u0645\u0646\u0635\u0629",s=t.bannedUntil?new Date(t.bannedUntil).toLocaleDateString("ar-EG"):null,o=t.isPermanent?`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${n}) \u0646\u0647\u0627\u0626\u064A\u0627\u064B \u0645\u0646 \u062F\u062E\u0648\u0644 \u0627\u0644\u0645\u0646\u0635\u0629 \u0628\u0633\u0628\u0628: ${e}`:`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${n}) \u062D\u062A\u0649 ${s} \u0628\u0633\u0628\u0628: ${e}`;H(o)}}}catch(a){console.debug("[_enforceBanGuard] notice:",a)}}function H(a){document.body.innerHTML=`
  ...
  `}function de(){const a=document.getElementById("header-search-container"),n=document.getElementById("header-search-pill"),i=document.getElementById("header-search-trigger"),t=document.getElementById("header-search-input"),e=document.getElementById("header-search-clear"),s=document.getElementById("header-live-dropdown"),o=document.getElementById("header-live-list"),r=document.getElementById("header-live-count"),_=document.getElementById("header-live-all-btn");if(!t)return;let h=null,w=0;const g=()=>{n?.classList.add("expanded"),t.focus(),t.value.trim().length>=1&&s?.classList.add("visible")},m=()=>{n?.classList.remove("expanded"),s?.classList.remove("visible")};i?.addEventListener("click",d=>{d.stopPropagation(),n?.classList.contains("expanded")&&t.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(t.value.trim())}`:g()}),t.addEventListener("focus",()=>{n?.classList.add("expanded"),t.value.trim().length>=1&&o?.children.length>0&&s?.classList.add("visible")}),e?.addEventListener("click",d=>{d.stopPropagation(),t.value="",e.classList.remove("visible"),s?.classList.remove("visible"),o&&(o.innerHTML=""),t.focus()}),t.addEventListener("keydown",d=>{d.key==="Enter"&&t.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(t.value.trim())}`:d.key==="Escape"&&m()}),t.addEventListener("input",()=>{const d=t.value.trim();if(e?.classList.toggle("visible",d.length>0),_&&(_.href=`search.html?q=${encodeURIComponent(d)}`),!d){s?.classList.remove("visible"),o&&(o.innerHTML="");return}clearTimeout(h),h=setTimeout(async()=>{const u=++w;try{const{executeFastSearch:S}=await import("../services/search-engine.service.js"),y=await S(d,{limit:6});if(u!==w||!s||!o)return;if(!y||y.length===0){r&&(r.textContent="0"),o.innerHTML=`
          ...
          `,s.classList.add("visible");return}r&&(r.textContent=String(y.length)),o.innerHTML=y.map(I=>{const l=I.raw||I,x=l.name||"\u0645\u0643\u0627\u0646 \u0628\u0627\u0644\u062F\u0644\u064A\u0644",C=l.categoryName||I.category||"",P=l.area||l.address||"\u0645\u062F\u064A\u0646\u0629 \u0627\u0644\u0645\u0646\u0632\u0644\u0629",f=l.slug||l.id||"",k=l.photoURL||l.logo||l.coverURL||l.coverImageUrl||l.logoUrl||"",q=l.isVerified||!1,A=l.isOpen!==void 0?l.isOpen:!0;if(typeof window<"u"&&window._placesRegistry&&f){const U=String(f).toLowerCase().trim();window._placesRegistry.set(U,l),l.slug&&window._placesRegistry.set(String(l.slug).toLowerCase().trim(),l),l.id&&window._placesRegistry.set(String(l.id).toLowerCase().trim(),l)}const T=(x.trim()[0]||"\u0645").toUpperCase();return`
            <a href="/place.html?slug=${encodeURIComponent(f)}" class="header-live-dropdown__item" role="option"
               data-place-id="${p(l.id||f)}"
               data-place-slug="${p(f)}"
               data-name="${p(x)}"
               data-phone="${p(l.phone||"")}"
               data-whatsapp="${p(l.whatsapp||"")}"
               data-area="${p(P)}"
               data-address="${p(l.address||"")}"
               data-cover="${p(l.coverImageUrl||k)}"
               data-logo="${p(l.logoUrl||k)}"
               data-category="${p(C)}"
               onclick="window.__openPlaceCard ? window.__openPlaceCard(this, '${p(f)}', event) : null"
               ontouchstart="window.__prefetchPlaceCard && window.__prefetchPlaceCard('${p(f)}', this)"
               onpointerdown="window.__prefetchPlaceCard && window.__prefetchPlaceCard('${p(f)}', this)">
              <div class="header-live-avatar">
                ${k?`<img src="${k}" alt="${p(x)}" loading="lazy" onerror="this.onerror=null;this.parentElement.innerHTML='<div class=\\'header-live-avatar-fallback\\'>${T}</div>'"/>`:`<div class="header-live-avatar-fallback">${T}</div>`}
              </div>
              <div class="header-live-content">
                <div class="header-live-title-row">
                  <span class="header-live-name">${p(x)}</span>
                  ${q?'<span class="header-live-verified" title="\u0645\u0643\u0627\u0646 \u0645\u0648\u062B\u0642">\u2713</span>':""}
                </div>
                <div class="header-live-meta-row">
                  ${C?`<span class="header-live-cat">${p(C)}</span>`:""}
                  <span class="header-live-area">${p(P)}</span>
          ...
          `}).join(""),s.classList.add("visible")}catch(S){console.warn("[HeaderLiveSearch] search error:",S)}},120)}),document.addEventListener("click",d=>{a?.contains(d.target)||(s?.classList.remove("visible"),window.innerWidth<=767&&n?.classList.remove("expanded"))})}function p(a){return String(a||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}
