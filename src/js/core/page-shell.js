import{initAuth as U,onAuthStateChange as W,signOut as T,waitForAuth as R,isAdmin as y,getCurrentUser as $,getClientIp as j,signInWithGoogle as G}from"./auth.js";import{toast as d}from"../ui/components/Toast.js";function K(a){return`
...
</header>`}function V(a){if(a==="admin/index.html")return`
...
<div class="pwa-banner" id="pwa-banner" hidden role="dialog" aria-label="\u062A\u062B\u0628\u064A\u062A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A">
      ...
      <div style="display:flex;align-items:center;gap:10px">
        ...
        <div style="position:relative">
          <button class="header__user-btn" id="usr-btn" aria-haspopup="true" aria-expanded="false">
            <img src="${F(a.photoURL||"./icons/icon-72x72.png")}"
                 class="header__avatar" width="32" height="32"
                 onerror="this.src='./icons/icon-72x72.png'"
                 alt="${x(a.name)}"/>
            <span class="header__user-name">${x((a.name||"").split(" ")[0])}</span>
          ...
          <div class="header__dropdown" id="usr-dd" role="menu">
            ...
            ${y(a)?'<a href="admin.html" class="header__dropdown-item" style="color:var(--secondary,#F5A623);font-weight:bold" role="menuitem">\u2699\uFE0F \u0644\u0648\u062D\u0629 \u0627\u0644\u0625\u062F\u0627\u0631\u0629</a>':""}
    ...
    <div class="more-menu-container" style="direction:rtl;text-align:right">
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;padding:12px 14px;background:var(--surface-2,#F8FAFC);border-radius:14px;margin-bottom:12px;border:1px solid var(--border,#E2E8F0)">
        <div style="display:flex;align-items:center;gap:12px">
          <img src="${F(s)}" style="width:46px;height:46px;border-radius:50%;object-fit:cover;border:2px solid var(--primary,#1B4F72)" alt="${x(e)}" onerror="this.src='./icons/icon-72x72.png'"/>
          <div>
  ...
  `,{showModal:b}=await import("../ui/components/Modal.js"),u=b({title:i?"\u2630 \u0627\u0644\u0642\u0627\u0626\u0645\u0629 \u0648\u0644\u0648\u062D\u0629 \u0627\u0644\u062A\u062D\u0643\u0645":"\u2630 \u062F\u0644\u064A\u0644 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629",content:l,sheet:!0,closeable:!0,size:"sm"}),v=document.querySelector(".modal");return v&&(v.querySelectorAll("[data-dash-nav]").forEach(h=>{h.addEventListener("click",c=>{const r=h.getAttribute("data-dash-nav");o&&typeof window.switchDashboardSection=="function"?(c.preventDefault(),u.close(),window.switchDashboardSection(r,null,!0)):u.close()})}),document.getElementById("more-modal-logout-btn")?.addEventListener("click",async()=>{u.close(),await T(),d.success("\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062E\u0631\u0648\u062C \u0628\u0646\u062C\u0627\u062D"),window.location.reload()}),document.getElementById("more-modal-google-login-btn")?.addEventListener("click",async h=>{h.preventDefault();const c=h.currentTarget,r=c.innerHTML;try{c.disabled=!0,c.style.opacity="0.7",c.innerHTML="<span>\u062C\u0627\u0631\u064A \u0641\u062A\u062D \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062F\u062E\u0648\u0644...</span>";const m=await G();m?(u.close(),d.success(`\u0623\u0647\u0644\u0627\u064B \u0628\u0643 ${m.displayName||m.name||""} \u{1F44B}`),window.location.reload()):(c.disabled=!1,c.style.opacity="1",c.innerHTML=r)}catch(m){c.disabled=!1,c.style.opacity="1",c.innerHTML=r,console.error("[MoreModal GoogleSignIn] error:",m),m?.code!=="auth/popup-closed-by-user"&&d.error("\u062A\u0639\u0630\u0631 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062F\u062E\u0648\u0644: "+(m?.message||"\u064A\u0631\u062C\u0649 \u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649"))}})),u}typeof window<"u"&&(window.openDashboardMoreModal=openDashboardMoreModal);let f=typeof window<"u"&&window.__deferredPwaPrompt?window.__deferredPwaPrompt:null;typeof window<"u"&&(window.addEventListener("beforeinstallprompt",a=>{a.preventDefault(),f=a,window.__deferredPwaPrompt=a}),window.addEventListener("appinstalled",()=>{try{localStorage.setItem("pwa-installed","true")}catch{}f=null,typeof window<"u"&&(window.__deferredPwaPrompt=null),g()}));function te(){return typeof window>"u"?!1:!!(window.matchMedia("(display-mode: standalone)").matches||window.matchMedia("(display-mode: window-controls-overlay)").matches||window.navigator.standalone||document.referrer.includes("android-app://")||localStorage.getItem("pwa-installed")==="true")}function ae(){try{const a=localStorage.getItem("pwa-dismissed");if(!a)return!1;const n=parseInt(a,10);return isNaN(n)?!1:Date.now()-n<7200*1e3}catch{return!1}}function S(){if(te()||ae())return!1;try{if(sessionStorage.getItem("pwa_session_shown")==="true")return!1}catch{}return!0}function ne(){const a=!localStorage.getItem("manzala_voice_guide_seen");a&&setTimeout(()=>{I()},2e3);const n=a?12e3:5e3,i=()=>{(f||typeof window<"u"&&window.__deferredPwaPrompt)&&S()&&!document.getElementById("voice-guide-callout")&&se()};S()&&(f||typeof window<"u"&&window.__deferredPwaPrompt?setTimeout(i,n):typeof window<"u"&&window.addEventListener("beforeinstallprompt",()=>{setTimeout(i,n)},{once:!0})),document.addEventListener("click",t=>{if(t.target.closest("#pwa-banner-close")||t.target.closest("#pwa-banner-later")){t.preventDefault(),g();return}if(t.target.closest("#pwa-install-btn")){t.preventDefault(),ie();return}if(t.target.closest("#desktop-voice-fab")){t.preventDefault();try{import("../services/voice.service.js").then(({openManzalaVoiceAssistantModal:e})=>e()).catch(()=>{})}catch{}return}})}function se(){if(!S())return;const a=document.getElementById("pwa-banner");if(a){try{sessionStorage.setItem("pwa_session_shown","true")}catch{}a.hidden=!1,a.style.display="block",requestAnimationFrame(()=>{a.classList.add("visible")})}}function g(){const a=document.getElementById("pwa-banner");a&&(a.classList.remove("visible"),setTimeout(()=>{a.hidden=!0,a.style.display="none"},350));try{localStorage.setItem("pwa-dismissed",Date.now().toString()),sessionStorage.setItem("pwa_session_shown","true")}catch{}I()}async function ie(){const a=f||(typeof window<"u"?window.__deferredPwaPrompt:null);if(a)try{a.prompt();const{outcome:n}=await a.userChoice;if(n==="accepted"){try{localStorage.setItem("pwa-installed","true")}catch{}g(),d.success("\u062A\u0645 \u062A\u062B\u0628\u064A\u062A \u0627\u0644\u062A\u0637\u0628\u064A\u0642 \u0628\u0646\u062C\u0627\u062D! \u0633\u062A\u062C\u062F\u0647 \u0641\u064A \u0634\u0627\u0634\u0629 \u062A\u0637\u0628\u064A\u0642\u0627\u062A \u0647\u0627\u062A\u0641\u0643 \u{1F389}"),setTimeout(()=>I(),1200)}else g()}catch{g()}finally{f=null,typeof window<"u"&&(window.__deferredPwaPrompt=null)}else g()}function I(){if(!(typeof document>"u")){try{if(localStorage.getItem("manzala_voice_guide_seen")==="true")return;localStorage.setItem("manzala_voice_guide_seen","true")}catch{return}setTimeout(()=>{const a=window.innerWidth>=769;let n=null;if(a?n=document.getElementById("desktop-voice-fab")||document.getElementById("global-voice-assistant-fab"):n=document.getElementById("global-voice-assistant-fab")||document.querySelector(".bottom-nav__fab-btn")||document.querySelector(".bottom-nav__fab"),!n)return;document.getElementById("voice-guide-callout")?.remove();const i=document.getElementById("pwa-banner");i&&i.classList.contains("visible")&&(i.classList.remove("visible"),i.style.display="none",i.hidden=!0);const t=document.createElement("div");t.className="voice-guide-callout",t.id="voice-guide-callout",t.setAttribute("role","tooltip"),t.innerHTML=`
    ...
    `,document.body.appendChild(t),n.classList.add("voice-mic-highlighted");const e=()=>{t.classList.add("fade-out"),n?.classList.remove("voice-mic-highlighted"),setTimeout(()=>t.remove(),350)};t.querySelector("#voice-guide-callout-close")?.addEventListener("click",o=>{o.stopPropagation(),e()}),t.querySelector("#voice-guide-bubble")?.addEventListener("click",o=>{if(!o.target.closest("#voice-guide-callout-close")){e();try{import("../services/voice.service.js").then(({openManzalaVoiceAssistantModal:l})=>l()).catch(()=>{})}catch{}}}),n.addEventListener("click",e,{once:!0});const s=o=>{!t.contains(o.target)&&!n.contains(o.target)&&(e(),document.removeEventListener("click",s))};setTimeout(()=>{document.addEventListener("click",s)},400),setTimeout(()=>{document.body.contains(t)&&(e(),document.removeEventListener("click",s))},9e3)},500)}}function x(a){return a?String(a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):""}function F(a){return a?String(a).replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function oe(){if(typeof window>"u")return;const a=new Date().getFullYear(),n=()=>{try{console.log(`%c\xA9 \u062C\u0645\u064A\u0639 \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0627\u0644\u062D\u0642\u0648\u0642 \u0645\u062D\u0641\u0648\u0638\u0629 \u0644\u062F\u0644\u064A\u0644 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A (${a}).`,"background: linear-gradient(135deg, #0B2239, #153A5C); color: #F5A623; font-size: 16px; font-weight: 800; padding: 12px 20px; border-radius: 8px; border: 2px solid #F5A623; font-family: Cairo, Tahoma, sans-serif; text-shadow: 0 1px 2px rgba(0,0,0,0.5);"),console.log(`%c\u26A0\uFE0F \u062A\u062D\u0630\u064A\u0631 \u0642\u0627\u0646\u0648\u0646\u064A \u0631\u0633\u0645\u064A:
\u0643\u0627\u0641\u0629 \u0627\u0644\u0645\u062D\u062A\u0648\u064A\u0627\u062A \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0642\u0648\u0627\u0639\u062F \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0646\u0634\u0648\u0631\u0629 \u0645\u0633\u062C\u0644\u0629 \u0648\u0645\u062D\u0645\u064A\u0629 \u0631\u0642\u0645\u064A\u0627\u064B\u060C \u0648\u0644\u0627 \u064A\u0645\u0643\u0646 \u0646\u0642\u0644\u0647\u0627 \u0623\u0648 \u0646\u0633\u062E\u0647\u0627 \u062D\u062A\u0649 \u0644\u0627 \u064A\u062A\u0645 \u0645\u0633\u0627\u0621\u0644\u062A\u0643 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u0623\u0645\u0627\u0645 \u0627\u0644\u0645\u062D\u0627\u0643\u0645 \u0628\u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629.`,"color: #EF4444; font-size: 13px; font-weight: 700; line-height: 1.8; font-family: Cairo, Tahoma, sans-serif;"),console.log("%c\u0631\u0627\u0628\u0637 \u0627\u0644\u0628\u0648\u0627\u0628\u0629 \u0627\u0644\u0631\u0633\u0645\u064A\u0629: %chttps://dalilmanzala.com/","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #0284C7; font-size: 11px; font-weight: 700; text-decoration: underline;"),console.log("%c\u{1F4AC} \u0644\u0644\u0627\u0633\u062A\u0641\u0633\u0627\u0631\u0627\u062A \u0648\u0627\u0644\u0627\u0642\u062A\u0631\u0627\u062D\u0627\u062A: %chttps://wa.me/wasendernew","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #10B981; font-size: 11px; font-weight: 700; text-decoration: underline;")}catch{}};n();let i=window.outerWidth-window.innerWidth,t=window.outerHeight-window.innerHeight;window.addEventListener("resize",()=>{const e=window.outerWidth-window.innerWidth,s=window.outerHeight-window.innerHeight;(e!==i||s!==t)&&(i=e,t=s,n())},{passive:!0}),document.addEventListener("contextmenu",e=>{const s=e.target.tagName.toLowerCase();s==="input"||s==="textarea"||e.target.isContentEditable||(e.preventDefault(),typeof d<"u"&&d.info&&d.info("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0645\u064A\u0629 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u2014 \u063A\u064A\u0631 \u0645\u0635\u0631\u062D \u0628\u0646\u0633\u062E \u0623\u0648 \u0646\u0642\u0644 \u0645\u062D\u062A\u0648\u0649 \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("copy",e=>{const s=e.target.tagName?e.target.tagName.toLowerCase():"";s==="input"||s==="textarea"||e.target.isContentEditable||(e.preventDefault(),e.clipboardData&&e.clipboardData.setData("text/plain",`\xA9 \u062C\u0645\u064A\u0639 \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0627\u0644\u062D\u0642\u0648\u0642 \u0645\u062D\u0641\u0648\u0638\u0629 \u0644\u062F\u0644\u064A\u0644 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A (${a}). https://dalilmanzala.com/`),typeof d<"u"&&d.warning&&d.warning("\u26A0\uFE0F \u062A\u0645 \u062D\u0641\u0638 \u062D\u0642\u0648\u0642 \u0627\u0644\u0645\u0644\u0643\u064A\u0629: \u0644\u0627 \u064A\u062C\u0648\u0632 \u0646\u0633\u062E \u0623\u0648 \u0627\u0642\u062A\u0628\u0627\u0633 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("cut",e=>{const s=e.target.tagName?e.target.tagName.toLowerCase():"";s==="input"||s==="textarea"||e.target.isContentEditable||e.preventDefault()}),document.addEventListener("keydown",e=>{const s=e.target.tagName?e.target.tagName.toLowerCase():"",o=s==="input"||s==="textarea"||e.target.isContentEditable;(e.key==="F12"||e.ctrlKey&&e.shiftKey&&(e.key==="I"||e.key==="i"||e.key==="J"||e.key==="j"||e.key==="C"||e.key==="c"))&&n(),e.ctrlKey&&(e.key==="u"||e.key==="U"||e.key==="s"||e.key==="S"||e.key==="p"||e.key==="P")&&(e.preventDefault(),typeof d<"u"&&d.warning&&d.warning("\u{1F512} \u0645\u0635\u062F\u0631 \u0648\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644 \u0645\u062D\u0645\u064A\u0629 \u0628\u0645\u0648\u062C\u0628 \u0642\u0627\u0646\u0648\u0646 \u0627\u0644\u0645\u0644\u0643\u064A\u0629 \u0627\u0644\u0641\u0643\u0631\u064A\u0629.")),e.ctrlKey&&(e.key==="c"||e.key==="C")&&!o&&(window.getSelection?window.getSelection().toString():"").length>0&&(e.preventDefault(),typeof d<"u"&&d.warning&&d.warning("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0645\u062D\u0645\u064A: \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u0646\u0633\u062E \u0644\u0645\u0646\u0639 \u0627\u0644\u062A\u0639\u062F\u064A \u0627\u0644\u0642\u0627\u0646\u0648\u0646\u064A."))})}async function le(){try{const a=$();if(a&&y(a))return;if(a&&a.status==="suspended"){N("\u062A\u0645 \u0625\u064A\u0642\u0627\u0641 \u062D\u0633\u0627\u0628\u0643 \u0645\u0646 \u0642\u0628\u0644 \u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0645\u0646\u0635\u0629 \u0644\u0645\u062E\u0627\u0644\u0641\u0629 \u0627\u0644\u0634\u0631\u0648\u0637.");return}const n=await j();if(n){const{isIpBanned:i}=await import("./db.js"),t=await i(n);if(t){const e=t.reason||"\u0645\u062E\u0627\u0644\u0641\u0629 \u0645\u0639\u0627\u064A\u064A\u0631 \u0648\u0633\u064A\u0627\u0633\u0627\u062A \u0627\u0644\u0645\u0646\u0635\u0629",s=t.bannedUntil?new Date(t.bannedUntil).toLocaleDateString("ar-EG"):null,o=t.isPermanent?`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${n}) \u0646\u0647\u0627\u0626\u064A\u0627\u064B \u0645\u0646 \u062F\u062E\u0648\u0644 \u0627\u0644\u0645\u0646\u0635\u0629 \u0628\u0633\u0628\u0628: ${e}`:`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${n}) \u062D\u062A\u0649 ${s} \u0628\u0633\u0628\u0628: ${e}`;N(o)}}}catch(a){console.debug("[_enforceBanGuard] notice:",a)}}function N(a){document.body.innerHTML=`
  ...
  `}function re(){const a=document.getElementById("header-search-container"),n=document.getElementById("header-search-pill"),i=document.getElementById("header-search-trigger"),t=document.getElementById("header-search-input"),e=document.getElementById("header-search-clear"),s=document.getElementById("header-live-dropdown"),o=document.getElementById("header-live-list"),l=document.getElementById("header-live-count"),b=document.getElementById("header-live-all-btn");if(!t)return;let u=null,v=0;const h=()=>{n?.classList.add("expanded"),t.focus(),t.value.trim().length>=1&&s?.classList.add("visible")},c=()=>{n?.classList.remove("expanded"),s?.classList.remove("visible")};i?.addEventListener("click",r=>{r.stopPropagation(),n?.classList.contains("expanded")&&t.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(t.value.trim())}`:h()}),t.addEventListener("focus",()=>{n?.classList.add("expanded"),t.value.trim().length>=1&&o?.children.length>0&&s?.classList.add("visible")}),e?.addEventListener("click",r=>{r.stopPropagation(),t.value="",e.classList.remove("visible"),s?.classList.remove("visible"),o&&(o.innerHTML=""),t.focus()}),t.addEventListener("keydown",r=>{r.key==="Enter"&&t.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(t.value.trim())}`:r.key==="Escape"&&c()}),t.addEventListener("input",()=>{const r=t.value.trim();if(e?.classList.toggle("visible",r.length>0),b&&(b.href=`search.html?q=${encodeURIComponent(r)}`),!r){s?.classList.remove("visible"),o&&(o.innerHTML="");return}clearTimeout(u),u=setTimeout(async()=>{const m=++v;try{const{executeFastSearch:E}=await import("../services/search-engine.service.js"),w=await E(r,{limit:6});if(m!==v||!s||!o)return;if(!w||w.length===0){l&&(l.textContent="0"),o.innerHTML=`
          ...
          `,s.classList.add("visible");return}l&&(l.textContent=String(w.length)),o.innerHTML=w.map(L=>{const p=L.raw||L,B=p.name||"\u0645\u0643\u0627\u0646 \u0628\u0627\u0644\u062F\u0644\u064A\u0644",C=p.categoryName||L.category||"",D=p.area||p.address||"\u0645\u062F\u064A\u0646\u0629 \u0627\u0644\u0645\u0646\u0632\u0644\u0629",H=p.slug||p.id||"",z=p.photoURL||p.logo||p.coverURL||"",q=p.isVerified||!1,A=p.isOpen!==void 0?p.isOpen:!0,P=(B.trim()[0]||"\u0645").toUpperCase();return`
            <a href="/place.html?slug=${encodeURIComponent(H)}" class="header-live-dropdown__item" role="option">
              <div class="header-live-avatar">
                ${z?`<img src="${z}" alt="${k(B)}" loading="lazy" onerror="this.onerror=null;this.parentElement.innerHTML='<div class=\\'header-live-avatar-fallback\\'>${P}</div>'"/>`:`<div class="header-live-avatar-fallback">${P}</div>`}
              </div>
              <div class="header-live-content">
                ...
                <div class="header-live-meta-row">
                  ...
                  <span class="header-live-area">${k(D)}</span>
                  <span class="${A?"header-live-status-open":"header-live-status-closed"}">
                    ${A?"\u0645\u0641\u062A\u0648\u062D \u0627\u0644\u0622\u0646":"\u0645\u063A\u0644\u0642"}
                  </span>
                </div>
              </div>
            </a>
          `}).join(""),s.classList.add("visible")}catch(E){console.warn("[HeaderLiveSearch] search error:",E)}},120)}),document.addEventListener("click",r=>{a?.contains(r.target)||(s?.classList.remove("visible"),window.innerWidth<=767&&n?.classList.remove("expanded"))})}function k(a){return String(a||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}
