...
function _footerHTML() {
  ...
  const groups = isEn ? [
    {title:'Quick Links',links:[['/en/','Home'],['/en/places/','Places Directory'],['/en/categories/','Categories'],['/en/offers/','Offers'],['/en/favorites/','Favorites'],['/en/about.html','About Us']]},
    ...
    {title:'روابط سريعة',links:[['/index.html','الصفحة الرئيسية'],['/places.html','دليل الأماكن'],['/categories.html','التصنيفات'],['/offers.html','العروض'],['/favorites.html','المفضلة'],['/about.html','عن الدليل']]},
