import{ensureFirebaseReady as R}from"./firebase.js";import{initAuth as N,onAuthStateChange as W,signOut as T,waitForAuth as j,isAdmin as v,getCurrentUser as P,getClientIp as V}from"./auth.js";import{getSettings as K,isIpBanned as G}from"./db.js";import{toast as r}from"../ui/components/Toast.js";import{bindGlobalVoiceAssistantFab as O,openManzalaVoiceAssistantModal as z}from"../services/voice.service.js";import{initRealtimePwaSyncBus as Y}from"../services/realtime-sync.service.js";import{initLiveNotificationSubscriber as J}from"../services/notification.service.js";import{initFcmMessaging as Q}from"../services/fcm.service.js";import{initUniversalMobileTouchTooltips as X}from"../utils/mobile-tooltip.js";import{executeFastSearch as Z}from"../services/search-engine.service.js";import{mountWideAdsBanner as ee}from"../ui/components/WideAdsBanner.js";import{showModal as te}from"../ui/components/Modal.js";function ae(t){return`
...
\u0643\u0627\u0641\u0629 \u0627\u0644\u0645\u062D\u062A\u0648\u064A\u0627\u062A \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0642\u0648\u0627\u0639\u062F \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0646\u0634\u0648\u0631\u0629 \u0645\u0633\u062C\u0644\u0629 \u0648\u0645\u062D\u0645\u064A\u0629 \u0631\u0642\u0645\u064A\u0627\u064B\u060C \u0648\u0644\u0627 \u064A\u0645\u0643\u0646 \u0646\u0642\u0644\u0647\u0627 \u0623\u0648 \u0646\u0633\u062E\u0647\u0627 \u062D\u062A\u0649 \u0644\u0627 \u064A\u062A\u0645 \u0645\u0633\u0627\u0621\u0644\u062A\u0643 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u0623\u0645\u0627\u0645 \u0627\u0644\u0645\u062D\u0627\u0643\u0645 \u0628\u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629.`,"color: #EF4444; font-size: 13px; font-weight: 700; line-height: 1.8; font-family: Cairo, Tahoma, sans-serif;"),console.log("%c\u0631\u0627\u0628\u0637 \u0627\u0644\u0628\u0648\u0627\u0628\u0629 \u0627\u0644\u0631\u0633\u0645\u064A\u0629: %chttps://dalilmanzala.com/","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #0284C7; font-size: 11px; font-weight: 700; text-decoration: underline;"),console.log("%c\u{1F4AC} \u0644\u0644\u0627\u0633\u062A\u0641\u0633\u0627\u0631\u0627\u062A \u0648\u0627\u0644\u0627\u0642\u062A\u0631\u0627\u062D\u0627\u062A: %chttps://wa.me/wasendernew","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #10B981; font-size: 11px; font-weight: 700; text-decoration: underline;")}catch{}};a();let s=window.outerWidth-window.innerWidth,n=window.outerHeight-window.innerHeight;window.addEventListener("resize",()=>{const e=window.outerWidth-window.innerWidth,o=window.outerHeight-window.innerHeight;(e!==s||o!==n)&&(s=e,n=o,a())},{passive:!0}),document.addEventListener("contextmenu",e=>{const o=e.target.tagName.toLowerCase();o==="input"||o==="textarea"||e.target.isContentEditable||(e.preventDefault(),typeof r<"u"&&r.info&&r.info("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0645\u064A\u0629 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u2014 \u063A\u064A\u0631 \u0645\u0635\u0631\u062D \u0628\u0646\u0633\u062E \u0623\u0648 \u0646\u0642\u0644 \u0645\u062D\u062A\u0648\u0649 \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("copy",e=>{const o=e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||e.target.isContentEditable||(e.preventDefault(),e.clipboardData&&e.clipboardData.setData("text/plain",`\xA9 \u062C\u0645\u064A\u0639 \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0627\u0644\u062D\u0642\u0648\u0642 \u0645\u062D\u0641\u0648\u0638\u0629 \u0644\u062F\u0644\u064A\u0644 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A (${t}). https://dalilmanzala.com/`),typeof r<"u"&&r.warning&&r.warning("\u26A0\uFE0F \u062A\u0645 \u062D\u0641\u0638 \u062D\u0642\u0648\u0642 \u0627\u0644\u0645\u0644\u0643\u064A\u0629: \u0644\u0627 \u064A\u062C\u0648\u0632 \u0646\u0633\u062E \u0623\u0648 \u0627\u0642\u062A\u0628\u0627\u0633 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("cut",e=>{const o=e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||e.target.isContentEditable||e.preventDefault()}),document.addEventListener("keydown",e=>{const o=e.target.tagName?e.target.tagName.toLowerCase():"",i=o==="input"||o==="textarea"||e.target.isContentEditable;(e.key==="F12"||e.ctrlKey&&e.shiftKey&&(e.key==="I"||e.key==="i"||e.key==="J"||e.key==="j"||e.key==="C"||e.key==="c"))&&a(),e.ctrlKey&&(e.key==="u"||e.key==="U"||e.key==="s"||e.key==="S"||e.key==="p"||e.key==="P")&&(e.preventDefault(),typeof r<"u"&&r.warning&&r.warning("\u{1F512} \u0645\u0635\u062F\u0631 \u0648\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644 \u0645\u062D\u0645\u064A\u0629 \u0628\u0645\u0648\u062C\u0628 \u0642\u0627\u0646\u0648\u0646 \u0627\u0644\u0645\u0644\u0643\u064A\u0629 \u0627\u0644\u0641\u0643\u0631\u064A\u0629.")),e.ctrlKey&&(e.key==="c"||e.key==="C")&&!i&&(window.getSelection?window.getSelection().toString():"").length>0&&(e.preventDefault(),typeof r<"u"&&r.warning&&r.warning("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0645\u062D\u0645\u064A: \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u0646\u0633\u062E \u0644\u0645\u0646\u0639 \u0627\u0644\u062A\u0639\u062F\u064A \u0627\u0644\u0642\u0627\u0646\u0648\u0646\u064A."))})}async function ve(){try{const t=P();if(t&&v(t))return;if(t&&t.status==="suspended"){D("\u062A\u0645 \u0625\u064A\u0642\u0627\u0641 \u062D\u0633\u0627\u0628\u0643 \u0645\u0646 \u0642\u0628\u0644 \u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0645\u0646\u0635\u0629 \u0644\u0645\u062E\u0627\u0644\u0641\u0629 \u0627\u0644\u0634\u0631\u0648\u0637.");return}const a=await V();if(a){const s=await G(a);if(s){const n=s.reason||"\u0645\u062E\u0627\u0644\u0641\u0629 \u0645\u0639\u0627\u064A\u064A\u0631 \u0648\u0633\u064A\u0627\u0633\u0627\u062A \u0627\u0644\u0645\u0646\u0635\u0629",e=s.bannedUntil?new Date(s.bannedUntil).toLocaleDateString("ar-EG"):null,o=s.isPermanent?`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${a}) \u0646\u0647\u0627\u0626\u064A\u0627\u064B \u0645\u0646 \u062F\u062E\u0648\u0644 \u0627\u0644\u0645\u0646\u0635\u0629 \u0628\u0633\u0628\u0628: ${n}`:`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${a}) \u062D\u062A\u0649 ${e} \u0628\u0633\u0628\u0628: ${n}`;D(o)}}}catch(t){console.debug("[_enforceBanGuard] notice:",t)}}function D(t){document.body.innerHTML=`
  ...
  `}function ge(){const t=document.getElementById("header-search-container"),a=document.getElementById("header-search-pill"),s=document.getElementById("header-search-trigger"),n=document.getElementById("header-search-input"),e=document.getElementById("header-search-clear"),o=document.getElementById("header-live-dropdown"),i=document.getElementById("header-live-list"),c=document.getElementById("header-live-count"),p=document.getElementById("header-live-all-btn");if(!n)return;let f=null,b=0;const y=()=>{a?.classList.add("expanded"),n.focus(),n.value.trim().length>=1&&o?.classList.add("visible")},x=()=>{a?.classList.remove("expanded"),o?.classList.remove("visible")};s?.addEventListener("click",l=>{l.stopPropagation(),a?.classList.contains("expanded")&&n.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(n.value.trim())}`:y()}),n.addEventListener("focus",()=>{a?.classList.add("expanded"),n.value.trim().length>=1&&i?.children.length>0&&o?.classList.add("visible")}),e?.addEventListener("click",l=>{l.stopPropagation(),n.value="",e.classList.remove("visible"),o?.classList.remove("visible"),i&&(i.innerHTML=""),n.focus()}),n.addEventListener("keydown",l=>{l.key==="Enter"&&n.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(n.value.trim())}`:l.key==="Escape"&&x()}),n.addEventListener("input",()=>{const l=n.value.trim();if(e?.classList.toggle("visible",l.length>0),p&&(p.href=`search.html?q=${encodeURIComponent(l)}`),!l){o?.classList.remove("visible"),i&&(i.innerHTML="");return}clearTimeout(f),f=setTimeout(async()=>{const F=++b;try{const m=await Z(l,{limit:6});if(F!==b||!o||!i)return;if(!m||m.length===0){c&&(c.textContent="0"),i.innerHTML=`
          ...
          `,o.classList.add("visible");return}c&&(c.textContent=String(m.length)),i.innerHTML=m.map(k=>{const d=k.raw||k,E=d.name||"\u0645\u0643\u0627\u0646 \u0628\u0627\u0644\u062F\u0644\u064A\u0644",I=d.categoryName||k.category||"",q=d.area||d.address||"\u0645\u062F\u064A\u0646\u0629 \u0627\u0644\u0645\u0646\u0632\u0644\u0629",H=d.slug||d.id||"",S=d.photoURL||d.logo||d.coverURL||"",U=d.isVerified||!1,$=d.isOpen!==void 0?d.isOpen:!0,C=(E.trim()[0]||"\u0645").toUpperCase();return`
