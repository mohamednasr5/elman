import{initAuth as R,onAuthStateChange as N,signOut as T,waitForAuth as W,isAdmin as g,getCurrentUser as z,getClientIp as j}from"./auth.js";import{toast as r}from"../ui/components/Toast.js";function K(t){return`
...
<div class="pwa-banner" id="pwa-banner" hidden role="dialog" aria-label="\u062A\u062B\u0628\u064A\u062A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A">
...
</div>`}export async function initPage(t=""){if(J(),_("header-slot",K(t)),!t.includes("admin/")&&t!=="dashboard.html"){let e=document.getElementById("wide-ads-banner");if(!e&&t!=="index.html"&&t!==""){const o=document.getElementById("page-container")||document.querySelector("main");o&&(e=document.createElement("div"),e.id="wide-ads-banner",e.className="container",o.insertAdjacentElement("afterend",e))}e&&setTimeout(()=>{import("../ui/components/WideAdsBanner.js").then(({mountWideAdsBanner:o})=>o(e)).catch(()=>{})},100)}_("footer-slot",G()),_("nav-slot",V(t)),_("pwa-slot",O()),Y(),Q();try{import("../services/voice.service.js").then(({bindGlobalVoiceAssistantFab:e})=>e()).catch(e=>console.warn("[initPage] voice FAB init failed:",e))}catch(e){console.warn("[initPage] voice FAB import failed:",e)}const a=document.getElementById("site-header"),s=document.getElementById("scroll-to-top-btn");window.addEventListener("scroll",()=>{const e=window.scrollY||window.pageYOffset||0;a?.classList.toggle("scrolled",e>8),s?.classList.toggle("visible",e>300)},{passive:!0}),s?.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});try{re()}catch(e){console.warn("[initPage] header search init failed:",e)}document.addEventListener("click",e=>{(e.target.closest("#bottom-nav-more-btn")||e.target.closest("#dash-bottom-more-btn"))&&(e.preventDefault(),openDashboardMoreModal())});const n=e=>{"requestIdleCallback"in window?requestIdleCallback(e,{timeout:2500}):setTimeout(e,0)};n(async()=>{try{const{ensureFirebaseReady:e}=await import("./firebase.js");(await e(2500))?.auth&&R()}catch{}try{await ie()}catch{}try{const[{initLiveNotificationSubscriber:e},{initFcmMessaging:o}]=await Promise.all([import("../services/notification.service.js"),import("../services/fcm.service.js")]);N(i=>{Z(i),e(i?.uid),o(i)})}catch{}try{const{getSettings:e}=await import("./db.js"),i=(await e())?.contact?.whatsappLink;i&&document.querySelectorAll("[data-wa]").forEach(c=>{c.href=i})}catch{}});try{ae()}catch(e){console.warn("[initPage] PWA setup failed:",e)}"serviceWorker"in navigator&&n(()=>navigator.serviceWorker.register("./sw.js").catch(()=>{}));try{["manzala_fast_places_cache","manzala_live_news_store_v2","manzala_global_broadcast_notifs_cache"].forEach(o=>localStorage.removeItem(o))}catch{}n(()=>{import("../services/realtime-sync.service.js").then(({initRealtimePwaSyncBus:e})=>e()).catch(()=>{}),import("../utils/mobile-tooltip.js").then(({initUniversalMobileTouchTooltips:e})=>e()).catch(()=>{});try{X()}catch{}try{se()}catch{}})}function Y(){try{(window.matchMedia&&window.matchMedia("(display-mode: standalone)").matches||window.matchMedia&&window.matchMedia("(display-mode: fullscreen)").matches||window.matchMedia&&window.matchMedia("(display-mode: minimal-ui)").matches||window.navigator.standalone===!0||document.referrer&&document.referrer.includes("android-app://")||navigator.userAgent&&(navigator.userAgent.includes("wv")||navigator.userAgent.includes("Android")&&navigator.userAgent.includes("Version/"))||new URLSearchParams(window.location.search).get("source")==="apk"||new URLSearchParams(window.location.search).get("source")==="pwa")&&document.querySelectorAll("#footer-apk-container, .footer__apk-download, .apk-pro-download-btn").forEach(a=>{a.style.display="none"})}catch{}}function J(){const t=localStorage.getItem("elmanzala-theme")||(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light");A(t)}function Q(){document.querySelectorAll("#theme-toggle-btn, .theme-toggle-btn").forEach(t=>{t.addEventListener("click",()=>{const s=(document.documentElement.getAttribute("data-theme")||"light")==="dark"?"light":"dark";A(s),localStorage.setItem("elmanzala-theme",s),r.info(s==="dark"?"\u062A\u0645 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0648\u0636\u0639 \u0627\u0644\u0644\u064A\u0644\u064A \u{1F319}":"\u062A\u0645 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0648\u0636\u0639 \u0627\u0644\u0646\u0647\u0627\u0631\u064A \u2600\uFE0F")})})}function A(t){document.documentElement.setAttribute("data-theme",t),document.body&&(document.body.classList.toggle("dark-theme",t==="dark"),document.body.classList.toggle("light-theme",t==="light"));const a=document.querySelector('meta[name="theme-color"]');a&&a.setAttribute("content",t==="dark"?"#0F172A":"#1B4F72")}function X(){const t=new Set,a=e=>{if(e)try{const o=new URL(e,location.href);if(o.origin===location.origin&&!t.has(o.href)){t.add(o.href);const i=document.createElement("link");i.rel="prefetch",i.href=o.href,document.head.appendChild(i)}}catch{}};document.addEventListener("mouseover",e=>{const o=e.target.closest("a[href]");o&&a(o.href)},{passive:!0}),document.addEventListener("touchstart",e=>{const o=e.target.closest("a[href]");o&&a(o.href)},{passive:!0});const s=["index.html","places.html","categories.html","offers.html","search.html"],n=()=>{s.forEach(e=>a(e))};"requestIdleCallback"in window?window.requestIdleCallback(n,{timeout:1500}):setTimeout(n,800)}export{W as waitForAuth,g as isAdmin};function _(t,a){const s=document.getElementById(t);if(!s)return;const n=document.createElement("div");n.innerHTML=a.trim(),s.replaceWith(n.firstElementChild)}function Z(t){const a=document.getElementById("header-user-section");if(a)if(t){a.innerHTML=`
      <div style="display:flex;align-items:center;gap:10px">
        ...
        <div style="position:relative">
          <button class="header__user-btn" id="usr-btn" aria-haspopup="true" aria-expanded="false">
            <img src="${D(t.photoURL||"./icons/icon-72x72.png")}"
                 class="header__avatar" width="32" height="32"
                 onerror="this.src='./icons/icon-72x72.png'"
                 alt="${w(t.name)}"/>
            <span class="header__user-name">${w((t.name||"").split(" ")[0])}</span>
          ...
          <div class="header__dropdown" id="usr-dd" role="menu">
            ...
            ${g(t)?'<a href="admin.html" class="header__dropdown-item" style="color:var(--secondary,#F5A623);font-weight:bold" role="menuitem">\u2699\uFE0F \u0644\u0648\u062D\u0629 \u0627\u0644\u0625\u062F\u0627\u0631\u0629</a>':""}
    ...
    <div class="more-menu-container" style="direction:rtl;text-align:right">
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;padding:12px;background:var(--surface-2,#F8FAFC);border-radius:14px;margin-bottom:12px;border:1px solid var(--border,#E2E8F0)">
        <div style="display:flex;align-items:center;gap:12px">
          <img src="${D(o)}" style="width:44px;height:44px;border-radius:50%;object-fit:cover;border:2px solid var(--primary,#1B4F72)" alt="${w(e)}" onerror="this.src='./icons/icon-72x72.png'"/>
          <div>
            <div style="font-weight:800;font-size:0.98rem;color:var(--text-primary,#0F172A)">${w(e)}</div>
  ...
  `,{showModal:f}=await import("../ui/components/Modal.js"),p=f({title:"\u2630 \u0627\u0644\u0642\u0627\u0626\u0645\u0629 \u0648\u0644\u0648\u062D\u0629 \u0627\u0644\u062A\u062D\u0643\u0645",content:c,sheet:!0,closeable:!0,size:"sm"}),h=document.querySelector(".modal");return h&&(h.querySelectorAll("[data-dash-nav]").forEach(b=>{b.addEventListener("click",x=>{const l=b.getAttribute("data-dash-nav");i&&typeof window.switchDashboardSection=="function"?(x.preventDefault(),p.close(),window.switchDashboardSection(l,null,!0)):p.close()})}),document.getElementById("more-modal-logout-btn")?.addEventListener("click",async()=>{p.close(),await T(),r.success("\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062E\u0631\u0648\u062C \u0628\u0646\u062C\u0627\u062D"),window.location.reload()})),p}typeof window<"u"&&(window.openDashboardMoreModal=openDashboardMoreModal);let m=typeof window<"u"&&window.__deferredPwaPrompt?window.__deferredPwaPrompt:null;typeof window<"u"&&(window.addEventListener("beforeinstallprompt",t=>{t.preventDefault(),m=t,window.__deferredPwaPrompt=t}),window.addEventListener("appinstalled",()=>{try{localStorage.setItem("pwa-installed","true")}catch{}m=null,typeof window<"u"&&(window.__deferredPwaPrompt=null),u()}));function ee(){return typeof window>"u"?!1:!!(window.matchMedia("(display-mode: standalone)").matches||window.matchMedia("(display-mode: window-controls-overlay)").matches||window.navigator.standalone||document.referrer.includes("android-app://")||localStorage.getItem("pwa-installed")==="true")}function te(){try{const t=localStorage.getItem("pwa-dismissed");if(!t)return!1;const a=parseInt(t,10);return isNaN(a)?!1:Date.now()-a<7200*1e3}catch{return!1}}function B(){if(ee()||te())return!1;try{if(sessionStorage.getItem("pwa_session_shown")==="true")return!1}catch{}return!0}function ae(){const t=!localStorage.getItem("manzala_voice_guide_seen");t&&setTimeout(()=>{I()},2e3);const a=t?12e3:5e3,s=()=>{(m||typeof window<"u"&&window.__deferredPwaPrompt)&&B()&&!document.getElementById("voice-guide-callout")&&ne()};B()&&(m||typeof window<"u"&&window.__deferredPwaPrompt?setTimeout(s,a):typeof window<"u"&&window.addEventListener("beforeinstallprompt",()=>{setTimeout(s,a)},{once:!0})),document.addEventListener("click",n=>{if(n.target.closest("#pwa-banner-close")||n.target.closest("#pwa-banner-later")){n.preventDefault(),u();return}if(n.target.closest("#pwa-install-btn")){n.preventDefault(),oe();return}if(n.target.closest("#desktop-voice-fab")){n.preventDefault();try{import("../services/voice.service.js").then(({openManzalaVoiceAssistantModal:e})=>e()).catch(()=>{})}catch{}return}})}function ne(){if(!B())return;const t=document.getElementById("pwa-banner");if(t){try{sessionStorage.setItem("pwa_session_shown","true")}catch{}t.hidden=!1,t.style.display="block",requestAnimationFrame(()=>{t.classList.add("visible")})}}function u(){const t=document.getElementById("pwa-banner");t&&(t.classList.remove("visible"),setTimeout(()=>{t.hidden=!0,t.style.display="none"},350));try{localStorage.setItem("pwa-dismissed",Date.now().toString()),sessionStorage.setItem("pwa_session_shown","true")}catch{}I()}async function oe(){const t=m||(typeof window<"u"?window.__deferredPwaPrompt:null);if(t)try{t.prompt();const{outcome:a}=await t.userChoice;if(a==="accepted"){try{localStorage.setItem("pwa-installed","true")}catch{}u(),r.success("\u062A\u0645 \u062A\u062B\u0628\u064A\u062A \u0627\u0644\u062A\u0637\u0628\u064A\u0642 \u0628\u0646\u062C\u0627\u062D! \u0633\u062A\u062C\u062F\u0647 \u0641\u064A \u0634\u0627\u0634\u0629 \u062A\u0637\u0628\u064A\u0642\u0627\u062A \u0647\u0627\u062A\u0641\u0643 \u{1F389}"),setTimeout(()=>I(),1200)}else u()}catch{u()}finally{m=null,typeof window<"u"&&(window.__deferredPwaPrompt=null)}else u()}function I(){if(!(typeof document>"u")){try{if(localStorage.getItem("manzala_voice_guide_seen")==="true")return;localStorage.setItem("manzala_voice_guide_seen","true")}catch{return}setTimeout(()=>{const t=window.innerWidth>=769;let a=null;if(t?a=document.getElementById("desktop-voice-fab")||document.getElementById("global-voice-assistant-fab"):a=document.getElementById("global-voice-assistant-fab")||document.querySelector(".bottom-nav__fab-btn")||document.querySelector(".bottom-nav__fab"),!a)return;document.getElementById("voice-guide-callout")?.remove();const s=document.getElementById("pwa-banner");s&&s.classList.contains("visible")&&(s.classList.remove("visible"),s.style.display="none",s.hidden=!0);const n=document.createElement("div");n.className="voice-guide-callout",n.id="voice-guide-callout",n.setAttribute("role","tooltip"),n.innerHTML=`
...
\u0643\u0627\u0641\u0629 \u0627\u0644\u0645\u062D\u062A\u0648\u064A\u0627\u062A \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0642\u0648\u0627\u0639\u062F \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0646\u0634\u0648\u0631\u0629 \u0645\u0633\u062C\u0644\u0629 \u0648\u0645\u062D\u0645\u064A\u0629 \u0631\u0642\u0645\u064A\u0627\u064B\u060C \u0648\u0644\u0627 \u064A\u0645\u0643\u0646 \u0646\u0642\u0644\u0647\u0627 \u0623\u0648 \u0646\u0633\u062E\u0647\u0627 \u062D\u062A\u0649 \u0644\u0627 \u064A\u062A\u0645 \u0645\u0633\u0627\u0621\u0644\u062A\u0643 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u0623\u0645\u0627\u0645 \u0627\u0644\u0645\u062D\u0627\u0643\u0645 \u0628\u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629.`,"color: #EF4444; font-size: 13px; font-weight: 700; line-height: 1.8; font-family: Cairo, Tahoma, sans-serif;"),console.log("%c\u0631\u0627\u0628\u0637 \u0627\u0644\u0628\u0648\u0627\u0628\u0629 \u0627\u0644\u0631\u0633\u0645\u064A\u0629: %chttps://dalilmanzala.com/","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #0284C7; font-size: 11px; font-weight: 700; text-decoration: underline;"),console.log("%c\u{1F4AC} \u0644\u0644\u0627\u0633\u062A\u0641\u0633\u0627\u0631\u0627\u062A \u0648\u0627\u0644\u0627\u0642\u062A\u0631\u0627\u062D\u0627\u062A: %chttps://wa.me/wasendernew","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #10B981; font-size: 11px; font-weight: 700; text-decoration: underline;")}catch{}};a();let s=window.outerWidth-window.innerWidth,n=window.outerHeight-window.innerHeight;window.addEventListener("resize",()=>{const e=window.outerWidth-window.innerWidth,o=window.outerHeight-window.innerHeight;(e!==s||o!==n)&&(s=e,n=o,a())},{passive:!0}),document.addEventListener("contextmenu",e=>{const o=e.target.tagName.toLowerCase();o==="input"||o==="textarea"||e.target.isContentEditable||(e.preventDefault(),typeof r<"u"&&r.info&&r.info("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0645\u064A\u0629 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u2014 \u063A\u064A\u0631 \u0645\u0635\u0631\u062D \u0628\u0646\u0633\u062E \u0623\u0648 \u0646\u0642\u0644 \u0645\u062D\u062A\u0648\u0649 \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("copy",e=>{const o=e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||e.target.isContentEditable||(e.preventDefault(),e.clipboardData&&e.clipboardData.setData("text/plain",`\xA9 \u062C\u0645\u064A\u0639 \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0627\u0644\u062D\u0642\u0648\u0642 \u0645\u062D\u0641\u0648\u0638\u0629 \u0644\u062F\u0644\u064A\u0644 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A (${t}). https://dalilmanzala.com/`),typeof r<"u"&&r.warning&&r.warning("\u26A0\uFE0F \u062A\u0645 \u062D\u0641\u0638 \u062D\u0642\u0648\u0642 \u0627\u0644\u0645\u0644\u0643\u064A\u0629: \u0644\u0627 \u064A\u062C\u0648\u0632 \u0646\u0633\u062E \u0623\u0648 \u0627\u0642\u062A\u0628\u0627\u0633 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("cut",e=>{const o=e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||e.target.isContentEditable||e.preventDefault()}),document.addEventListener("keydown",e=>{const o=e.target.tagName?e.target.tagName.toLowerCase():"",i=o==="input"||o==="textarea"||e.target.isContentEditable;(e.key==="F12"||e.ctrlKey&&e.shiftKey&&(e.key==="I"||e.key==="i"||e.key==="J"||e.key==="j"||e.key==="C"||e.key==="c"))&&a(),e.ctrlKey&&(e.key==="u"||e.key==="U"||e.key==="s"||e.key==="S"||e.key==="p"||e.key==="P")&&(e.preventDefault(),typeof r<"u"&&r.warning&&r.warning("\u{1F512} \u0645\u0635\u062F\u0631 \u0648\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644 \u0645\u062D\u0645\u064A\u0629 \u0628\u0645\u0648\u062C\u0628 \u0642\u0627\u0646\u0648\u0646 \u0627\u0644\u0645\u0644\u0643\u064A\u0629 \u0627\u0644\u0641\u0643\u0631\u064A\u0629.")),e.ctrlKey&&(e.key==="c"||e.key==="C")&&!i&&(window.getSelection?window.getSelection().toString():"").length>0&&(e.preventDefault(),typeof r<"u"&&r.warning&&r.warning("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0645\u062D\u0645\u064A: \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u0646\u0633\u062E \u0644\u0645\u0646\u0639 \u0627\u0644\u062A\u0639\u062F\u064A \u0627\u0644\u0642\u0627\u0646\u0648\u0646\u064A."))})}async function ie(){try{const t=z();if(t&&g(t))return;if(t&&t.status==="suspended"){M("\u062A\u0645 \u0625\u064A\u0642\u0627\u0641 \u062D\u0633\u0627\u0628\u0643 \u0645\u0646 \u0642\u0628\u0644 \u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0645\u0646\u0635\u0629 \u0644\u0645\u062E\u0627\u0644\u0641\u0629 \u0627\u0644\u0634\u0631\u0648\u0637.");return}const a=await j();if(a){const{isIpBanned:s}=await import("./db.js"),n=await s(a);if(n){const e=n.reason||"\u0645\u062E\u0627\u0644\u0641\u0629 \u0645\u0639\u0627\u064A\u064A\u0631 \u0648\u0633\u064A\u0627\u0633\u0627\u062A \u0627\u0644\u0645\u0646\u0635\u0629",o=n.bannedUntil?new Date(n.bannedUntil).toLocaleDateString("ar-EG"):null,i=n.isPermanent?`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${a}) \u0646\u0647\u0627\u0626\u064A\u0627\u064B \u0645\u0646 \u062F\u062E\u0648\u0644 \u0627\u0644\u0645\u0646\u0635\u0629 \u0628\u0633\u0628\u0628: ${e}`:`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${a}) \u062D\u062A\u0649 ${o} \u0628\u0633\u0628\u0628: ${e}`;M(i)}}}catch(t){console.debug("[_enforceBanGuard] notice:",t)}}function M(t){document.body.innerHTML=`
  ...
  `}function re(){const t=document.getElementById("header-search-container"),a=document.getElementById("header-search-pill"),s=document.getElementById("header-search-trigger"),n=document.getElementById("header-search-input"),e=document.getElementById("header-search-clear"),o=document.getElementById("header-live-dropdown"),i=document.getElementById("header-live-list"),c=document.getElementById("header-live-count"),f=document.getElementById("header-live-all-btn");if(!n)return;let p=null,h=0;const b=()=>{a?.classList.add("expanded"),n.focus(),n.value.trim().length>=1&&o?.classList.add("visible")},x=()=>{a?.classList.remove("expanded"),o?.classList.remove("visible")};s?.addEventListener("click",l=>{l.stopPropagation(),a?.classList.contains("expanded")&&n.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(n.value.trim())}`:b()}),n.addEventListener("focus",()=>{a?.classList.add("expanded"),n.value.trim().length>=1&&i?.children.length>0&&o?.classList.add("visible")}),e?.addEventListener("click",l=>{l.stopPropagation(),n.value="",e.classList.remove("visible"),o?.classList.remove("visible"),i&&(i.innerHTML=""),n.focus()}),n.addEventListener("keydown",l=>{l.key==="Enter"&&n.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(n.value.trim())}`:l.key==="Escape"&&x()}),n.addEventListener("input",()=>{const l=n.value.trim();if(e?.classList.toggle("visible",l.length>0),f&&(f.href=`search.html?q=${encodeURIComponent(l)}`),!l){o?.classList.remove("visible"),i&&(i.innerHTML="");return}clearTimeout(p),p=setTimeout(async()=>{const F=++h;try{const{executeFastSearch:k}=await import("../services/search-engine.service.js"),v=await k(l,{limit:6});if(F!==h||!o||!i)return;if(!v||v.length===0){c&&(c.textContent="0"),i.innerHTML=`
          ...
          `,o.classList.add("visible");return}c&&(c.textContent=String(v.length)),i.innerHTML=v.map(E=>{const d=E.raw||E,L=d.name||"\u0645\u0643\u0627\u0646 \u0628\u0627\u0644\u062F\u0644\u064A\u0644",S=d.categoryName||E.category||"",q=d.area||d.address||"\u0645\u062F\u064A\u0646\u0629 \u0627\u0644\u0645\u0646\u0632\u0644\u0629",H=d.slug||d.id||"",$=d.photoURL||d.logo||d.coverURL||"",U=d.isVerified||!1,C=d.isOpen!==void 0?d.isOpen:!0,P=(L.trim()[0]||"\u0645").toUpperCase();return`
            <a href="/place.html?slug=${encodeURIComponent(H)}" class="header-live-dropdown__item" role="option">
              <div class="header-live-avatar">
                ${$?`<img src="${$}" alt="${y(L)}" loading="lazy" onerror="this.onerror=null;this.parentElement.innerHTML='<div class=\\'header-live-avatar-fallback\\'>${P}</div>'"/>`:`<div class="header-live-avatar-fallback">${P}</div>`}
              </div>
              <div class="header-live-content">
                <div class="header-live-title-row">
                  <span class="header-live-name">${y(L)}</span>
                  ${U?'<span class="header-live-verified" title="\u0645\u0643\u0627\u0646 \u0645\u0648\u062B\u0642">\u2713</span>':""}
                </div>
                <div class="header-live-meta-row">
                  ${S?`<span class="header-live-cat">${y(S)}</span>`:""}
                  <span class="header-live-area">${y(q)}</span>
                  <span class="${C?"header-live-status-open":"header-live-status-closed"}">
                    ${C?"\u0645\u0641\u062A\u0648\u062D \u0627\u0644\u0622\u0646":"\u0645\u063A\u0644\u0642"}
                  </span>
                </div>
              </div>
            </a>
          `}).join(""),o.classList.add("visible")}catch(k){console.warn("[HeaderLiveSearch] search error:",k)}},120)}),document.addEventListener("click",l=>{t?.contains(l.target)||(o?.classList.remove("visible"),window.innerWidth<=767&&a?.classList.remove("expanded"))})}function y(t){return String(t||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}
