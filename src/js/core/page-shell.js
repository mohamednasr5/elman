...
<header class="header" id="site-header" role="banner">
  <div class="container header__inner">
    ...
    <nav class="header__nav" aria-label="\u0627\u0644\u062A\u0646\u0642\u0644 \u0627\u0644\u0631\u0626\u064A\u0633\u064A">
      ${[["index.html","\u0627\u0644\u0631\u0626\u064A\u0633\u064A\u0629"],["places.html","\u0627\u0644\u0623\u0645\u0627\u0643\u0646"],["categories.html","\u0627\u0644\u062A\u0635\u0646\u064A\u0641\u0627\u062A"],["offers.html","\u0627\u0644\u0639\u0631\u0648\u0636"],["now.html","\u064A\u062D\u062F\u062B \u0627\u0644\u0622\u0646 \u{1F525}"],["around-me.html","\u0628\u0627\u0644\u0642\u0631\u0628 \u0645\u0646\u064A \u{1F9ED}"],["favorites.html","\u2764\uFE0F \u0627\u0644\u0645\u0641\u0636\u0644\u0629"]].map(([i,o])=>`<a href="${i}" class="header__nav-link${i===t?" active":""}">${o}</a>`).join("")}
    </nav>
...
</div>`}export async function initPage(t=""){if(J(),y("header-slot",K(t)),t==="index.html"||t==="home"||typeof window<"u"&&(window.location.pathname==="/"||window.location.pathname.endsWith("/index.html")||window.location.pathname.endsWith("/"))){const e=(s=0)=>{const r=document.getElementById("wide-ads-banner");r&&!r.dataset.wideAdsMounted?import("../ui/components/WideAdsBanner.js").then(({mountWideAdsBanner:u})=>u(r)).catch(()=>{}):!r&&s<25&&setTimeout(()=>e(s+1),100)};e()}else{let e=document.getElementById("wide-ads-banner");if(!e){e=document.createElement("div"),e.id="wide-ads-banner",e.className="container wide-ads-banner-page-top",e.style.margin="14px auto";const s=document.getElementById("site-header"),r=document.getElementById("page-container")||document.querySelector("main")||document.querySelector("#admin-container")||document.querySelector(".admin-layout")||document.querySelector("#app")||document.body;s&&s.nextSibling?s.parentNode.insertBefore(e,s.nextSibling):r&&r.firstChild?r.insertBefore(e,r.firstChild):r?r.appendChild(e):document.body.appendChild(e)}e&&setTimeout(()=>{import("../ui/components/WideAdsBanner.js").then(({mountWideAdsBanner:s})=>s(e)).catch(()=>{})},50)}y("footer-slot",O()),y("nav-slot",V(t)),y("pwa-slot",Y()),Q(),X();try{import("../services/voice.service.js").then(({bindGlobalVoiceAssistantFab:e})=>e()).catch(e=>console.warn("[initPage] voice FAB init failed:",e))}catch(e){console.warn("[initPage] voice FAB import failed:",e)}const i=document.getElementById("site-header"),o=document.getElementById("scroll-to-top-btn");window.addEventListener("scroll",()=>{const e=window.scrollY||window.pageYOffset||0;i?.classList.toggle("scrolled",e>8),o?.classList.toggle("visible",e>300)},{passive:!0}),o?.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});try{le()}catch(e){console.warn("[initPage] header search init failed:",e)}document.addEventListener("click",e=>{(e.target.closest("#bottom-nav-more-btn")||e.target.closest("#dash-bottom-more-btn"))&&(e.preventDefault(),openDashboardMoreModal())});const a=e=>{"requestIdleCallback"in window?requestIdleCallback(e,{timeout:2500}):setTimeout(e,0)};a(async()=>{try{const{ensureFirebaseReady:e}=await import("./firebase.js");(await e(2500))?.auth&&W()}catch{}try{await re()}catch{}try{const[{initLiveNotificationSubscriber:e},{initFcmMessaging:s}]=await Promise.all([import("../services/notification.service.js"),import("../services/fcm.service.js")]);N(r=>{ee(r),e(r?.uid),s(r)})}catch{}try{const{getSettings:e}=await import("./db.js"),r=(await e())?.contact?.whatsappLink;r&&document.querySelectorAll("[data-wa]").forEach(u=>{u.href=r})}catch{}});try{ne()}catch(e){console.warn("[initPage] PWA setup failed:",e)}"serviceWorker"in navigator&&a(()=>navigator.serviceWorker.register("./sw.js").catch(()=>{}));try{["manzala_fast_places_cache","manzala_live_news_store_v2","manzala_global_broadcast_notifs_cache"].forEach(s=>localStorage.removeItem(s))}catch{}a(()=>{import("../services/realtime-sync.service.js").then(({initRealtimePwaSyncBus:e})=>e()).catch(()=>{}),import("../utils/mobile-tooltip.js").then(({initUniversalMobileTouchTooltips:e})=>e()).catch(()=>{});try{Z()}catch{}try{se()}catch{}})}function Q(){try{(window.matchMedia&&window.matchMedia("(display-mode: standalone)").matches||window.matchMedia&&window.matchMedia("(display-mode: fullscreen)").matches||window.matchMedia&&window.matchMedia("(display-mode: minimal-ui)").matches||window.navigator.standalone===!0||document.referrer&&document.referrer.includes("android-app://")||navigator.userAgent&&(navigator.userAgent.includes("wv")||navigator.userAgent.includes("Android")&&navigator.userAgent.includes("Version/"))||new URLSearchParams(window.location.search).get("source")==="apk"||new URLSearchParams(window.location.search).get("source")==="pwa")&&document.querySelectorAll("#footer-apk-container, .footer__apk-download, .apk-pro-download-btn").forEach(n=>{n.style.display="none"})}catch{}}function J(){const t=localStorage.getItem("elmanzala-theme")||(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light");A(t)}function X(){document.querySelectorAll("#theme-toggle-btn, .theme-toggle-btn").forEach(t=>{t.addEventListener("click",()=>{const i=(document.documentElement.getAttribute("data-theme")||"light")==="dark"?"light":"dark";A(i),localStorage.setItem("elmanzala-theme",i),d.info(i==="dark"?"\u062A\u0645 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0648\u0636\u0639 \u0627\u0644\u0644\u064A\u0644\u064A \u{1F319}":"\u062A\u0645 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0648\u0636\u0639 \u0627\u0644\u0646\u0647\u0627\u0631\u064A \u2600\uFE0F")})})}function A(t){document.documentElement.setAttribute("data-theme",t),document.body&&(document.body.classList.toggle("dark-theme",t==="dark"),document.body.classList.toggle("light-theme",t==="light"));const n=document.querySelector('meta[name="theme-color"]');n&&n.setAttribute("content",t==="dark"?"#0F172A":"#1B4F72")}function Z(){const t=new Set,n=a=>{if(a)try{const e=new URL(a,location.href);if(e.origin===location.origin&&!t.has(e.href)){t.add(e.href);const s=document.createElement("link");s.rel="prefetch",s.href=e.href,document.head.appendChild(s)}}catch{}};document.addEventListener("mouseover",a=>{const e=a.target.closest("a[href]");e&&n(e.href)},{passive:!0}),document.addEventListener("touchstart",a=>{const e=a.target.closest("a[href]");e&&n(e.href)},{passive:!0});const i=["index.html","places.html","categories.html","offers.html","search.html"],o=()=>{i.forEach(a=>n(a))};"requestIdleCallback"in window?window.requestIdleCallback(o,{timeout:1500}):setTimeout(o,800)}export{R as waitForAuth,_ as isAdmin};function y(t,n){const i=document.getElementById(t);if(!i)return;const o=document.createElement("div");o.innerHTML=n.trim(),i.replaceWith(o.firstElementChild)}function ee(t){const n=document.getElementById("header-user-section");if(n)if(t){n.innerHTML=`
...
\u0643\u0627\u0641\u0629 \u0627\u0644\u0645\u062D\u062A\u0648\u064A\u0627\u062A \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0642\u0648\u0627\u0639\u062F \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0646\u0634\u0648\u0631\u0629 \u0645\u0633\u062C\u0644\u0629 \u0648\u0645\u062D\u0645\u064A\u0629 \u0631\u0642\u0645\u064A\u0627\u064B\u060C \u0648\u0644\u0627 \u064A\u0645\u0643\u0646 \u0646\u0642\u0644\u0647\u0627 \u0623\u0648 \u0646\u0633\u062E\u0647\u0627 \u062D\u062A\u0649 \u0644\u0627 \u064A\u062A\u0645 \u0645\u0633\u0627\u0621\u0644\u062A\u0643 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u0623\u0645\u0627\u0645 \u0627\u0644\u0645\u062D\u0627\u0643\u0645 \u0628\u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629.`,"color: #EF4444; font-size: 13px; font-weight: 700; line-height: 1.8; font-family: Cairo, Tahoma, sans-serif;"),console.log("%c\u0631\u0627\u0628\u0637 \u0627\u0644\u0628\u0648\u0627\u0628\u0629 \u0627\u0644\u0631\u0633\u0645\u064A\u0629: %chttps://dalilmanzala.com/","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #0284C7; font-size: 11px; font-weight: 700; text-decoration: underline;"),console.log("%c\u{1F4AC} \u0644\u0644\u0627\u0633\u062A\u0641\u0633\u0627\u0631\u0627\u062A \u0648\u0627\u0644\u0627\u0642\u062A\u0631\u0627\u062D\u0627\u062A: %chttps://wa.me/wasendernew","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #10B981; font-size: 11px; font-weight: 700; text-decoration: underline;")}catch{}};n();let i=window.outerWidth-window.innerWidth,o=window.outerHeight-window.innerHeight;window.addEventListener("resize",()=>{const a=window.outerWidth-window.innerWidth,e=window.outerHeight-window.innerHeight;(a!==i||e!==o)&&(i=a,o=e,n())},{passive:!0}),document.addEventListener("contextmenu",a=>{const e=a.target.tagName.toLowerCase();e==="input"||e==="textarea"||a.target.isContentEditable||(a.preventDefault(),typeof d<"u"&&d.info&&d.info("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0645\u064A\u0629 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u2014 \u063A\u064A\u0631 \u0645\u0635\u0631\u062D \u0628\u0646\u0633\u062E \u0623\u0648 \u0646\u0642\u0644 \u0645\u062D\u062A\u0648\u0649 \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("copy",a=>{const e=a.target.tagName?a.target.tagName.toLowerCase():"";e==="input"||e==="textarea"||a.target.isContentEditable||(a.preventDefault(),a.clipboardData&&a.clipboardData.setData("text/plain",`\xA9 \u062C\u0645\u064A\u0639 \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0627\u0644\u062D\u0642\u0648\u0642 \u0645\u062D\u0641\u0648\u0638\u0629 \u0644\u062F\u0644\u064A\u0644 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A (${t}). https://dalilmanzala.com/`),typeof d<"u"&&d.warning&&d.warning("\u26A0\uFE0F \u062A\u0645 \u062D\u0641\u0638 \u062D\u0642\u0648\u0642 \u0627\u0644\u0645\u0644\u0643\u064A\u0629: \u0644\u0627 \u064A\u062C\u0648\u0632 \u0646\u0633\u062E \u0623\u0648 \u0627\u0642\u062A\u0628\u0627\u0633 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("cut",a=>{const e=a.target.tagName?a.target.tagName.toLowerCase():"";e==="input"||e==="textarea"||a.target.isContentEditable||a.preventDefault()}),document.addEventListener("keydown",a=>{const e=a.target.tagName?a.target.tagName.toLowerCase():"",s=e==="input"||e==="textarea"||a.target.isContentEditable;(a.key==="F12"||a.ctrlKey&&a.shiftKey&&(a.key==="I"||a.key==="i"||a.key==="J"||a.key==="j"||a.key==="C"||a.key==="c"))&&n(),a.ctrlKey&&(a.key==="u"||a.key==="U"||a.key==="s"||a.key==="S"||a.key==="p"||a.key==="P")&&(a.preventDefault(),typeof d<"u"&&d.warning&&d.warning("\u{1F512} \u0645\u0635\u062F\u0631 \u0648\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644 \u0645\u062D\u0645\u064A\u0629 \u0628\u0645\u0648\u062C\u0628 \u0642\u0627\u0646\u0648\u0646 \u0627\u0644\u0645\u0644\u0643\u064A\u0629 \u0627\u0644\u0641\u0643\u0631\u064A\u0629.")),a.ctrlKey&&(a.key==="c"||a.key==="C")&&!s&&(window.getSelection?window.getSelection().toString():"").length>0&&(a.preventDefault(),typeof d<"u"&&d.warning&&d.warning("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0645\u062D\u0645\u064A: \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u0646\u0633\u062E \u0644\u0645\u0646\u0639 \u0627\u0644\u062A\u0639\u062F\u064A \u0627\u0644\u0642\u0627\u0646\u0648\u0646\u064A."))})}async function re(){try{const t=P();if(t&&_(t))return;if(t&&t.status==="suspended"){D("\u062A\u0645 \u0625\u064A\u0642\u0627\u0641 \u062D\u0633\u0627\u0628\u0643 \u0645\u0646 \u0642\u0628\u0644 \u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0645\u0646\u0635\u0629 \u0644\u0645\u062E\u0627\u0644\u0641\u0629 \u0627\u0644\u0634\u0631\u0648\u0637.");return}const n=await j();if(n){const{isIpBanned:i}=await import("./db.js"),o=await i(n);if(o){const a=o.reason||"\u0645\u062E\u0627\u0644\u0641\u0629 \u0645\u0639\u0627\u064A\u064A\u0631 \u0648\u0633\u064A\u0627\u0633\u0627\u062A \u0627\u0644\u0645\u0646\u0635\u0629",e=o.bannedUntil?new Date(o.bannedUntil).toLocaleDateString("ar-EG"):null,s=o.isPermanent?`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${n}) \u0646\u0647\u0627\u0626\u064A\u0627\u064B \u0645\u0646 \u062F\u062E\u0648\u0644 \u0627\u0644\u0645\u0646\u0635\u0629 \u0628\u0633\u0628\u0628: ${a}`:`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${n}) \u062D\u062A\u0649 ${e} \u0628\u0633\u0628\u0628: ${a}`;D(s)}}}catch(t){console.debug("[_enforceBanGuard] notice:",t)}}function D(t){document.body.innerHTML=`
  ...
  `}function le(){const t=document.getElementById("header-search-container"),n=document.getElementById("header-search-pill"),i=document.getElementById("header-search-trigger"),o=document.getElementById("header-search-input"),a=document.getElementById("header-search-clear"),e=document.getElementById("header-live-dropdown"),s=document.getElementById("header-live-list"),r=document.getElementById("header-live-count"),u=document.getElementById("header-live-all-btn");if(!o)return;let h=null,b=0;const f=()=>{n?.classList.add("expanded"),o.focus(),o.value.trim().length>=1&&e?.classList.add("visible")},c=()=>{n?.classList.remove("expanded"),e?.classList.remove("visible")};i?.addEventListener("click",l=>{l.stopPropagation(),n?.classList.contains("expanded")&&o.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(o.value.trim())}`:f()}),o.addEventListener("focus",()=>{n?.classList.add("expanded"),o.value.trim().length>=1&&s?.children.length>0&&e?.classList.add("visible")}),a?.addEventListener("click",l=>{l.stopPropagation(),o.value="",a.classList.remove("visible"),e?.classList.remove("visible"),s&&(s.innerHTML=""),o.focus()}),o.addEventListener("keydown",l=>{l.key==="Enter"&&o.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(o.value.trim())}`:l.key==="Escape"&&c()}),o.addEventListener("input",()=>{const l=o.value.trim();if(a?.classList.toggle("visible",l.length>0),u&&(u.href=`search.html?q=${encodeURIComponent(l)}`),!l){e?.classList.remove("visible"),s&&(s.innerHTML="");return}clearTimeout(h),h=setTimeout(async()=>{const m=++b;try{const{executeFastSearch:E}=await import("../services/search-engine.service.js"),w=await E(l,{limit:6});if(m!==b||!e||!s)return;if(!w||w.length===0){r&&(r.textContent="0"),s.innerHTML=`
          ...
          `,e.classList.add("visible");return}r&&(r.textContent=String(w.length)),s.innerHTML=w.map(L=>{const p=L.raw||L,B=p.name||"\u0645\u0643\u0627\u0646 \u0628\u0627\u0644\u062F\u0644\u064A\u0644",z=p.categoryName||L.category||"",H=p.area||p.address||"\u0645\u062F\u064A\u0646\u0629 \u0627\u0644\u0645\u0646\u0632\u0644\u0629",q=p.slug||p.id||"",C=p.photoURL||p.logo||p.coverURL||"",U=p.isVerified||!1,$=p.isOpen!==void 0?p.isOpen:!0,M=(B.trim()[0]||"\u0645").toUpperCase();return`
