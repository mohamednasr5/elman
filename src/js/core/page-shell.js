import{initAuth as j,onAuthStateChange as R,signOut as M,waitForAuth as N,isAdmin as _,getCurrentUser as A,getClientIp as W,signInWithGoogle as G}from"./auth.js";import{toast as l}from"../ui/components/Toast.js";function K(t){return`
...
<div class="pwa-banner" id="pwa-banner" hidden role="dialog" aria-label="\u062A\u062B\u0628\u064A\u062A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A">
...
</div>`}export async function initPage(t=""){if(J(),y("header-slot",K(t)),!t.includes("admin/")&&t!=="dashboard.html"){let e=document.getElementById("wide-ads-banner");if(!e&&t!=="index.html"&&t!==""){const o=document.getElementById("page-container")||document.querySelector("main");o&&(e=document.createElement("div"),e.id="wide-ads-banner",e.className="container",o.insertAdjacentElement("afterend",e))}e&&setTimeout(()=>{import("../ui/components/WideAdsBanner.js").then(({mountWideAdsBanner:o})=>o(e)).catch(()=>{})},100)}y("footer-slot",O()),y("nav-slot",V(t)),y("pwa-slot",Y()),Q(),X();try{import("../services/voice.service.js").then(({bindGlobalVoiceAssistantFab:e})=>e()).catch(e=>console.warn("[initPage] voice FAB init failed:",e))}catch(e){console.warn("[initPage] voice FAB import failed:",e)}const a=document.getElementById("site-header"),s=document.getElementById("scroll-to-top-btn");window.addEventListener("scroll",()=>{const e=window.scrollY||window.pageYOffset||0;a?.classList.toggle("scrolled",e>8),s?.classList.toggle("visible",e>300)},{passive:!0}),s?.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});try{le()}catch(e){console.warn("[initPage] header search init failed:",e)}document.addEventListener("click",e=>{(e.target.closest("#bottom-nav-more-btn")||e.target.closest("#dash-bottom-more-btn"))&&(e.preventDefault(),openDashboardMoreModal())});const n=e=>{"requestIdleCallback"in window?requestIdleCallback(e,{timeout:2500}):setTimeout(e,0)};n(async()=>{try{const{ensureFirebaseReady:e}=await import("./firebase.js");(await e(2500))?.auth&&j()}catch{}try{await re()}catch{}try{const[{initLiveNotificationSubscriber:e},{initFcmMessaging:o}]=await Promise.all([import("../services/notification.service.js"),import("../services/fcm.service.js")]);R(i=>{ee(i),e(i?.uid),o(i)})}catch{}try{const{getSettings:e}=await import("./db.js"),i=(await e())?.contact?.whatsappLink;i&&document.querySelectorAll("[data-wa]").forEach(c=>{c.href=i})}catch{}});try{ne()}catch(e){console.warn("[initPage] PWA setup failed:",e)}"serviceWorker"in navigator&&n(()=>navigator.serviceWorker.register("./sw.js").catch(()=>{}));try{["manzala_fast_places_cache","manzala_live_news_store_v2","manzala_global_broadcast_notifs_cache"].forEach(o=>localStorage.removeItem(o))}catch{}n(()=>{import("../services/realtime-sync.service.js").then(({initRealtimePwaSyncBus:e})=>e()).catch(()=>{}),import("../utils/mobile-tooltip.js").then(({initUniversalMobileTouchTooltips:e})=>e()).catch(()=>{});try{Z()}catch{}try{ie()}catch{}})}function Q(){try{(window.matchMedia&&window.matchMedia("(display-mode: standalone)").matches||window.matchMedia&&window.matchMedia("(display-mode: fullscreen)").matches||window.matchMedia&&window.matchMedia("(display-mode: minimal-ui)").matches||window.navigator.standalone===!0||document.referrer&&document.referrer.includes("android-app://")||navigator.userAgent&&(navigator.userAgent.includes("wv")||navigator.userAgent.includes("Android")&&navigator.userAgent.includes("Version/"))||new URLSearchParams(window.location.search).get("source")==="apk"||new URLSearchParams(window.location.search).get("source")==="pwa")&&document.querySelectorAll("#footer-apk-container, .footer__apk-download, .apk-pro-download-btn").forEach(a=>{a.style.display="none"})}catch{}}function J(){const t=localStorage.getItem("elmanzala-theme")||(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light");P(t)}function X(){document.querySelectorAll("#theme-toggle-btn, .theme-toggle-btn").forEach(t=>{t.addEventListener("click",()=>{const s=(document.documentElement.getAttribute("data-theme")||"light")==="dark"?"light":"dark";P(s),localStorage.setItem("elmanzala-theme",s),l.info(s==="dark"?"\u062A\u0645 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0648\u0636\u0639 \u0627\u0644\u0644\u064A\u0644\u064A \u{1F319}":"\u062A\u0645 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0648\u0636\u0639 \u0627\u0644\u0646\u0647\u0627\u0631\u064A \u2600\uFE0F")})})}function P(t){document.documentElement.setAttribute("data-theme",t),document.body&&(document.body.classList.toggle("dark-theme",t==="dark"),document.body.classList.toggle("light-theme",t==="light"));const a=document.querySelector('meta[name="theme-color"]');a&&a.setAttribute("content",t==="dark"?"#0F172A":"#1B4F72")}function Z(){const t=new Set,a=e=>{if(e)try{const o=new URL(e,location.href);if(o.origin===location.origin&&!t.has(o.href)){t.add(o.href);const i=document.createElement("link");i.rel="prefetch",i.href=o.href,document.head.appendChild(i)}}catch{}};document.addEventListener("mouseover",e=>{const o=e.target.closest("a[href]");o&&a(o.href)},{passive:!0}),document.addEventListener("touchstart",e=>{const o=e.target.closest("a[href]");o&&a(o.href)},{passive:!0});const s=["index.html","places.html","categories.html","offers.html","search.html"],n=()=>{s.forEach(e=>a(e))};"requestIdleCallback"in window?window.requestIdleCallback(n,{timeout:1500}):setTimeout(n,800)}export{N as waitForAuth,_ as isAdmin};function y(t,a){const s=document.getElementById(t);if(!s)return;const n=document.createElement("div");n.innerHTML=a.trim(),s.replaceWith(n.firstElementChild)}function ee(t){const a=document.getElementById("header-user-section");if(a)if(t){a.innerHTML=`
    ...
    <div class="more-menu-container" style="direction:rtl;text-align:right">
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;padding:12px;background:var(--surface-2,#F8FAFC);border-radius:14px;margin-bottom:12px;border:1px solid var(--border,#E2E8F0)">
        <div style="display:flex;align-items:center;gap:12px">
          <img src="${F(o)}" style="width:44px;height:44px;border-radius:50%;object-fit:cover;border:2px solid var(--primary,#1B4F72)" alt="${x(e)}" onerror="this.src='./icons/icon-72x72.png'"/>
          <div>
            <div style="font-weight:800;font-size:0.98rem;color:var(--text-primary,#0F172A)">${x(e)}</div>
            <div style="font-size:0.8rem;color:var(--text-muted,#64748B)">${n?"\u0645\u062F\u064A\u0631 \u0627\u0644\u0645\u0646\u0635\u0629 \u2B50":"\u0635\u0627\u062D\u0628 \u062D\u0633\u0627\u0628 \u062A\u062C\u0627\u0631\u064A"}</div>
          </div>
        </div>
      </div>
  ...
  `,{showModal:b}=await import("../ui/components/Modal.js"),u=b({title:s?"\u2630 \u0627\u0644\u0642\u0627\u0626\u0645\u0629 \u0648\u0644\u0648\u062D\u0629 \u0627\u0644\u062A\u062D\u0643\u0645":"\u2630 \u062F\u0644\u064A\u0644 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629",content:c,sheet:!0,closeable:!0,size:"sm"}),v=document.querySelector(".modal");return v&&(v.querySelectorAll("[data-dash-nav]").forEach(h=>{h.addEventListener("click",d=>{const r=h.getAttribute("data-dash-nav");i&&typeof window.switchDashboardSection=="function"?(d.preventDefault(),u.close(),window.switchDashboardSection(r,null,!0)):u.close()})}),document.getElementById("more-modal-logout-btn")?.addEventListener("click",async()=>{u.close(),await M(),l.success("\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062E\u0631\u0648\u062C \u0628\u0646\u062C\u0627\u062D"),window.location.reload()}),document.getElementById("more-modal-google-login-btn")?.addEventListener("click",async h=>{h.preventDefault();const d=h.currentTarget,r=d.innerHTML;try{d.disabled=!0,d.style.opacity="0.7",d.innerHTML="<span>\u062C\u0627\u0631\u064A \u0641\u062A\u062D \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062F\u062E\u0648\u0644...</span>";const m=await G();m?(u.close(),l.success(`\u0623\u0647\u0644\u0627\u064B \u0628\u0643 ${m.displayName||m.name||""} \u{1F44B}`),window.location.reload()):(d.disabled=!1,d.style.opacity="1",d.innerHTML=r)}catch(m){d.disabled=!1,d.style.opacity="1",d.innerHTML=r,console.error("[MoreModal GoogleSignIn] error:",m),m?.code!=="auth/popup-closed-by-user"&&l.error("\u062A\u0639\u0630\u0631 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062F\u062E\u0648\u0644: "+(m?.message||"\u064A\u0631\u062C\u0649 \u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649"))}})),u}typeof window<"u"&&(window.openDashboardMoreModal=openDashboardMoreModal);let f=typeof window<"u"&&window.__deferredPwaPrompt?window.__deferredPwaPrompt:null;typeof window<"u"&&(window.addEventListener("beforeinstallprompt",t=>{t.preventDefault(),f=t,window.__deferredPwaPrompt=t}),window.addEventListener("appinstalled",()=>{try{localStorage.setItem("pwa-installed","true")}catch{}f=null,typeof window<"u"&&(window.__deferredPwaPrompt=null),g()}));function te(){return typeof window>"u"?!1:!!(window.matchMedia("(display-mode: standalone)").matches||window.matchMedia("(display-mode: window-controls-overlay)").matches||window.navigator.standalone||document.referrer.includes("android-app://")||localStorage.getItem("pwa-installed")==="true")}function ae(){try{const t=localStorage.getItem("pwa-dismissed");if(!t)return!1;const a=parseInt(t,10);return isNaN(a)?!1:Date.now()-a<7200*1e3}catch{return!1}}function I(){if(te()||ae())return!1;try{if(sessionStorage.getItem("pwa_session_shown")==="true")return!1}catch{}return!0}function ne(){const t=!localStorage.getItem("manzala_voice_guide_seen");t&&setTimeout(()=>{z()},2e3);const a=t?12e3:5e3,s=()=>{(f||typeof window<"u"&&window.__deferredPwaPrompt)&&I()&&!document.getElementById("voice-guide-callout")&&oe()};I()&&(f||typeof window<"u"&&window.__deferredPwaPrompt?setTimeout(s,a):typeof window<"u"&&window.addEventListener("beforeinstallprompt",()=>{setTimeout(s,a)},{once:!0})),document.addEventListener("click",n=>{if(n.target.closest("#pwa-banner-close")||n.target.closest("#pwa-banner-later")){n.preventDefault(),g();return}if(n.target.closest("#pwa-install-btn")){n.preventDefault(),se();return}if(n.target.closest("#desktop-voice-fab")){n.preventDefault();try{import("../services/voice.service.js").then(({openManzalaVoiceAssistantModal:e})=>e()).catch(()=>{})}catch{}return}})}function oe(){if(!I())return;const t=document.getElementById("pwa-banner");if(t){try{sessionStorage.setItem("pwa_session_shown","true")}catch{}t.hidden=!1,t.style.display="block",requestAnimationFrame(()=>{t.classList.add("visible")})}}function g(){const t=document.getElementById("pwa-banner");t&&(t.classList.remove("visible"),setTimeout(()=>{t.hidden=!0,t.style.display="none"},350));try{localStorage.setItem("pwa-dismissed",Date.now().toString()),sessionStorage.setItem("pwa_session_shown","true")}catch{}z()}async function se(){const t=f||(typeof window<"u"?window.__deferredPwaPrompt:null);if(t)try{t.prompt();const{outcome:a}=await t.userChoice;if(a==="accepted"){try{localStorage.setItem("pwa-installed","true")}catch{}g(),l.success("\u062A\u0645 \u062A\u062B\u0628\u064A\u062A \u0627\u0644\u062A\u0637\u0628\u064A\u0642 \u0628\u0646\u062C\u0627\u062D! \u0633\u062A\u062C\u062F\u0647 \u0641\u064A \u0634\u0627\u0634\u0629 \u062A\u0637\u0628\u064A\u0642\u0627\u062A \u0647\u0627\u062A\u0641\u0643 \u{1F389}"),setTimeout(()=>z(),1200)}else g()}catch{g()}finally{f=null,typeof window<"u"&&(window.__deferredPwaPrompt=null)}else g()}function z(){if(!(typeof document>"u")){try{if(localStorage.getItem("manzala_voice_guide_seen")==="true")return;localStorage.setItem("manzala_voice_guide_seen","true")}catch{return}setTimeout(()=>{const t=window.innerWidth>=769;let a=null;if(t?a=document.getElementById("desktop-voice-fab")||document.getElementById("global-voice-assistant-fab"):a=document.getElementById("global-voice-assistant-fab")||document.querySelector(".bottom-nav__fab-btn")||document.querySelector(".bottom-nav__fab"),!a)return;document.getElementById("voice-guide-callout")?.remove();const s=document.getElementById("pwa-banner");s&&s.classList.contains("visible")&&(s.classList.remove("visible"),s.style.display="none",s.hidden=!0);const n=document.createElement("div");n.className="voice-guide-callout",n.id="voice-guide-callout",n.setAttribute("role","tooltip"),n.innerHTML=`
...
\u0643\u0627\u0641\u0629 \u0627\u0644\u0645\u062D\u062A\u0648\u064A\u0627\u062A \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0642\u0648\u0627\u0639\u062F \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0646\u0634\u0648\u0631\u0629 \u0645\u0633\u062C\u0644\u0629 \u0648\u0645\u062D\u0645\u064A\u0629 \u0631\u0642\u0645\u064A\u0627\u064B\u060C \u0648\u0644\u0627 \u064A\u0645\u0643\u0646 \u0646\u0642\u0644\u0647\u0627 \u0623\u0648 \u0646\u0633\u062E\u0647\u0627 \u062D\u062A\u0649 \u0644\u0627 \u064A\u062A\u0645 \u0645\u0633\u0627\u0621\u0644\u062A\u0643 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u0623\u0645\u0627\u0645 \u0627\u0644\u0645\u062D\u0627\u0643\u0645 \u0628\u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629.`,"color: #EF4444; font-size: 13px; font-weight: 700; line-height: 1.8; font-family: Cairo, Tahoma, sans-serif;"),console.log("%c\u0631\u0627\u0628\u0637 \u0627\u0644\u0628\u0648\u0627\u0628\u0629 \u0627\u0644\u0631\u0633\u0645\u064A\u0629: %chttps://dalilmanzala.com/","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #0284C7; font-size: 11px; font-weight: 700; text-decoration: underline;"),console.log("%c\u{1F4AC} \u0644\u0644\u0627\u0633\u062A\u0641\u0633\u0627\u0631\u0627\u062A \u0648\u0627\u0644\u0627\u0642\u062A\u0631\u0627\u062D\u0627\u062A: %chttps://wa.me/wasendernew","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #10B981; font-size: 11px; font-weight: 700; text-decoration: underline;")}catch{}};a();let s=window.outerWidth-window.innerWidth,n=window.outerHeight-window.innerHeight;window.addEventListener("resize",()=>{const e=window.outerWidth-window.innerWidth,o=window.outerHeight-window.innerHeight;(e!==s||o!==n)&&(s=e,n=o,a())},{passive:!0}),document.addEventListener("contextmenu",e=>{const o=e.target.tagName.toLowerCase();o==="input"||o==="textarea"||e.target.isContentEditable||(e.preventDefault(),typeof l<"u"&&l.info&&l.info("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0645\u064A\u0629 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u2014 \u063A\u064A\u0631 \u0645\u0635\u0631\u062D \u0628\u0646\u0633\u062E \u0623\u0648 \u0646\u0642\u0644 \u0645\u062D\u062A\u0648\u0649 \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("copy",e=>{const o=e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||e.target.isContentEditable||(e.preventDefault(),e.clipboardData&&e.clipboardData.setData("text/plain",`\xA9 \u062C\u0645\u064A\u0639 \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0627\u0644\u062D\u0642\u0648\u0642 \u0645\u062D\u0641\u0648\u0638\u0629 \u0644\u062F\u0644\u064A\u0644 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A (${t}). https://dalilmanzala.com/`),typeof l<"u"&&l.warning&&l.warning("\u26A0\uFE0F \u062A\u0645 \u062D\u0641\u0638 \u062D\u0642\u0648\u0642 \u0627\u0644\u0645\u0644\u0643\u064A\u0629: \u0644\u0627 \u064A\u062C\u0648\u0632 \u0646\u0633\u062E \u0623\u0648 \u0627\u0642\u062A\u0628\u0627\u0633 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("cut",e=>{const o=e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||e.target.isContentEditable||e.preventDefault()}),document.addEventListener("keydown",e=>{const o=e.target.tagName?e.target.tagName.toLowerCase():"",i=o==="input"||o==="textarea"||e.target.isContentEditable;(e.key==="F12"||e.ctrlKey&&e.shiftKey&&(e.key==="I"||e.key==="i"||e.key==="J"||e.key==="j"||e.key==="C"||e.key==="c"))&&a(),e.ctrlKey&&(e.key==="u"||e.key==="U"||e.key==="s"||e.key==="S"||e.key==="p"||e.key==="P")&&(e.preventDefault(),typeof l<"u"&&l.warning&&l.warning("\u{1F512} \u0645\u0635\u062F\u0631 \u0648\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644 \u0645\u062D\u0645\u064A\u0629 \u0628\u0645\u0648\u062C\u0628 \u0642\u0627\u0646\u0648\u0646 \u0627\u0644\u0645\u0644\u0643\u064A\u0629 \u0627\u0644\u0641\u0643\u0631\u064A\u0629.")),e.ctrlKey&&(e.key==="c"||e.key==="C")&&!i&&(window.getSelection?window.getSelection().toString():"").length>0&&(e.preventDefault(),typeof l<"u"&&l.warning&&l.warning("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0645\u062D\u0645\u064A: \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u0646\u0633\u062E \u0644\u0645\u0646\u0639 \u0627\u0644\u062A\u0639\u062F\u064A \u0627\u0644\u0642\u0627\u0646\u0648\u0646\u064A."))})}async function re(){try{const t=A();if(t&&_(t))return;if(t&&t.status==="suspended"){D("\u062A\u0645 \u0625\u064A\u0642\u0627\u0641 \u062D\u0633\u0627\u0628\u0643 \u0645\u0646 \u0642\u0628\u0644 \u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0645\u0646\u0635\u0629 \u0644\u0645\u062E\u0627\u0644\u0641\u0629 \u0627\u0644\u0634\u0631\u0648\u0637.");return}const a=await W();if(a){const{isIpBanned:s}=await import("./db.js"),n=await s(a);if(n){const e=n.reason||"\u0645\u062E\u0627\u0644\u0641\u0629 \u0645\u0639\u0627\u064A\u064A\u0631 \u0648\u0633\u064A\u0627\u0633\u0627\u062A \u0627\u0644\u0645\u0646\u0635\u0629",o=n.bannedUntil?new Date(n.bannedUntil).toLocaleDateString("ar-EG"):null,i=n.isPermanent?`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${a}) \u0646\u0647\u0627\u0626\u064A\u0627\u064B \u0645\u0646 \u062F\u062E\u0648\u0644 \u0627\u0644\u0645\u0646\u0635\u0629 \u0628\u0633\u0628\u0628: ${e}`:`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${a}) \u062D\u062A\u0649 ${o} \u0628\u0633\u0628\u0628: ${e}`;D(i)}}}catch(t){console.debug("[_enforceBanGuard] notice:",t)}}function D(t){document.body.innerHTML=`
  ...
  `}function le(){const t=document.getElementById("header-search-container"),a=document.getElementById("header-search-pill"),s=document.getElementById("header-search-trigger"),n=document.getElementById("header-search-input"),e=document.getElementById("header-search-clear"),o=document.getElementById("header-live-dropdown"),i=document.getElementById("header-live-list"),c=document.getElementById("header-live-count"),b=document.getElementById("header-live-all-btn");if(!n)return;let u=null,v=0;const h=()=>{a?.classList.add("expanded"),n.focus(),n.value.trim().length>=1&&o?.classList.add("visible")},d=()=>{a?.classList.remove("expanded"),o?.classList.remove("visible")};s?.addEventListener("click",r=>{r.stopPropagation(),a?.classList.contains("expanded")&&n.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(n.value.trim())}`:h()}),n.addEventListener("focus",()=>{a?.classList.add("expanded"),n.value.trim().length>=1&&i?.children.length>0&&o?.classList.add("visible")}),e?.addEventListener("click",r=>{r.stopPropagation(),n.value="",e.classList.remove("visible"),o?.classList.remove("visible"),i&&(i.innerHTML=""),n.focus()}),n.addEventListener("keydown",r=>{r.key==="Enter"&&n.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(n.value.trim())}`:r.key==="Escape"&&d()}),n.addEventListener("input",()=>{const r=n.value.trim();if(e?.classList.toggle("visible",r.length>0),b&&(b.href=`search.html?q=${encodeURIComponent(r)}`),!r){o?.classList.remove("visible"),i&&(i.innerHTML="");return}clearTimeout(u),u=setTimeout(async()=>{const m=++v;try{const{executeFastSearch:E}=await import("../services/search-engine.service.js"),w=await E(r,{limit:6});if(m!==v||!o||!i)return;if(!w||w.length===0){c&&(c.textContent="0"),i.innerHTML=`
          ...
          `,o.classList.add("visible");return}c&&(c.textContent=String(w.length)),i.innerHTML=w.map(L=>{const p=L.raw||L,B=p.name||"\u0645\u0643\u0627\u0646 \u0628\u0627\u0644\u062F\u0644\u064A\u0644",C=p.categoryName||L.category||"",H=p.area||p.address||"\u0645\u062F\u064A\u0646\u0629 \u0627\u0644\u0645\u0646\u0632\u0644\u0629",q=p.slug||p.id||"",S=p.photoURL||p.logo||p.coverURL||"",U=p.isVerified||!1,$=p.isOpen!==void 0?p.isOpen:!0,T=(B.trim()[0]||"\u0645").toUpperCase();return`
            <a href="/place.html?slug=${encodeURIComponent(q)}" class="header-live-dropdown__item" role="option">
              <div class="header-live-avatar">
                ${S?`<img src="${S}" alt="${k(B)}" loading="lazy" onerror="this.onerror=null;this.parentElement.innerHTML='<div class=\\'header-live-avatar-fallback\\'>${T}</div>'"/>`:`<div class="header-live-avatar-fallback">${T}</div>`}
              </div>
          ...
          `}).join(""),o.classList.add("visible")}catch(E){console.warn("[HeaderLiveSearch] search error:",E)}},120)}),document.addEventListener("click",r=>{t?.contains(r.target)||(o?.classList.remove("visible"),window.innerWidth<=767&&a?.classList.remove("expanded"))})}function k(t){return String(t||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}
