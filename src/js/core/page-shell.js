import{initAuth as N,onAuthStateChange as W,signOut as T,waitForAuth as j,isAdmin as v,getCurrentUser as P,getClientIp as V}from"./auth.js";import{toast as r}from"../ui/components/Toast.js";function ae(t){return`
<header class="header" id="site-header" role="banner">
  <div class="container header__inner">
    ...
    <nav class="header__nav" aria-label="\u0627\u0644\u062A\u0646\u0642\u0644 \u0627\u0644\u0631\u0626\u064A\u0633\u064A">
      ${[["index.html","\u0627\u0644\u0631\u0626\u064A\u0633\u064A\u0629"],["places.html","\u0627\u0644\u0623\u0645\u0627\u0643\u0646"],["categories.html","\u0627\u0644\u062A\u0635\u0646\u064A\u0641\u0627\u062A"],["offers.html","\u0627\u0644\u0639\u0631\u0648\u0636"],["now.html","\u064A\u062D\u062F\u062B \u0627\u0644\u0622\u0646 \u{1F525}"],["around-me.html","\u0628\u0627\u0644\u0642\u0631\u0628 \u0645\u0646\u064A \u{1F9ED}"],["favorites.html","\u2764\uFE0F \u0627\u0644\u0645\u0641\u0636\u0644\u0629"]].map(([s,n])=>`<a href="${s}" class="header__nav-link${s===t?" active":""}">${n}</a>`).join("")}
    </nav>
...
</header>`}function ne(t){if(t==="admin/index.html")return`
...
</nav>`;const a=[["index.html","\u{1F3E0}","\u0627\u0644\u0631\u0626\u064A\u0633\u064A\u0629"],["categories.html","\u{1F4CB}","\u0627\u0644\u062A\u0635\u0646\u064A\u0641\u0627\u062A"],["offers.html","\u{1F3F7}\uFE0F","\u0627\u0644\u0639\u0631\u0648\u0636"],["#more","\u2630","\u0627\u0644\u0645\u0632\u064A\u062F"]];return`
...
<div class="pwa-banner" id="pwa-banner" hidden role="dialog" aria-label="\u062A\u062B\u0628\u064A\u062A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A">
  <div class="pwa-banner__rect">
    ...
    <div class="pwa-banner__rect-actions">
...
</div>`}export async function initPage(t=""){if(re(),g("header-slot",ae(t)),!t.includes("admin/")&&t!=="dashboard.html"){let e=document.getElementById("wide-ads-banner");if(!e&&t!=="index.html"&&t!==""){const o=document.getElementById("page-container")||document.querySelector("main");o&&(e=document.createElement("div"),e.id="wide-ads-banner",e.className="container",o.insertAdjacentElement("afterend",e))}e&&setTimeout(()=>{import("../ui/components/WideAdsBanner.js").then(({mountWideAdsBanner:e})=>e(document.getElementById("wide-ads-banner"))).catch(()=>{})},100)}g("footer-slot",oe()),g("nav-slot",ne(t)),g("pwa-slot",se()),ie(),le();import("../services/voice.service.js").then(({bindGlobalVoiceAssistantFab:e})=>e()).catch(e=>console.warn("[initPage] voice FAB init failed:",e));const a=document.getElementById("site-header"),s=document.getElementById("scroll-to-top-btn");window.addEventListener("scroll",()=>{const e=window.scrollY||window.pageYOffset||0;a?.classList.toggle("scrolled",e>8),s?.classList.toggle("visible",e>300)},{passive:!0}),s?.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})});try{ge()}catch(e){console.warn("[initPage] header search init failed:",e)}document.addEventListener("click",e=>{(e.target.closest("#bottom-nav-more-btn")||e.target.closest("#dash-bottom-more-btn"))&&(e.preventDefault(),openDashboardMoreModal())});const n=e=>{"requestIdleCallback"in window?requestIdleCallback(e,{timeout:2500}):setTimeout(e,0)};n(async()=>{try{const{ensureFirebaseReady:e}=await import("./firebase.js");(await e(2500))?.auth&&N()}catch{}try{await ve()}catch{}try{const[{initLiveNotificationSubscriber:e},{initFcmMessaging:a}]=await Promise.all([import("../services/notification.service.js"),import("../services/fcm.service.js")]);W(t=>{ce(t),e(t?.uid),a(t)})}catch{}try{const{getSettings:e}=await import("./db.js"),a=(await e())?.contact?.whatsappLink;a&&document.querySelectorAll("[data-wa]").forEach(e=>{e.href=a})}catch{});try{ue()}catch(e){console.warn("[initPage] PWA setup failed:",e)}"serviceWorker"in navigator&&n(()=>navigator.serviceWorker.register("./sw.js").catch(()=>{}));try{["manzala_fast_places_cache","manzala_live_news_store_v2","manzala_global_broadcast_notifs_cache"].forEach(o=>localStorage.removeItem(o))}catch{}n(()=>{import("../services/realtime-sync.service.js").then(({initRealtimePwaSyncBus:e})=>e()).catch(()=>{}),import("../utils/mobile-tooltip.js").then(({initUniversalMobileTouchTooltips:e})=>e()).catch(()=>{});try{de()}catch{}try{be()}catch{}})}function ie(){try{(window.matchMedia&&window.matchMedia("(display-mode: standalone)").matches||window.matchMedia&&window.matchMedia("(display-mode: fullscreen)").matches||window.matchMedia&&window.matchMedia("(display-mode: minimal-ui)").matches||window.navigator.standalone===!0||document.referrer&&document.referrer.includes("android-app://")||navigator.userAgent&&(navigator.userAgent.includes("wv")||navigator.userAgent.includes("Android")&&navigator.userAgent.includes("Version/"))||new URLSearchParams(window.location.search).get("source")==="apk"||new URLSearchParams(window.location.search).get("source")==="pwa")&&document.querySelectorAll("#footer-apk-container, .footer__apk-download, .apk-pro-download-btn").forEach(a=>{a.style.display="none"})}catch{}}function re(){const t=localStorage.getItem("elmanzala-theme")||(window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light");A(t)}function le(){document.querySelectorAll("#theme-toggle-btn, .theme-toggle-btn").forEach(t=>{t.addEventListener("click",()=>{const s=(document.documentElement.getAttribute("data-theme")||"light")==="dark"?"light":"dark";A(s),localStorage.setItem("elmanzala-theme",s),r.info(s==="dark"?"\u062A\u0645 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0648\u0636\u0639 \u0627\u0644\u0644\u064A\u0644\u064A \u{1F319}":"\u062A\u0645 \u062A\u0641\u0639\u064A\u0644 \u0627\u0644\u0648\u0636\u0639 \u0627\u0644\u0646\u0647\u0627\u0631\u064A \u2600\uFE0F")})})}function A(t){document.documentElement.setAttribute("data-theme",t),document.body&&(document.body.classList.toggle("dark-theme",t==="dark"),document.body.classList.toggle("light-theme",t==="light"));const a=document.querySelector('meta[name="theme-color"]');a&&a.setAttribute("content",t==="dark"?"#0F172A":"#1B4F72")}function de(){const t=new Set,a=e=>{if(e)try{const o=new URL(e,location.href);if(o.origin===location.origin&&!t.has(o.href)){t.add(o.href);const i=document.createElement("link");i.rel="prefetch",i.href=o.href,document.head.appendChild(i)}}catch{}};document.addEventListener("mouseover",e=>{const o=e.target.closest("a[href]");o&&a(o.href)},{passive:!0}),document.addEventListener("touchstart",e=>{const o=e.target.closest("a[href]");o&&a(o.href)},{passive:!0});const s=["index.html","places.html","categories.html","offers.html","search.html"],n=()=>{s.forEach(e=>a(e))};"requestIdleCallback"in window?window.requestIdleCallback(n,{timeout:1500}):setTimeout(n,800)}export{j as waitForAuth,v as isAdmin};function g(t,a){const s=document.getElementById(t);if(!s)return;const n=document.createElement("div");n.innerHTML=a.trim(),s.replaceWith(n.firstElementChild)}function ce(t){const a=document.getElementById("header-user-section");if(a)if(t){a.innerHTML=`
      <div style="display:flex;align-items:center;gap:10px">
        ...
        <div style="position:relative">
          <button class="header__user-btn" id="usr-btn" aria-haspopup="true" aria-expanded="false">
            <img src="${M(t.photoURL||"./icons/icon-72x72.png")}"
                 class="header__avatar" width="32" height="32"
                 onerror="this.src='./icons/icon-72x72.png'"
                 alt="${_(t.name)}"/>
            <span class="header__user-name">${_((t.name||"").split(" ")[0])}</span>
          ...
          <div class="header__dropdown" id="usr-dd" role="menu">
            ...
            ${v(t)?'<a href="admin.html" class="header__dropdown-item" style="color:var(--secondary,#F5A623);font-weight:bold" role="menuitem">\u2699\uFE0F \u0644\u0648\u062D\u0629 \u0627\u0644\u0625\u062F\u0627\u0631\u0629</a>':""}
      ...
      </div>`;const s=document.getElementById("usr-btn"),n=document.getElementById("usr-dd");s&&n&&(s.addEventListener("click",e=>{if(e.preventDefault(),e.stopPropagation(),window.innerWidth<769){openDashboardMoreModal(t);return}const o=n.classList.contains("open");n.classList.toggle("open",!o),s.setAttribute("aria-expanded",o?"false":"true")}),document.addEventListener("click",e=>{!e.target.closest("#usr-btn")&&!e.target.closest("#usr-dd")&&(n.classList.remove("open"),s.setAttribute("aria-expanded","false"))})),document.getElementById("logout-btn")?.addEventListener("click",async()=>{await T(),r.success("\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062E\u0631\u0648\u062C \u0628\u0646\u062C\u0627\u062D"),location.reload()})}else a.innerHTML='<a href="login.html" class="btn btn-primary btn-sm"><span>\u{1F511}</span> \u062F\u062E\u0648\u0644</a>'}export async function openDashboardMoreModal(t=null){const a=t||P(),s=!!(a&&(a.uid||a.id)),n=s&&v(a),e=s?a.name||a.displayName||"\u0635\u0627\u062D\u0628 \u0627\u0644\u0646\u0634\u0627\u0637":"\u0632\u0627\u0626\u0631 \u0643\u0631\u064A\u0645",o=s&&a.photoURL||"./icons/icon-72x72.png",i=typeof window<"u"&&(window.location.pathname.endsWith("dashboard.html")||window.location.pathname.endsWith("/dashboard.html")),c=`
    <div class="more-menu-container" style="direction:rtl;text-align:right">
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;padding:12px;background:var(--surface-2,#F8FAFC);border-radius:14px;margin-bottom:12px;border:1px solid var(--border,#E2E8F0)">
        <div style="display:flex;align-items:center;gap:12px">
          <img src="${M(o)}" style="width:44px;height:44px;border-radius:50%;object-fit:cover;border:2px solid var(--primary,#1B4F72)" alt="${_(e)}" onerror="this.src='./icons/icon-72x72.png'"/>
          <div>
            <div style="font-weight:800;font-size:0.98rem;color:var(--text-primary,#0F172A)">${_(e)}</div>
            <div style="font-size:0.8rem;color:var(--text-muted,#64748B)">${s?n?"\u0645\u062F\u064A\u0631 \u0627\u0644\u0645\u0646\u0635\u0629 \u2B50":"\u0635\u0627\u062D\u0628 \u062D\u0633\u0627\u0628 \u062A\u062C\u0627\u0631\u064A":"\u062F\u0644\u064A\u0644 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629"}</div>
          </div>
        </div>
        ${s?"":`
          <a href="login.html" class="btn btn-primary btn-sm" style="font-weight:700;padding:6px 14px"><span>\u{1F511}</span> \u062F\u062E\u0648\u0644</a>
        `}
      </div>
  ...
  `,p=(await import("../ui/components/Modal.js")).showModal({title:"\u2630 \u0627\u0644\u0642\u0627\u0626\u0645\u0629 \u0648\u0644\u0648\u062D\u0629 \u0627\u0644\u062A\u062D\u0643\u0645",content:c,sheet:!0,closeable:!0,size:"sm"}),f=document.querySelector(".modal");return f&&(f.querySelectorAll("[data-dash-nav]").forEach(b=>{b.addEventListener("click",y=>{const x=b.getAttribute("data-dash-nav");i&&typeof window.switchDashboardSection=="function"?(y.preventDefault(),p.close(),window.switchDashboardSection(x,null,!0)):p.close()})}),document.getElementById("more-modal-logout-btn")?.addEventListener("click",async()=>{p.close(),await T(),r.success("\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062E\u0631\u0648\u062C \u0628\u0646\u062C\u0627\u062D"),window.location.reload()})),p}typeof window<"u"&&(window.openDashboardMoreModal=openDashboardMoreModal);let u=typeof window<"u"&&window.__deferredPwaPrompt?window.__deferredPwaPrompt:null;typeof window<"u"&&(window.addEventListener("beforeinstallprompt",t=>{t.preventDefault(),u=t,window.__deferredPwaPrompt=t}),window.addEventListener("appinstalled",()=>{try{localStorage.setItem("pwa-installed","true")}catch{}u=null,typeof window<"u"&&(window.__deferredPwaPrompt=null),h()}));function pe(){return typeof window>"u"?!1:!!(window.matchMedia("(display-mode: standalone)").matches||window.matchMedia("(display-mode: window-controls-overlay)").matches||window.navigator.standalone||document.referrer.includes("android-app://")||localStorage.getItem("pwa-installed")==="true")}function me(){try{const t=localStorage.getItem("pwa-dismissed");if(!t)return!1;const a=parseInt(t,10);return isNaN(a)?!1:Date.now()-a<7200*1e3}catch{return!1}}function L(){if(pe()||me())return!1;try{if(sessionStorage.getItem("pwa_session_shown")==="true")return!1}catch{}return!0}function ue(){const t=!localStorage.getItem("manzala_voice_guide_seen");t&&setTimeout(()=>{B()},2e3);const a=t?12e3:5e3,s=()=>{(u||typeof window<"u"&&window.__deferredPwaPrompt)&&L()&&!document.getElementById("voice-guide-callout")&&he()};L()&&(u||typeof window<"u"&&window.__deferredPwaPrompt?setTimeout(s,a):typeof window<"u"&&window.addEventListener("beforeinstallprompt",()=>{setTimeout(s,a)},{once:!0})),document.addEventListener("click",n=>{if(n.target.closest("#pwa-banner-close")||n.target.closest("#pwa-banner-later")){n.preventDefault(),h();return}if(n.target.closest("#pwa-install-btn")){n.preventDefault(),fe();return}if(n.target.closest("#desktop-voice-fab")){n.preventDefault();import("../services/voice.service.js").then(({openManzalaVoiceAssistantModal:e})=>e()).catch(()=>{})return}})}function he(){if(!L())return;const t=document.getElementById("pwa-banner");if(t){try{sessionStorage.setItem("pwa_session_shown","true")}catch{}t.hidden=!1,t.style.display="block",requestAnimationFrame(()=>{t.classList.add("visible")})}}function h(){const t=document.getElementById("pwa-banner");t&&(t.classList.remove("visible"),setTimeout(()=>{t.hidden=!0,t.style.display="none"},350));try{localStorage.setItem("pwa-dismissed",Date.now().toString()),sessionStorage.setItem("pwa_session_shown","true")}catch{}B()}async function fe(){const t=u||(typeof window<"u"?window.__deferredPwaPrompt:null);if(t)try{t.prompt();const{outcome:a}=await t.userChoice;if(a==="accepted"){try{localStorage.setItem("pwa-installed","true")}catch{}h(),r.success("\u062A\u0645 \u062A\u062B\u0628\u064A\u062A \u0627\u0644\u062A\u0637\u0628\u064A\u0642 \u0628\u0646\u062C\u0627\u062D! \u0633\u062A\u062C\u062F\u0647 \u0641\u064A \u0634\u0627\u0634\u0629 \u062A\u0637\u0628\u064A\u0642\u0627\u062A \u0647\u0627\u062A\u0641\u0643 \u{1F389}"),setTimeout(()=>B(),1200)}else h()}catch{h()}finally{u=null,typeof window<"u"&&(window.__deferredPwaPrompt=null)}else h()}function B(){if(!(typeof document>"u")){try{if(localStorage.getItem("manzala_voice_guide_seen")==="true")return;localStorage.setItem("manzala_voice_guide_seen","true")}catch{return}setTimeout(()=>{const t=window.innerWidth>=769;let a=null;if(t?a=document.getElementById("desktop-voice-fab")||document.getElementById("global-voice-assistant-fab"):a=document.getElementById("global-voice-assistant-fab")||document.querySelector(".bottom-nav__fab-btn")||document.querySelector(".bottom-nav__fab"),!a)return;document.getElementById("voice-guide-callout")?.remove();const s=document.getElementById("pwa-banner");s&&s.classList.contains("visible")&&(s.classList.remove("visible"),s.style.display="none",s.hidden=!0);const n=document.createElement("div");n.className="voice-guide-callout",n.id="voice-guide-callout",n.setAttribute("role","tooltip"),n.innerHTML=`
    ...
    `,document.body.appendChild(n),a.classList.add("voice-mic-highlighted");const e=()=>{n.classList.add("fade-out"),a?.classList.remove("voice-mic-highlighted"),setTimeout(()=>n.remove(),350)};n.querySelector("#voice-guide-callout-close")?.addEventListener("click",i=>{i.stopPropagation(),e()}),n.querySelector("#voice-guide-bubble")?.addEventListener("click",i=>{if(!i.target.closest("#voice-guide-callout-close")){e();try{z()}catch{}}}),a.addEventListener("click",e,{once:!0});const o=i=>{!n.contains(i.target)&&!a.contains(i.target)&&(e(),document.removeEventListener("click",o))};setTimeout(()=>{document.addEventListener("click",o)},400),setTimeout(()=>{document.body.contains(n)&&(e(),document.removeEventListener("click",o))},9e3)},500)}}function _(t){return t?String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):""}function M(t){return t?String(t).replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function be(){if(typeof window>"u")return;const t=new Date().getFullYear(),a=()=>{try{console.log(`%c\xA9 \u062C\u0645\u064A\u0639 \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0627\u0644\u062D\u0642\u0648\u0642 \u0645\u062D\u0641\u0648\u0638\u0629 \u0644\u062F\u0644\u064A\u0644 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A (${t}).`,"background: linear-gradient(135deg, #0B2239, #153A5C); color: #F5A623; font-size: 16px; font-weight: 800; padding: 12px 20px; border-radius: 8px; border: 2px solid #F5A623; font-family: Cairo, Tahoma, sans-serif; text-shadow: 0 1px 2px rgba(0,0,0,0.5);"),console.log(`%c\u26A0\uFE0F \u062A\u062D\u0630\u064A\u0631 \u0642\u0627\u0646\u0648\u0646\u064A \u0631\u0633\u0645\u064A:
\u0643\u0627\u0641\u0629 \u0627\u0644\u0645\u062D\u062A\u0648\u064A\u0627\u062A \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0642\u0648\u0627\u0639\u062F \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0646\u0634\u0648\u0631\u0629 \u0645\u0633\u062C\u0644\u0629 \u0648\u0645\u062D\u0645\u064A\u0629 \u0631\u0642\u0645\u064A\u0627\u064B\u060C \u0648\u0644\u0627 \u064A\u0645\u0643\u0646 \u0646\u0642\u0644\u0647\u0627 \u0623\u0648 \u0646\u0633\u062E\u0647\u0627 \u062D\u062A\u0649 \u0644\u0627 \u064A\u062A\u0645 \u0645\u0633\u0627\u0621\u0644\u062A\u0643 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u0623\u0645\u0627\u0645 \u0627\u0644\u0645\u062D\u0627\u0643\u0645 \u0628\u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629.`,"color: #EF4444; font-size: 13px; font-weight: 700; line-height: 1.8; font-family: Cairo, Tahoma, sans-serif;"),console.log("%c\u0631\u0627\u0628\u0637 \u0627\u0644\u0628\u0648\u0627\u0628\u0629 \u0627\u0644\u0631\u0633\u0645\u064A\u0629: %chttps://dalilmanzala.com/","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #0284C7; font-size: 11px; font-weight: 700; text-decoration: underline;"),console.log("%c\u{1F4AC} \u0644\u0644\u0627\u0633\u062A\u0641\u0633\u0627\u0631\u0627\u062A \u0648\u0627\u0644\u0627\u0642\u062A\u0631\u0627\u062D\u0627\u062A: %chttps://wa.me/wasendernew","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #10B981; font-size: 11px; font-weight: 700; text-decoration: underline;")}catch{}};a();let s=window.outerWidth-window.innerWidth,n=window.outerHeight-window.innerHeight;window.addEventListener("resize",()=>{const e=window.outerWidth-window.innerWidth,o=window.outerHeight-window.innerHeight;(e!==s||o!==n)&&(s=e,n=o,a())},{passive:!0}),document.addEventListener("contextmenu",e=>{const o=e.target.tagName.toLowerCase();o==="input"||o==="textarea"||e.target.isContentEditable||(e.preventDefault(),typeof r<"u"&&r.info&&r.info("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0645\u064A\u0629 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u2014 \u063A\u064A\u0631 \u0645\u0635\u0631\u062D \u0628\u0646\u0633\u062E \u0623\u0648 \u0646\u0642\u0644 \u0645\u062D\u062A\u0648\u0649 \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("copy",e=>{const o=e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||e.target.isContentEditable||(e.preventDefault(),e.clipboardData&&e.clipboardData.setData("text/plain",`\xA9 \u062C\u0645\u064A\u0639 \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0627\u0644\u062D\u0642\u0648\u0642 \u0645\u062D\u0641\u0648\u0638\u0629 \u0644\u062F\u0644\u064A\u0644 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A (${t}). https://dalilmanzala.com/`),typeof r<"u"&&r.warning&&r.warning("\u26A0\uFE0F \u062A\u0645 \u062D\u0641\u0638 \u062D\u0642\u0648\u0642 \u0627\u0644\u0645\u0644\u0643\u064A\u0629: \u0644\u0627 \u064A\u062C\u0648\u0632 \u0646\u0633\u062E \u0623\u0648 \u0627\u0642\u062A\u0628\u0627\u0633 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("cut",e=>{const o=e.target.tagName?e.target.tagName.toLowerCase():"";o==="input"||o==="textarea"||e.target.isContentEditable||e.preventDefault()}),document.addEventListener("keydown",e=>{const o=e.target.tagName?e.target.tagName.toLowerCase():"",i=o==="input"||o==="textarea"||e.target.isContentEditable;(e.key==="F12"||e.ctrlKey&&e.shiftKey&&(e.key==="I"||e.key==="i"||e.key==="J"||e.key==="j"||e.key==="C"||e.key==="c"))&&a(),e.ctrlKey&&(e.key==="u"||e.key==="U"||e.key==="s"||e.key==="S"||e.key==="p"||e.key==="P")&&(e.preventDefault(),typeof r<"u"&&r.warning&&r.warning("\u{1F512} \u0645\u0635\u062F\u0631 \u0648\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644 \u0645\u062D\u0645\u064A\u0629 \u0628\u0645\u0648\u062C\u0628 \u0642\u0627\u0646\u0648\u0646 \u0627\u0644\u0645\u0644\u0643\u064A\u0629 \u0627\u0644\u0641\u0643\u0631\u064A\u0629.")),e.ctrlKey&&(e.key==="c"||e.key==="C")&&!i&&(window.getSelection?window.getSelection().toString():"").length>0&&(e.preventDefault(),typeof r<"u"&&r.warning&&r.warning("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0645\u062D\u0645\u064A: \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u0646\u0633\u062E \u0644\u0645\u0646\u0639 \u0627\u0644\u062A\u0639\u062F\u064A \u0627\u0644\u0642\u0627\u0646\u0648\u0646\u064A."))})}async function ve(){try{const t=P();if(t&&v(t))return;if(t&&t.status==="suspended"){D("\u062A\u0645 \u0625\u064A\u0642\u0627\u0641 \u062D\u0633\u0627\u0628\u0643 \u0645\u0646 \u0642\u0628\u0644 \u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0645\u0646\u0635\u0629 \u0644\u0645\u062E\u0627\u0644\u0641\u0629 \u0627\u0644\u0634\u0631\u0648\u0637.");return}const a=await V();if(a){const{isIpBanned:s}=await import("./db.js");const n=await s(a);if(n){const s=n,reason=s.reason||"\u0645\u062E\u0627\u0644\u0641\u0629 \u0645\u0639\u0627\u064A\u064A\u0631 \u0648\u0633\u064A\u0627\u0633\u0627\u062A \u0627\u0644\u0645\u0646\u0635\u0629",e=s.bannedUntil?new Date(s.bannedUntil).toLocaleDateString("ar-EG"):null,o=s.isPermanent?`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${a}) \u0646\u0647\u0627\u0626\u064A\u0627\u064B \u0645\u0646 \u062F\u062E\u0648\u0644 \u0627\u0644\u0645\u0646\u0635\u0629 \u0628\u0633\u0628\u0628: ${reason}`:`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${a}) \u062D\u062A\u0649 ${e} \u0628\u0633\u0628\u0628: ${reason}`;D(o)}}}catch(t){console.debug("[_enforceBanGuard] notice:",t)}}function D(t){document.body.innerHTML=`
  ...
  `}function ge(){const t=document.getElementById("header-search-container"),a=document.getElementById("header-search-pill"),s=document.getElementById("header-search-trigger"),n=document.getElementById("header-search-input"),e=document.getElementById("header-search-clear"),o=document.getElementById("header-live-dropdown"),i=document.getElementById("header-live-list"),c=document.getElementById("header-live-count"),p=document.getElementById("header-live-all-btn");if(!n)return;let f=null,b=0;const y=()=>{a?.classList.add("expanded"),n.focus(),n.value.trim().length>=1&&o?.classList.add("visible")},x=()=>{a?.classList.remove("expanded"),o?.classList.remove("visible")};s?.addEventListener("click",l=>{l.stopPropagation(),a?.classList.contains("expanded")&&n.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(n.value.trim())}`:y()}),n.addEventListener("focus",()=>{a?.classList.add("expanded"),n.value.trim().length>=1&&i?.children.length>0&&o?.classList.add("visible")}),e?.addEventListener("click",l=>{l.stopPropagation(),n.value="",e.classList.remove("visible"),o?.classList.remove("visible"),i&&(i.innerHTML=""),n.focus()}),n.addEventListener("keydown",l=>{l.key==="Enter"&&n.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(n.value.trim())}`:l.key==="Escape"&&x()}),n.addEventListener("input",()=>{const l=n.value.trim();if(e?.classList.toggle("visible",l.length>0),p&&(p.href=`search.html?q=${encodeURIComponent(l)}`),!l){o?.classList.remove("visible"),i&&(i.innerHTML="");return}clearTimeout(f),f=setTimeout(async()=>{const F=++b;try{const{executeFastSearch:m}=await import("../services/search-engine.service.js");const a=await m(l,{limit:6});if(F!==b||!o||!i)return;if(!a||a.length===0){c&&(c.textContent="0"),i.innerHTML=`
          ...
          `,o.classList.add("visible");return}c&&(c.textContent=String(a.length)),i.innerHTML=a.map(k=>{const d=k.raw||k,E=d.name||"\u0645\u0643\u0627\u0646 \u0628\u0627\u0644\u062F\u0644\u064A\u0644",I=d.categoryName||k.category||"",q=d.area||d.address||"\u0645\u062F\u064A\u0646\u0629 \u0627\u0644\u0645\u0646\u0632\u0644\u0629",H=d.slug||d.id||"",S=d.photoURL||d.logo||d.coverURL||"",U=d.isVerified||!1,$=d.isOpen!==void 0?d.isOpen:!0,C=(E.trim()[0]||"\u0645").toUpperCase();return`
            <a href="/place.html?slug=${encodeURIComponent(H)}" class="header-live-dropdown__item" role="option">
              <div class="header-live-avatar">
                ${S?`<img src="${S}" alt="${w(E)}" loading="lazy" onerror="this.onerror=null;this.parentElement.innerHTML='<div class=\\'header-live-avatar-fallback\\'>${C}</div>'"/>`:`<div class="header-live-avatar-fallback">${C}</div>`}
              </div>
              <div class="header-live-content">
                <div class="header-live-title-row">
                  <span class="header-live-name">${w(E)}</span>
                  ${U?'<span class="header-live-verified" title="\u0645\u0643\u0627\u0646 \u0645\u0648\u062B\u0642">\u2713</span>':""}
                </div>
                <div class="header-live-meta-row">
                  ${I?`<span class="header-live-cat">${w(I)}</span>`:""}
                  <span class="header-live-area">${w(q)}</span>
          ...
          `}).join(""),o.classList.add("visible")}catch(m){console.warn("[HeaderLiveSearch] search error:",m)}},120)}),document.addEventListener("click",l=>{t?.contains(l.target)||(o?.classList.remove("visible"),window.innerWidth<=767&&a?.classList.remove("expanded"))})}function w(t){return String(t||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}
