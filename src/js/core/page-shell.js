import{initAuth as Q,onAuthStateChange as X,signOut as j,waitForAuth as Z,isAdmin as $,getCurrentUser as G,getClientIp as ee,signInWithGoogle as te}from"./auth.js";import{toast as p}from"../ui/components/Toast.js";function ae(a){return`
...
<div class="pwa-banner" id="pwa-banner" hidden role="dialog" aria-label="\u062A\u062B\u0628\u064A\u062A \u062A\u0637\u0628\u064A\u0642 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A">
      ...
      <div style="display:flex;align-items:center;gap:10px">
        ...
        <div style="position:relative">
          <button class="header__user-btn" id="usr-btn" aria-haspopup="true" aria-expanded="false">
            <img src="${V(a.photoURL||"./icons/icon-72x72.png")}"
    ...
    <div class="more-menu-container" style="direction:rtl;text-align:right">
      ...
      <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;padding:12px 14px;background:var(--surface-2,#F8FAFC);border-radius:14px;margin-bottom:12px;border:1px solid var(--border,#E2E8F0)">
        <div style="display:flex;align-items:center;gap:12px">
          <img src="${V(s)}" style="width:46px;height:46px;border-radius:50%;object-fit:cover;border:2px solid var(--primary,#1B4F72)" alt="${z(e)}" onerror="this.src='./icons/icon-72x72.png'"/>
          <div>
  ...
  `,{showModal:L}=await import("../ui/components/Modal.js"),g=L({title:i?"\u2630 \u0627\u0644\u0642\u0627\u0626\u0645\u0629 \u0648\u0644\u0648\u062D\u0629 \u0627\u0644\u062A\u062D\u0643\u0645":"\u2630 \u062F\u0644\u064A\u0644 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629",content:d,sheet:!0,closeable:!0,size:"sm"}),k=document.querySelector(".modal");return k&&(k.querySelectorAll("[data-dash-nav]").forEach(f=>{f.addEventListener("click",m=>{const w=f.getAttribute("data-dash-nav");o&&typeof window.switchDashboardSection=="function"?(m.preventDefault(),g.close(),window.switchDashboardSection(w,null,!0)):g.close()})}),document.getElementById("more-modal-logout-btn")?.addEventListener("click",async()=>{g.close(),await j(),p.success("\u062A\u0645 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062E\u0631\u0648\u062C \u0628\u0646\u062C\u0627\u062D"),window.location.reload()}),document.getElementById("more-modal-google-login-btn")?.addEventListener("click",async f=>{f.preventDefault();const m=f.currentTarget,w=m.innerHTML;try{m.disabled=!0,m.style.opacity="0.7",m.innerHTML="<span>\u062C\u0627\u0631\u064A \u0641\u062A\u062D \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062F\u062E\u0648\u0644...</span>";const r=await te();r?(g.close(),p.success(`\u0623\u0647\u0644\u0627\u064B \u0628\u0643 ${r.displayName||r.name||""} \u{1F44B}`),window.location.reload()):(m.disabled=!1,m.style.opacity="1",m.innerHTML=w)}catch(r){m.disabled=!1,m.style.opacity="1",m.innerHTML=w,console.error("[MoreModal GoogleSignIn] error:",r),r?.code!=="auth/popup-closed-by-user"&&p.error("\u062A\u0639\u0630\u0631 \u062A\u0633\u062C\u064A\u0644 \u0627\u0644\u062F\u062E\u0648\u0644: "+(r?.message||"\u064A\u0631\u062C\u0649 \u0627\u0644\u0645\u062D\u0627\u0648\u0644\u0629 \u0645\u0631\u0629 \u0623\u062E\u0631\u0649"))}})),g}typeof window<"u"&&(window.openDashboardMoreModal=openDashboardMoreModal);let y=typeof window<"u"&&window.__deferredPwaPrompt?window.__deferredPwaPrompt:null;typeof window<"u"&&(window.addEventListener("beforeinstallprompt",a=>{a.preventDefault(),y=a,window.__deferredPwaPrompt=a}),window.addEventListener("appinstalled",()=>{try{localStorage.setItem("pwa-installed","true")}catch{}y=null,typeof window<"u"&&(window.__deferredPwaPrompt=null),x()}));function pe(){return typeof window>"u"?!1:!!(window.matchMedia("(display-mode: standalone)").matches||window.matchMedia("(display-mode: window-controls-overlay)").matches||window.navigator.standalone||document.referrer.includes("android-app://")||localStorage.getItem("pwa-installed")==="true")}function me(){try{const a=localStorage.getItem("pwa-dismissed");if(!a)return!1;const n=parseInt(a,10);return isNaN(n)?!1:Date.now()-n<7200*1e3}catch{return!1}}function F(){if(pe()||me())return!1;try{if(sessionStorage.getItem("pwa_session_shown")==="true")return!1}catch{}return!0}function ue(){const a=!localStorage.getItem("manzala_voice_guide_seen");a&&setTimeout(()=>{H()},2e3);const n=a?12e3:5e3,i=()=>{(y||typeof window<"u"&&window.__deferredPwaPrompt)&&F()&&!document.getElementById("voice-guide-callout")&&he()};F()&&(y||typeof window<"u"&&window.__deferredPwaPrompt?setTimeout(i,n):typeof window<"u"&&window.addEventListener("beforeinstallprompt",()=>{setTimeout(i,n)},{once:!0})),document.addEventListener("click",t=>{if(t.target.closest("#pwa-banner-close")||t.target.closest("#pwa-banner-later")){t.preventDefault(),x();return}if(t.target.closest("#pwa-install-btn")){t.preventDefault(),fe();return}if(t.target.closest("#desktop-voice-fab")){t.preventDefault();try{import("../services/voice.service.js").then(({openManzalaVoiceAssistantModal:e})=>e()).catch(()=>{})}catch{}return}})}function he(){if(!F())return;const a=document.getElementById("pwa-banner");if(a){try{sessionStorage.setItem("pwa_session_shown","true")}catch{}a.hidden=!1,a.style.display="block",requestAnimationFrame(()=>{a.classList.add("visible")})}}function x(){const a=document.getElementById("pwa-banner");a&&(a.classList.remove("visible"),setTimeout(()=>{a.hidden=!0,a.style.display="none"},350));try{localStorage.setItem("pwa-dismissed",Date.now().toString()),sessionStorage.setItem("pwa_session_shown","true")}catch{}H()}async function fe(){const a=y||(typeof window<"u"?window.__deferredPwaPrompt:null);if(a)try{a.prompt();const{outcome:n}=await a.userChoice;if(n==="accepted"){try{localStorage.setItem("pwa-installed","true")}catch{}x(),p.success("\u062A\u0645 \u062A\u062B\u0628\u064A\u062A \u0627\u0644\u062A\u0637\u0628\u064A\u0642 \u0628\u0646\u062C\u0627\u062D! \u0633\u062A\u062C\u062F\u0647 \u0641\u064A \u0634\u0627\u0634\u0629 \u062A\u0637\u0628\u064A\u0642\u0627\u062A \u0647\u0627\u062A\u0641\u0643 \u{1F389}"),setTimeout(()=>H(),1200)}else x()}catch{x()}finally{y=null,typeof window<"u"&&(window.__deferredPwaPrompt=null)}else x()}function H(){if(!(typeof document>"u")){try{if(localStorage.getItem("manzala_voice_guide_seen")==="true")return;localStorage.setItem("manzala_voice_guide_seen","true")}catch{return}setTimeout(()=>{const a=window.innerWidth>=769;let n=null;if(a?n=document.getElementById("desktop-voice-fab")||document.getElementById("global-voice-assistant-fab"):n=document.getElementById("global-voice-assistant-fab")||document.querySelector(".bottom-nav__fab-btn")||document.querySelector(".bottom-nav__fab"),!n)return;document.getElementById("voice-guide-callout")?.remove();const i=document.getElementById("pwa-banner");i&&i.classList.contains("visible")&&(i.classList.remove("visible"),i.style.display="none",i.hidden=!0);const t=document.createElement("div");t.className="voice-guide-callout",t.id="voice-guide-callout",t.setAttribute("role","tooltip"),t.innerHTML=`
...
\u0643\u0627\u0641\u0629 \u0627\u0644\u0645\u062D\u062A\u0648\u064A\u0627\u062A \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0642\u0648\u0627\u0639\u062F \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0646\u0634\u0648\u0631\u0629 \u0645\u0633\u062C\u0644\u0629 \u0648\u0645\u062D\u0645\u064A\u0629 \u0631\u0642\u0645\u064A\u0627\u064B\u060C \u0648\u0644\u0627 \u064A\u0645\u0643\u0646 \u0646\u0642\u0644\u0647\u0627 \u0623\u0648 \u0646\u0633\u062E\u0647\u0627 \u062D\u062A\u0649 \u0644\u0627 \u064A\u062A\u0645 \u0645\u0633\u0627\u0621\u0644\u062A\u0643 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u0623\u0645\u0627\u0645 \u0627\u0644\u0645\u062D\u0627\u0643\u0645 \u0628\u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629.`,"color: #EF4444; font-size: 13px; font-weight: 700; line-height: 1.8; font-family: Cairo, Tahoma, sans-serif;"),console.log("%c\u0631\u0627\u0628\u0637 \u0627\u0644\u0628\u0648\u0627\u0628\u0629 \u0627\u0644\u0631\u0633\u0645\u064A\u0629: %chttps://dalilmanzala.com/","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #0284C7; font-size: 11px; font-weight: 700; text-decoration: underline;"),console.log("%c\u{1F4AC} \u0644\u0644\u0627\u0633\u062A\u0641\u0633\u0627\u0631\u0627\u062A \u0648\u0627\u0644\u0627\u0642\u062A\u0631\u0627\u062D\u0627\u062A: %chttps://wa.me/wasendernew","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #10B981; font-size: 11px; font-weight: 700; text-decoration: underline;")}catch{}};n();let i=window.outerWidth-window.innerWidth,t=window.outerHeight-window.innerHeight;window.addEventListener("resize",()=>{const e=window.outerWidth-window.innerWidth,s=window.outerHeight-window.innerHeight;(e!==i||s!==t)&&(i=e,t=s,n())},{passive:!0}),document.addEventListener("contextmenu",e=>{const s=e.target.tagName.toLowerCase();s==="input"||s==="textarea"||e.target.isContentEditable||(e.preventDefault(),typeof p<"u"&&p.info&&p.info("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0645\u064A\u0629 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u2014 \u063A\u064A\u0631 \u0645\u0635\u0631\u062D \u0628\u0646\u0633\u062E \u0623\u0648 \u0646\u0642\u0644 \u0645\u062D\u062A\u0648\u0649 \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("copy",e=>{const s=e.target.tagName?e.target.tagName.toLowerCase():"";s==="input"||s==="textarea"||e.target.isContentEditable||(e.preventDefault(),e.clipboardData&&e.clipboardData.setData("text/plain",`\xA9 \u062C\u0645\u064A\u0639 \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0627\u0644\u062D\u0642\u0648\u0642 \u0645\u062D\u0641\u0648\u0638\u0629 \u0644\u062F\u0644\u064A\u0644 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A (${a}). https://dalilmanzala.com/`),typeof p<"u"&&p.warning&&p.warning("\u26A0\uFE0F \u062A\u0645 \u062D\u0641\u0638 \u062D\u0642\u0648\u0642 \u0627\u0644\u0645\u0644\u0643\u064A\u0629: \u0644\u0627 \u064A\u062C\u0648\u0632 \u0646\u0633\u062E \u0623\u0648 \u0627\u0642\u062A\u0628\u0627\u0633 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("cut",e=>{const s=e.target.tagName?e.target.tagName.toLowerCase():"";s==="input"||s==="textarea"||e.target.isContentEditable||e.preventDefault()}),document.addEventListener("keydown",e=>{const s=e.target.tagName?e.target.tagName.toLowerCase():"",o=s==="input"||s==="textarea"||e.target.isContentEditable;(e.key==="F12"||e.ctrlKey&&e.shiftKey&&(e.key==="I"||e.key==="i"||e.key==="J"||e.key==="j"||e.key==="C"||e.key==="c"))&&n(),e.ctrlKey&&(e.key==="u"||e.key==="U"||e.key==="s"||e.key==="S"||e.key==="p"||e.key==="P")&&(e.preventDefault(),typeof p<"u"&&p.warning&&p.warning("\u{1F512} \u0645\u0635\u062F\u0631 \u0648\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644 \u0645\u062D\u0645\u064A\u0629 \u0628\u0645\u0648\u062C\u0628 \u0642\u0627\u0646\u0648\u0646 \u0627\u0644\u0645\u0644\u0643\u064A\u0629 \u0627\u0644\u0641\u0643\u0631\u064A\u0629.")),e.ctrlKey&&(e.key==="c"||e.key==="C")&&!o&&(window.getSelection?window.getSelection().toString():"").length>0&&(e.preventDefault(),typeof p<"u"&&p.warning&&p.warning("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0645\u062D\u0645\u064A: \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u0646\u0633\u062E \u0644\u0645\u0646\u0639 \u0627\u0644\u062A\u0639\u062F\u064A \u0627\u0644\u0642\u0627\u0646\u0648\u0646\u064A."))})}async function ve(){try{const a=G();if(a&&$(a))return;if(a&&a.status==="suspended"){O("\u062A\u0645 \u0625\u064A\u0642\u0627\u0641 \u062D\u0633\u0627\u0628\u0643 \u0645\u0646 \u0642\u0628\u0644 \u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0645\u0646\u0635\u0629 \u0644\u0645\u062E\u0627\u0644\u0641\u0629 \u0627\u0644\u0634\u0631\u0648\u0637.");return}const n=await ee();if(n){const{isIpBanned:i}=await import("./db.js"),t=await i(n);if(t){const e=t.reason||"\u0645\u062E\u0627\u0644\u0641\u0629 \u0645\u0639\u0627\u064A\u064A\u0631 \u0648\u0633\u064A\u0627\u0633\u0627\u062A \u0627\u0644\u0645\u0646\u0635\u0629",s=t.bannedUntil?new Date(t.bannedUntil).toLocaleDateString("ar-EG"):null,o=t.isPermanent?`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${n}) \u0646\u0647\u0627\u0626\u064A\u0627\u064B \u0645\u0646 \u062F\u062E\u0648\u0644 \u0627\u0644\u0645\u0646\u0635\u0629 \u0628\u0633\u0628\u0628: ${e}`:`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${n}) \u062D\u062A\u0649 ${s} \u0628\u0633\u0628\u0628: ${e}`;O(o)}}}catch(a){console.debug("[_enforceBanGuard] notice:",a)}}function O(a){document.body.innerHTML=`
  ...
  `}function be(){const a=document.getElementById("header-search-container"),n=document.getElementById("header-search-pill"),i=document.getElementById("header-search-trigger"),t=document.getElementById("header-search-input"),e=document.getElementById("header-search-clear"),s=document.getElementById("header-live-dropdown"),o=document.getElementById("header-live-list"),d=document.getElementById("header-live-count"),L=document.getElementById("header-live-all-btn");if(!t)return;let g=null,k=0;function f(){!s||!o||(d&&(d.textContent="\u0645\u0642\u062A\u0631\u062D\u0627\u062A"),o.innerHTML=`
    ...
    `,o.querySelectorAll(".header-live-suggestion-chip").forEach(r=>{r.addEventListener("click",B=>{B.preventDefault(),B.stopPropagation();const P=r.getAttribute("data-q")||"";t.value=P,t.dispatchEvent(new Event("input",{bubbles:!0})),t.focus()})}),s.classList.add("visible"))}const m=()=>{n?.classList.add("expanded"),t.focus(),t.value.trim().length>=1?s?.classList.add("visible"):f()},w=()=>{n?.classList.remove("expanded"),s?.classList.remove("visible")};i?.addEventListener("click",r=>{r.stopPropagation(),n?.classList.contains("expanded")&&t.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(t.value.trim())}`:m()}),t.addEventListener("focus",()=>{n?.classList.add("expanded"),t.value.trim().length>=1&&o?.children.length>0?s?.classList.add("visible"):t.value.trim()||f()}),t.addEventListener("click",()=>{t.value.trim()||f()}),e?.addEventListener("click",r=>{r.stopPropagation(),t.value="",e.classList.remove("visible"),s?.classList.remove("visible"),o&&(o.innerHTML=""),t.focus()}),t.addEventListener("keydown",r=>{r.key==="Enter"&&t.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(t.value.trim())}`:r.key==="Escape"&&w()}),t.addEventListener("input",()=>{const r=t.value.trim();if(e?.classList.toggle("visible",r.length>0),L&&(L.href=`search.html?q=${encodeURIComponent(r)}`),!r){s?.classList.remove("visible"),o&&(o.innerHTML="");return}const B=r.length<=2?0:35;clearTimeout(g),g=setTimeout(async()=>{const P=++k;try{let D=function(u,l){if(!u)return"";if(!l)return c(u);const b=l.trim().split(/\s+/).filter(Boolean);if(!b.length)return c(u);const E=b.map(h=>h.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")),C=new RegExp(`(${E.join("|")})`,"gi");return c(u).replace(C,'<span class="search-highlight">$1</span>')};const{executeFastSearch:A}=await import("../services/search-engine.service.js"),v=await A(r,{limit:6});if(P!==k||!s||!o)return;if(!v||v.length===0){d&&(d.textContent="0"),o.innerHTML=`
          ...
          `,s.classList.add("visible");return}d&&(d.textContent=String(v.length));let N="";v.matchingCategories&&v.matchingCategories.length>0&&(N=`
          ...
          `),o.innerHTML=N+v.map(u=>{const l=u.raw||u,b=l.name||"\u0645\u0643\u0627\u0646 \u0628\u0627\u0644\u062F\u0644\u064A\u0644",E=l.categoryName||u.category||"",C=l.area||l.address||"\u0645\u062F\u064A\u0646\u0629 \u0627\u0644\u0645\u0646\u0632\u0644\u0629",h=l.slug||l.id||"",S=l.photoURL||l.logo||l.coverURL||l.coverImageUrl||l.logoUrl||"",Y=l.isVerified||!1,q=l.isOpen!==void 0?l.isOpen:!0,M=(l.phone||"").trim(),U=(l.whatsapp||l.phone||"").trim(),_=U?U.replace(/[^0-9]/g,""):"",T=_?_.startsWith("2")?_:_.startsWith("0")?"2"+_:"20"+_:"";let W="";if((M||T)&&(W=`
              <div class="header-live-actions" onclick="event.stopPropagation()">
                ${M?`
                  <a href="tel:${c(M)}" class="header-live-action-btn header-live-action-btn--call" title="\u0627\u062A\u0635\u0627\u0644 \u0647\u0627\u062A\u0641\u064A" onclick="event.stopPropagation()">
                ...
                `:""}
                ${T?`
                  <a href="https://wa.me/${c(T)}" target="_blank" rel="noopener" class="header-live-action-btn header-live-action-btn--wa" title="\u0648\u0627\u062A\u0633\u0627\u0628" onclick="event.stopPropagation()">
            ...
            `),typeof window<"u"&&window._placesRegistry&&h){const J=String(h).toLowerCase().trim();window._placesRegistry.set(J,l),l.slug&&window._placesRegistry.set(String(l.slug).toLowerCase().trim(),l),l.id&&window._placesRegistry.set(String(l.id).toLowerCase().trim(),l)}const R=(b.trim()[0]||"\u0645").toUpperCase();return`
            <a href="/place.html?slug=${encodeURIComponent(h)}" class="header-live-dropdown__item" role="option"
               data-place-id="${c(l.id||h)}"
               data-place-slug="${c(h)}"
               data-name="${c(b)}"
               ...
               data-cover="${c(l.coverImageUrl||S)}"
               data-logo="${c(l.logoUrl||S)}"
               data-category="${c(E)}"
               onclick="window.__openPlaceCard ? window.__openPlaceCard(this, '${c(h)}', event) : null"
               ontouchstart="window.__prefetchPlaceCard && window.__prefetchPlaceCard('${c(h)}', this)"
               onpointerdown="window.__prefetchPlaceCard && window.__prefetchPlaceCard('${c(h)}', this)">
              <div class="header-live-avatar">
                ${S?`<img src="${S}" alt="${c(b)}" loading="lazy" onerror="this.onerror=null;this.parentElement.innerHTML='<div class=\\'header-live-avatar-fallback\\'>${R}</div>'"/>`:`<div class="header-live-avatar-fallback">${R}</div>`}
              </div>
              <div class="header-live-content">
                <div class="header-live-title-row">
                  <span class="header-live-name">${D(b,r)}</span>
                  ${Y?'<span class="header-live-verified" title="\u0645\u0643\u0627\u0646 \u0645\u0648\u062B\u0642">\u2713</span>':""}
                </div>
                <div class="header-live-meta-row">
                  ${E?`<span class="header-live-cat">${D(E,r)}</span>`:""}
          ...
          `}).join(""),s.classList.add("visible")}catch(A){console.warn("[HeaderLiveSearch] search error:",A)}},B)}),document.addEventListener("click",r=>{a?.contains(r.target)||(s?.classList.remove("visible"),window.innerWidth<=767&&n?.classList.remove("expanded"))})}function c(a){return String(a||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}
