import{initAuth as X,onAuthStateChange as Z,signOut as j,waitForAuth as G,isAdmin as $,getCurrentUser as K,getClientIp as ee,signInWithGoogle as te}from"./auth.js";import{toast as p}from"../ui/components/Toast.js";import{t,getLang,isEnglish,localizeUrl,switchLanguage,applyLangToDOM}from"./i18n.js";function ae(a){
  const isEn = isEnglish();
  const n=[
    [localizeUrl("/index.html"),t("nav_home"),""],
    [localizeUrl("/popular.html"),t("nav_popular"),"🔥"],
    [localizeUrl("/places.html"),t("nav_places"),""],
    [localizeUrl("/categories.html"),t("nav_categories"),""],
    [localizeUrl("/offers.html"),t("nav_offers"),""],
    [localizeUrl("/now.html"),t("nav_now"),"🤝"],
    [localizeUrl("/around-me.html"),t("nav_around_me"),"🧭"],
    [localizeUrl("/favorites.html"),t("nav_favorites"),"❤️"]
  ],i=e=>String(e||"").replace(/^\/+/,""),tSlug=i(a);return`
  ...
  <div class="container header__inner">
    <a href="${localizeUrl('/index.html')}" class="header__logo" aria-label="${t('site_title')}">
      ...
      <div class="header__logo-text">
        <span class="header__logo-name">${t('site_title')}</span>
      </div>
    </a>
    ...
    <div class="header-search-expandable" id="header-search-container" role="search">
      <div class="header-search-pill" id="header-search-pill">
        <button type="button" class="header-search-btn-trigger" id="header-search-trigger" aria-label="${t('search_btn')}" title="${t('search_quick_title')}">
        ...
        <input type="search" id="header-search-input" class="header-search-input"
               ...
               autocomplete="off" aria-label="${t('search_placeholder')}"/>
      ...
      <div class="header-live-dropdown" id="header-live-dropdown" aria-live="polite">
        <div class="header-live-dropdown__header">
          <span>⚡ ${t('search_live_results')}:</span>
        ...
        <div class="header-live-dropdown__footer">
          <a href="${localizeUrl('/search.html')}" class="header-live-dropdown__all-btn" id="header-live-all-btn">
    ...
    <nav class="header__nav" aria-label="${t('site_title')}">
      ${n.map(([e,s,o])=>`<a href="${e}" class="header__nav-link${i(e)===tSlug?" active":""}">
          <span>${s}</span>
    ...
    <button type="button" class="lang-toggle-btn" id="lang-toggle-btn" aria-label="${t('lang_toggle_label')}" title="${t('lang_toggle_label')}">
      <span class="lang-globe">🌐</span>
      <span class="lang-name">${t('lang_toggle_label')}</span>
    </button>

    <!-- Theme Toggle -->
    <button type="button" class="theme-toggle-btn" id="theme-toggle-btn" aria-label="${t('theme_dark')}" title="${t('theme_dark')}">
      <span class="theme-icon-light">☀️</span>
      <span class="theme-icon-dark">🌙</span>
    </button>

    <div class="header__user" id="header-user-section">
      <a href="${localizeUrl('/login.html')}" class="btn btn-primary btn-sm"><span>🔑</span> ${t('nav_login')}</a>
    </div>
  </div>
...
\u0643\u0627\u0641\u0629 \u0627\u0644\u0645\u062D\u062A\u0648\u064A\u0627\u062A \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0642\u0648\u0627\u0639\u062F \u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u0645\u0646\u0634\u0648\u0631\u0629 \u0645\u0633\u062C\u0644\u0629 \u0648\u0645\u062D\u0645\u064A\u0629 \u0631\u0642\u0645\u064A\u0627\u064B\u060C \u0648\u0644\u0627 \u064A\u0645\u0643\u0646 \u0646\u0642\u0644\u0647\u0627 \u0623\u0648 \u0646\u0633\u062E\u0647\u0627 \u062D\u062A\u0649 \u0644\u0627 \u064A\u062A\u0645 \u0645\u0633\u0627\u0621\u0644\u062A\u0643 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u0623\u0645\u0627\u0645 \u0627\u0644\u0645\u062D\u0627\u0643\u0645 \u0628\u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629.`,"color: #EF4444; font-size: 13px; font-weight: 700; line-height: 1.8; font-family: Cairo, Tahoma, sans-serif;"),console.log("%c\u0631\u0627\u0628\u0637 \u0627\u0644\u0628\u0648\u0627\u0628\u0629 \u0627\u0644\u0631\u0633\u0645\u064A\u0629: %chttps://dalilmanzala.com/","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #0284C7; font-size: 11px; font-weight: 700; text-decoration: underline;"),console.log("%c\u{1F4AC} \u0644\u0644\u0627\u0633\u062A\u0641\u0633\u0627\u0631\u0627\u062A \u0648\u0627\u0644\u0627\u0642\u062A\u0631\u0627\u062D\u0627\u062A: %chttps://wa.me/wasendernew","color: #64748B; font-size: 11px; font-family: Cairo, sans-serif;","color: #10B981; font-size: 11px; font-weight: 700; text-decoration: underline;")}catch{}};n();let i=window.outerWidth-window.innerWidth,t=window.outerHeight-window.innerHeight;window.addEventListener("resize",()=>{const e=window.outerWidth-window.innerWidth,s=window.outerHeight-window.innerHeight;(e!==i||s!==t)&&(i=e,t=s,n())},{passive:!0}),document.addEventListener("contextmenu",e=>{const s=e.target.tagName.toLowerCase();s==="input"||s==="textarea"||e.target.isContentEditable||(e.preventDefault(),typeof p<"u"&&p.info&&p.info("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0645\u062D\u0645\u064A\u0629 \u0642\u0627\u0646\u0648\u0646\u064A\u0627\u064B \u2014 \u063A\u064A\u0631 \u0645\u0635\u0631\u062D \u0628\u0646\u0633\u062E \u0623\u0648 \u0646\u0642\u0644 \u0645\u062D\u062A\u0648\u0649 \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("copy",e=>{const s=e.target.tagName?e.target.tagName.toLowerCase():"";s==="input"||s==="textarea"||e.target.isContentEditable||(e.preventDefault(),e.clipboardData&&e.clipboardData.setData("text/plain",`\xA9 \u062C\u0645\u064A\u0639 \u0627\u0644\u0623\u0645\u0627\u0643\u0646 \u0648\u0627\u0644\u0628\u064A\u0627\u0646\u0627\u062A \u0648\u0627\u0644\u062D\u0642\u0648\u0642 \u0645\u062D\u0641\u0648\u0638\u0629 \u0644\u062F\u0644\u064A\u0644 \u0627\u0644\u0645\u0646\u0632\u0644\u0629 \u0648\u0627\u0644\u0645\u0637\u0631\u064A\u0629 \u0627\u0644\u0631\u0642\u0645\u064A (${a}). https://dalilmanzala.com/`),typeof p<"u"&&p.warning&&p.warning("\u26A0\uFE0F \u062A\u0645 \u062D\u0641\u0638 \u062D\u0642\u0648\u0642 \u0627\u0644\u0645\u0644\u0643\u064A\u0629: \u0644\u0627 \u064A\u062C\u0648\u0632 \u0646\u0633\u062E \u0623\u0648 \u0627\u0642\u062A\u0628\u0627\u0633 \u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644."))}),document.addEventListener("cut",e=>{const s=e.target.tagName?e.target.tagName.toLowerCase():"";s==="input"||s==="textarea"||e.target.isContentEditable||e.preventDefault()}),document.addEventListener("keydown",e=>{const s=e.target.tagName?e.target.tagName.toLowerCase():"",o=s==="input"||s==="textarea"||e.target.isContentEditable;(e.key==="F12"||e.ctrlKey&&e.shiftKey&&(e.key==="I"||e.key==="i"||e.key==="J"||e.key==="j"||e.key==="C"||e.key==="c"))&&n(),e.ctrlKey&&(e.key==="u"||e.key==="U"||e.key==="s"||e.key==="S"||e.key==="p"||e.key==="P")&&(e.preventDefault(),typeof p<"u"&&p.warning&&p.warning("\u{1F512} \u0645\u0635\u062F\u0631 \u0648\u0628\u064A\u0627\u0646\u0627\u062A \u0627\u0644\u062F\u0644\u064A\u0644 \u0645\u062D\u0645\u064A\u0629 \u0628\u0645\u0648\u062C\u0628 \u0642\u0627\u0646\u0648\u0646 \u0627\u0644\u0645\u0644\u0643\u064A\u0629 \u0627\u0644\u0641\u0643\u0631\u064A\u0629.")),e.ctrlKey&&(e.key==="c"||e.key==="C")&&!o&&(window.getSelection?window.getSelection().toString():"").length>0&&(e.preventDefault(),typeof p<"u"&&p.warning&&p.warning("\u{1F6E1}\uFE0F \u0627\u0644\u0645\u062D\u062A\u0648\u0649 \u0645\u062D\u0645\u064A: \u0644\u0627 \u064A\u0645\u0643\u0646 \u0627\u0644\u0646\u0633\u062E \u0644\u0645\u0646\u0639 \u0627\u0644\u062A\u0639\u062F\u064A \u0627\u0644\u0642\u0627\u0646\u0648\u0646\u064A."))})}async function ve(){try{let a=K();if(!a)try{a=await G(1500)}catch{}if(a&&$(a))return;if(a&&a.status==="suspended"){Y("\u062A\u0645 \u0625\u064A\u0642\u0627\u0641 \u062D\u0633\u0627\u0628\u0643 \u0645\u0646 \u0642\u0628\u0644 \u0625\u062F\u0627\u0631\u0629 \u0627\u0644\u0645\u0646\u0635\u0629 \u0644\u0645\u062E\u0627\u0644\u0641\u0629 \u0627\u0644\u0634\u0631\u0648\u0637.");return}const n=await ee();if(n){if(n==="156.197.215.243")return;const{isIpBanned:i}=await import("./db.js"),t=await i(n),e=!!(t&&t.isPermanent),s=!!(t&&t.bannedUntil&&Number(t.bannedUntil)>Date.now());if(e||s){const o=t.reason||"\u0645\u062E\u0627\u0644\u0641\u0629 \u0645\u0639\u0627\u064A\u064A\u0631 \u0648\u0633\u064A\u0627\u0633\u0627\u062A \u0627\u0644\u0645\u0646\u0635\u0629",c=e?null:new Date(t.bannedUntil).toLocaleDateString("ar-EG"),_=e?`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${n}) \u0646\u0647\u0627\u0626\u064A\u0627\u064B \u0645\u0646 \u062F\u062E\u0648\u0644 \u0627\u0644\u0645\u0646\u0635\u0629 \u0628\u0633\u0628\u0628: ${o}`:`\u062A\u0645 \u062D\u0638\u0631 \u0639\u0646\u0648\u0627\u0646 \u062C\u0647\u0627\u0632\u0643 (${n}) \u062D\u062A\u0649 ${c} \u0628\u0633\u0628\u0628: ${o}`;Y(_)}}}catch(a){console.debug("[_enforceBanGuard] notice:",a)}}function Y(a){document.body.innerHTML=`
  ...
  `}function be(){const a=document.getElementById("header-search-container"),n=document.getElementById("header-search-pill"),i=document.getElementById("header-search-trigger"),t=document.getElementById("header-search-input"),e=document.getElementById("header-search-clear"),s=document.getElementById("header-live-dropdown"),o=document.getElementById("header-live-list"),c=document.getElementById("header-live-count"),_=document.getElementById("header-live-all-btn");if(!t)return;let g=null,L=0;function f(){!s||!o||(c&&(c.textContent="\u0645\u0642\u062A\u0631\u062D\u0627\u062A"),o.innerHTML=`
    ...
    `,o.querySelectorAll(".header-live-suggestion-chip").forEach(r=>{r.addEventListener("click",B=>{B.preventDefault(),B.stopPropagation();const z=r.getAttribute("data-q")||"";t.value=z,t.dispatchEvent(new Event("input",{bubbles:!0})),t.focus()})}),s.classList.add("visible"))}const m=()=>{n?.classList.add("expanded"),t.focus(),t.value.trim().length>=1?s?.classList.add("visible"):f()},v=()=>{n?.classList.remove("expanded"),s?.classList.remove("visible")};i?.addEventListener("click",r=>{r.stopPropagation(),n?.classList.contains("expanded")&&t.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(t.value.trim())}`:n?.classList.contains("expanded")&&!t.value.trim()?(v(),t.blur()):m()}),n?.addEventListener("click",r=>{n.classList.contains("expanded")||(r.stopPropagation(),m())}),t.addEventListener("focus",()=>{n?.classList.add("expanded"),t.value.trim().length>=1&&o?.children.length>0?s?.classList.add("visible"):t.value.trim()||f()}),t.addEventListener("click",r=>{r.stopPropagation(),t.value.trim()||f()}),e?.addEventListener("click",r=>{r.stopPropagation(),t.value="",e.classList.remove("visible"),s?.classList.remove("visible"),o&&(o.innerHTML=""),t.focus()}),t.addEventListener("keydown",r=>{r.key==="Enter"&&t.value.trim()?window.location.href=`search.html?q=${encodeURIComponent(t.value.trim())}`:r.key==="Escape"&&(v(),t.blur())}),t.addEventListener("input",()=>{const r=t.value.trim();if(e?.classList.toggle("visible",r.length>0),_&&(_.href=`search.html?q=${encodeURIComponent(r)}`),!r){s?.classList.remove("visible"),o&&(o.innerHTML="");return}const B=r.length<=2?0:35;clearTimeout(g),g=setTimeout(async()=>{const z=++L;try{let H=function(u,l){if(!u)return"";if(!l)return d(u);const w=l.trim().split(/\s+/).filter(Boolean);if(!w.length)return d(u);const E=w.map(h=>h.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")),S=new RegExp(`(${E.join("|")})`,"gi");return d(u).replace(S,'<span class="search-highlight">$1</span>')};const{executeFastSearch:A}=await import("../services/search-engine.service.js"),b=await A(r,{limit:6});if(z!==L||!s||!o)return;if(!b||b.length===0){c&&(c.textContent="0"),o.innerHTML=`
          ...
          `,s.classList.add("visible");return}c&&(c.textContent=String(b.length));let D="";b.matchingCategories&&b.matchingCategories.length>0&&(D=`
            <div class="hero-live-matched-cats" style="margin-bottom:6px">
              ...
              <div class="hero-live-matched-cats__chips">
                ${b.matchingCategories.map(u=>{const l=u.slug||u.id||"";return`
          ...
          `),o.innerHTML=D+b.map(u=>{const l=u.raw||u,w=l.name||"\u0645\u0643\u0627\u0646 \u0628\u0627\u0644\u062F\u0644\u064A\u0644",E=l.categoryName||u.category||"",S=l.area||l.address||"\u0645\u062F\u064A\u0646\u0629 \u0627\u0644\u0645\u0646\u0632\u0644\u0629",h=l.slug||l.id||"",C=l.photoURL||l.logo||l.coverURL||l.coverImageUrl||l.logoUrl||"",J=l.isVerified||!1,q=l.isOpen!==void 0?l.isOpen:!0,M=(l.phone||"").trim(),U=(l.whatsapp||l.phone||"").trim(),y=U?U.replace(/[^0-9]/g,""):"",T=y?y.startsWith("2")?y:y.startsWith("0")?"2"+y:"20"+y:"";let R="";if((M||T)&&(R=`
            ...
            `),typeof window<"u"&&window._placesRegistry&&h){const Q=String(h).toLowerCase().trim();window._placesRegistry.set(Q,l),l.slug&&window._placesRegistry.set(String(l.slug).toLowerCase().trim(),l),l.id&&window._placesRegistry.set(String(l.id).toLowerCase().trim(),l)}const W=(w.trim()[0]||"\u0645").toUpperCase();return`
            <a href="/place.html?slug=${encodeURIComponent(h)}" class="header-live-dropdown__item" role="option"
              ...
              <div class="header-live-avatar">
                ${C?`<img src="${C}" alt="${d(w)}" loading="lazy" onerror="this.onerror=null;this.parentElement.innerHTML='<div class=\\'header-live-avatar-fallback\\'>${W}</div>'"/>`:`<div class="header-live-avatar-fallback">${W}</div>`}
              </div>
              <div class="header-live-content">
                <div class="header-live-title-row">
                  <span class="header-live-name">${H(w,r)}</span>
          ...
          `}).join(""),s.classList.add("visible")}catch(A){console.warn("[HeaderLiveSearch] search error:",A)}},B)}),document.addEventListener("click",r=>{a?.contains(r.target)||(s?.classList.remove("visible"),n?.classList.remove("expanded"))})}function d(a){return String(a||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}
